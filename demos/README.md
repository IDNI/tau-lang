...
| `demo_6.1-options_and_budgets.tau` | REPL options: `get`/`set`/`toggle`, `charvar`, severity, how `bvwidening` changes the answers of `sat`/`valid`/`normalize`/`solve`, `bvmaxwidth`, and the resource budgets with their give-ups |
