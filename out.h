...
ostream& operator<<(ostream& os, const hbdd<B, bdd_param_names>& f) {
	if (f == bdd_handle<B, bdd_param_names>::htrue) return os << '1';
	if (f == bdd_handle<B, bdd_param_names>::hfalse) return os << '0';
