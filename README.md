...
|---------|---------|---------|---------|
| Release | ![Release Build](https://github.com/IDNI/tau-lang/actions/workflows/release.yml/badge.svg) | Debug | ![Debug Build](https://github.com/IDNI/tau-lang/actions/workflows/debug.yml/badge.svg)     |
...
* TABA book [Theories and Applications of Boolean Algebras by Ohad Asor](./docs/taba.pdf) (In works).
