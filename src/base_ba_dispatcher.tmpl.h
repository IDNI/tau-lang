...
// The <bv, sbf_ba> pack's specializations are DECLARED here and defined once in
// base_ba_dispatcher_bv_sbf.cpp (see that file for why).  Included outside the
// namespace below because it opens its own; an explicit specialization must be
// declared in the namespace its template belongs to.
