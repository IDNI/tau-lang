...
// tree at compile time). Covers the PWR-capable (d.revisable) and
// declare_open (d.open_streams) shapes too -- program_desc replaced the old
// per-purpose emitters (emit_cpp_program_pwr, emit_cpp_program_open[_prop],
