...
using tau_sym = std::variant<tau_source_sym, std::variant<BAs...>, cvc5::Term, size_t>;
...
std::strong_ordering operator<=>(const tau_sym<BAs...>& lhs, const tau_sym<BAs...>& rhs) {
	return std::visit(overloaded(
		[](const cvc5::Term& l, const cvc5::Term& r) -> std::strong_ordering { return std::addressof(l) <=> std::addressof(r); },
...
template <typename... BAs>
using tau = rewriter::depreciating::sp_node<tau_sym<BAs...>>;
...
template <typename... BAs>
using builder = rewriter::depreciating::rule<tau<BAs...>>;
...
template <typename... BAs>
tau<BAs...> nso_rr_apply(const rewriter::depreciating::rule<tau<BAs...>>& r,
	const tau<BAs...>& n)
{
	...
	#ifdef TAU_CACHE
	static std::map<std::pair<rewriter::depreciating::rule<tau<BAs...>>, tau<BAs...>>, tau<BAs...>> cache;
...
struct nso_factory {
	...
	std::variant<BAs...> pack_tau_ba (const tau<BAs...>& c) const;
...
std::ostream& operator<<(std::ostream& stream,
	const idni::rewriter::depreciating::rule<idni::tau_lang::tau<BAs...>>& r)
{
