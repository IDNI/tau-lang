...
std::ostream& operator<<(std::ostream &os,
	std::map<depreciating::rewriter::sp_node<node_t>, depreciating::rewriter::sp_node<node_t>> m)
{
	os << "{";
...
std::ostream& print_sp_tau_source_node_tree(std::ostream &os,
	depreciating::rewriter::sp_node<node_t> n, size_t l = 0)
{
...
template <typename node_t>
std::ostream& ptree(std::ostream &os, depreciating::rewriter::sp_node<node_t> n, size_t l = 0) {
...
template <typename node_t>
std::string ptree(depreciating::rewriter::sp_node<node_t> n, size_t l = 0) {
	std::stringstream ss;
