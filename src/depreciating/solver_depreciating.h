...
#ifndef __SOLVER_DEPRECIATING_H__
#define __SOLVER_DEPRECIATING_H__
 ...
 */
template<typename...BAs>
using equations = std::set<tau_<BAs...>>;
 ...
 */
template<typename...BAs>
using solution = std::map<var<BAs...>, tau_<BAs...>>;
...
template<typename...BAs>
struct solver_options {
	tau_<BAs...> splitter_one = nullptr; /**< Splitter option */
