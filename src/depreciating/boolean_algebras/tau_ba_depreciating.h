...
#ifndef __TAU_BA_DEPRECIATING_H__
#define __TAU_BA_DEPRECIATING_H__

#include <iostream>

#include "depreciating/satisfiability_depreciating.h"
#include "depreciating/splitter_depreciating.h"
...
struct tau_ba {
	...
	using tau_nso_t = tau_<tau_ba_t, BAs...>;
 ...
 */
template <typename... BAs>
using tau_nso = tau_<tau_ba<BAs...>, BAs...>;
...
#endif // __TAU_BA_DEPRECIATING_H__