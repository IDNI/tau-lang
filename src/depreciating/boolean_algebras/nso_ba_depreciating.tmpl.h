...
tau_<BAs...> operator&(const tau_<BAs...>& l,
	const tau_<BAs...>& r)
{
	auto bf_constant_and = [](const auto& l, const auto& r) -> tau_<BAs...> {
		auto lc = l
...
tau_<BAs...> operator|(const tau_<BAs...>& l,
	const tau_<BAs...>& r)
{
	auto bf_constant_or = [](const auto& l, const auto& r) -> tau_<BAs...> {
		auto lc = l
			| tau_parser::bf_constant
			| tau_parser::constant
			| only_child_extractor<BAs...>
...
template <typename... BAs>
tau_<BAs...> operator~(const tau_<BAs...>& l) {
	auto bf_constant_neg = [](const auto& l) -> tau_<BAs...> {
		auto lc = l
			| tau_parser::bf_constant
			| tau_parser::constant
			| only_child_extractor<BAs...>
...
tau_<BAs...> operator^(const tau_<BAs...>& l,
	const tau_<BAs...>& r)
{
	auto bf_constant_xor = [](const auto& l, const auto& r) -> tau_<BAs...> {
		auto lc = l
			| tau_parser::bf_constant
			| tau_parser::constant
			| only_child_extractor<BAs...>
...
template <typename... BAs>
tau_<BAs...> splitter(const tau_<BAs...>& n,
	splitter_type st)
{
	using p = tau_parser;
