...
template <typename...BAs>
tau_<BAs...> first_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[0]->child[0];
}

template <typename...BAs>
tau_<BAs...> second_argument_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[1];
}

template <typename...BAs>
tau_<BAs...> second_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
	return n.child[0]->child[1]->child[0];
}

template <typename...BAs>
tau_<BAs...> third_argument_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[2];
}

template <typename...BAs>
tau_<BAs...> third_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[2]->child[0];
}

template <typename...BAs>
tau_<BAs...> logic_operator(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau_<BAs...> quantifier(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau_<BAs...> quantified_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[0];
}

template<typename...BAs>
std::optional<tau_<BAs...>> type_of(const tau_<BAs...>& e)
{
...
template<typename...BAs>
tau_<BAs...> build_bf_1(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename...BAs>
tau_<BAs...> build_bf_0(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau_<BAs...> build_wff_t(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau_<BAs...> build_wff_f(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
} // namespace rewriter::depreciating
