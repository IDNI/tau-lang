...
template<typename input_t, typename output_t, typename ... BAs>
tau_<BAs...> interpreter<input_t, output_t, BAs...>::get_ubt_ctn_at(int_t t) {
	using p = tau_parser;
...
template<typename input_t, typename output_t, typename ... BAs>
std::vector<tau_<BAs...>> interpreter<input_t, output_t, BAs...>::
build_inputs_for_step(const size_t t) {
	std::vector<tau_<BAs...>> step_inputs;
...
template<typename input_t, typename output_t, typename...BAs>
tau_<BAs...> interpreter<input_t, output_t, BAs...>::update_to_time_point(
	const tau_<BAs...>& f, const int_t t) {
...
void interpreter<input_t, output_t, BAs...>::compute_lookback_and_initial() {
	std::vector<tau_<BAs...> > io_vars = select_top(ubt_ctn,
		is_child_non_terminal< tau_parser::io_var , BAs...>);
...
template<typename input_t, typename output_t, typename...BAs>
std::vector<system<BAs...>> interpreter<input_t, output_t, BAs...>::compute_systems(const tau_<BAs...>& ubd_ctn,
...
template<typename input_t, typename output_t, typename...BAs>
std::optional<system<BAs...>> interpreter<input_t, output_t, BAs...>::compute_atomic_fm_types(const tau_<BAs...>& clause,
	auto& inputs, auto& outputs) {
	auto is_atomic_fm = [](const tau_<BAs...>& n) {
	...
	std::set<tau_<BAs...>> pending_atomic_fms;
	...
	while (new_choice) {
		new_choice = false;
		std::vector<tau_<BAs...>> to_erase_fms;
...
template<typename input_t, typename output_t, typename...BAs>
std::optional<std::string> interpreter<input_t, output_t, BAs...>::get_type_atomic_fm(const tau_<BAs...>& fm,
		auto& inputs, auto& outputs) {
	using p = tau_parser;
...
template<typename input_t, typename output_t, typename...BAs>
std::pair<tau_<BAs...>, tau_<BAs...>>
interpreter<input_t, output_t, BAs...>::get_executable_spec(
	const tau_<BAs...>& fm, const size_t start_time) {
...
template<typename input_t, typename output_t, typename ... BAs>
void interpreter<input_t, output_t, BAs...>::update(const tau_<BAs...>& update) {
	...
	tau_<BAs...> shifted_update = shift_const_io_vars_in_fm(
...
template<typename input_t, typename output_t, typename ... BAs>
tau_<BAs...> interpreter<input_t, output_t, BAs...>::pointwise_revision(
	tau_<BAs...> spec, tau_<BAs...> update, const int_t start_time) {
	using p = tau_parser;
	...
	for (const auto& clause : get_dnf_wff_clauses(update)) {
		...
		const tau_<BAs...> new_spec = clause;
		...
		tau_<BAs...> new_spec_pointwise;
		if (spec_always) {
			if (upd_always) {
				tau_<BAs...> aw = always_conjunction(
					upd_always.value(),
					spec_always.value());
...
template<typename input_t, typename output_t, typename...BAs>
bool interpreter<input_t, output_t, BAs...>::is_excluded_output (const tau_<BAs...>& var) {
	using p = tau_parser;
...
template<typename input_t, typename output_t, typename ... BAs>
std::vector<tau_<BAs...>> interpreter<input_t, output_t, BAs...>::appear_within_lookback(
	const std::vector<tau_<BAs...>>& vars) {
	std::vector<tau_<BAs...>> appeared;
