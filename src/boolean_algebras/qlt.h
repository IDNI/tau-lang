...
// Helper: gcd (always positive, works for negative inputs)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wstrict-overflow"
inline long long qlt_gcd(long long a, long long b) {
...
struct qlt_rational {
	...
	bool operator<(const qlt_rational& o) const {
		...
		// Both non-symbolic: existing logic
...
inline bool qlt_lo_less(const qlt_piece& a, const qlt_piece& b) {
...
inline bool qlt_above_lo(const qlt_endpoint& lo, const qlt_rational& x) {
...
inline bool qlt_below_hi(const qlt_endpoint& hi, const qlt_rational& x) {
...
inline bool qlt_hi_less(const qlt_endpoint& a, const qlt_endpoint& b) {
...
inline qlt_endpoint qlt_lo_max(const qlt_endpoint& a, const qlt_endpoint& b) {
...
inline qlt_endpoint qlt_hi_min(const qlt_endpoint& a, const qlt_endpoint& b) {
...
inline qlt_endpoint qlt_hi_max(const qlt_endpoint& a, const qlt_endpoint& b) {
...
inline bool qlt_piece_empty(const qlt_piece& p) {
...
inline bool qlt_pieces_overlap(const qlt_piece& a, const qlt_piece& b) {
...
inline bool qlt_pieces_adjacent(const qlt_piece& a, const qlt_piece& b) {
	if (a.lo.val.is_sym() || a.hi.val.is_sym() ||
	    b.lo.val.is_sym() || b.hi.val.is_sym()) return false;
...
inline qlt_piece qlt_merge(const qlt_piece& a, const qlt_piece& b) {
...
struct qlt {
	...
	auto operator<=>(const qlt& o) const {
...
// --- stream output ---
inline std::ostream& operator<<(std::ostream& os, const qlt& q) {
	return os << q.to_string();
}

// --- free functions expected by the dispatcher ---

inline bool is_qlt_zero(const qlt& x) { return x.is_empty(); }
inline bool is_qlt_one(const qlt& x) { return x.is_full(); }
inline qlt normalize_qlt(const qlt& x) { return x; }
inline tref simplify_qlt_symbol(tref sym) { return sym; }
inline tref simplify_qlt_term(tref t) { return t; }

// Splitter: return a non-zero strict sub-element
inline qlt qlt_splitter(const qlt& x, splitter_type /*st*/) {
