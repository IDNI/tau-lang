 ...
 * `max_simplify_rounds`, 0 = unlimited). Additive blocks fold fully (Z/2^n
 * is a group under `+`); a multiplicative block is folded only when it
 * contains no division, since `bvudiv` neither inverts `bvmul` nor
 * reassociates.
 *
