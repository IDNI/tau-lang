...
tau_depreciating<BAs...> first_argument_formula(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> first_argument_expression(const depreciating::rewriter::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[0]->child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> second_argument_formula(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[1];
}

template <typename...BAs>
tau_depreciating<BAs...> second_argument_expression(const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	return n.child[0]->child[1]->child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> third_argument_formula(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[2];
}

template <typename...BAs>
tau_depreciating<BAs...> third_argument_expression(const depreciating::rewriter::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[2]->child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> logic_operator(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> quantifier(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau_depreciating<BAs...> quantified_formula(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[0];
}

template<typename...BAs>
std::optional<tau_depreciating<BAs...>> type_of(const tau_depreciating<BAs...>& e)
{
	return e | tau_parser::type;
}

template<typename...BAs>
bool unbinded_subexpressionns(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template<typename...BAs>
tau_depreciating<BAs...> make_node_hook_cte_or(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	...
	return l && r ? build_bf_constant<BAs...>(l.value() | r.value(), type)
		: std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
}

template<typename...BAs>
tau_depreciating<BAs...> build_bf_1(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
	...
	return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
}

template<typename...BAs>
tau_depreciating<BAs...> build_bf_0(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_bf_or(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	// RULE(UNBINDED, UNBINDED_SUBEXPRESSIONS, NODE)
	if (unbinded_subexpressionns(n)) return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_cte_and(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto l = first_argument_expression(n)
		| tau_parser::constant
		| only_child_extractor<BAs...>
		| ba_extractor<BAs...>;
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_bf_and(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	// RULE(UNBINDED, UNBINDED_SUBEXPRESSIONS, NODE)
	if (unbinded_subexpressionns(n)) return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
	//RULE(BF_SIMPLIFY_ONE_00, "1 & 1 := 1.")
	if (is_non_terminal<tau_parser::bf_t>(first_argument_expression(n))
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_cte_neg(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto l = first_argument_expression(n)
		| tau_parser::constant
		| only_child_extractor<BAs...>
		| ba_extractor<BAs...>;
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_bf_neg(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_cte_xor(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	auto l = first_argument_expression(n)
		| tau_parser::constant
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_bf_xor(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	// RULE(UNBINDED, UNBINDED_SUBEXPRESSIONS, NODE)
	if (unbinded_subexpressionns(n)) return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_cte(const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	auto l = n
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_ctn(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto sp_n = make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_ctn_neg(const tau_depreciating<BAs...>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_bf(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	...
	if (is_non_terminal_node<BAs...>(n.child[0]))
		switch (std::get<tau_source_sym>(n.child[0]->value).n()) {
			...
			default: return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
		}
	return std::make_shared<depreciating::rewriter::node<tau_sym<BAs...>>>(n);
}

template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_and(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_or(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_neg(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_wff_eq_cte(const depreciating::rewriter::node<tau_sym<BAs...>>& n){
	auto l = n
		| tau_parser::bf_eq
		| tau_parser::bf
		| tau_parser::bf_constant
...
template<typename... BAs>
tau_depreciating<BAs...> build_wff_t(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau_depreciating<BAs...> build_wff_f(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_eq(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename...BAs>
tau_depreciating<BAs...> make_node_hook_wff_neq_cte(const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	auto l = n
		| tau_parser::bf_neq
		| tau_parser::bf
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_neq(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_sometimes(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_always(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_less(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_nless(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_less_equal(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_nleq(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_greater(const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_ngreater(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
inline tau_depreciating<BAs...> make_node_hook_wff_greater_equal(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_ngeq(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_interval(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_xor(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_conditional(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_imply(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_rimply(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
	//RULE(WFF_IMPLY_SIMPLIFY_0, "F -> $X ::= T.")
	if (is_non_terminal<tau_parser::wff_f>(second_argument_expression(n)))
		return _T<BAs...>;
	//RULE(WFF_IMPLY_SIMPLIFY_1, "T -> $X ::= $X.")
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff_equiv(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_wff(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau_depreciating<BAs...> make_node_hook_shift(const depreciating::rewriter::node<tau_sym<BAs...>>& n) {
...
template <typename...BAs>
std::optional<tau_depreciating<BAs...>> make_tau_node<BAs...>::operator()(
	const depreciating::rewriter::node<tau_sym<BAs...>>& n)
{
	if (is_non_terminal_node<BAs...>(n)) {
		switch (get_non_terminal_node(n)) {
			...
			default: return std::optional<tau_depreciating<BAs...>>();
		}
	}
...
template <typename...BAs>
std::optional<idni::tau_lang::tau_depreciating<BAs...>> make_node_hook<idni::tau_lang::tau_sym<BAs...>>::operator()(
