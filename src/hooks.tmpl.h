...
tau<BAs...> first_argument_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[0];
}

template <typename...BAs>
tau<BAs...> first_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[0]->child[0];
}

template <typename...BAs>
tau<BAs...> second_argument_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[1];
}

template <typename...BAs>
tau<BAs...> second_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
	return n.child[0]->child[1]->child[0];
}

template <typename...BAs>
tau<BAs...> third_argument_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[2];
}

template <typename...BAs>
tau<BAs...> third_argument_expression(const rewriter::depreciating::node<tau_sym<BAs...>>& n){
	return n.child[0]->child[2]->child[0];
}

template <typename...BAs>
tau<BAs...> logic_operator(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau<BAs...> quantifier(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0];
}

template <typename...BAs>
tau<BAs...> quantified_formula(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	return n.child[0]->child[0];
}
...
template<typename...BAs>
bool unbinded_subexpressionns(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	...
	const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
	...
	return l && r ? build_bf_constant<BAs...>(l.value() | r.value(), type)
		: std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
}

template<typename...BAs>
tau<BAs...> build_bf_1(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename...BAs>
tau<BAs...> build_bf_0(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template <typename...BAs>
tau<BAs...> make_node_hook_bf_or(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename...BAs>
tau<BAs...> make_node_hook_cte_and(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto l = first_argument_expression(n)
		| tau_parser::constant
		| only_child_extractor<BAs...>
		| ba_extractor<BAs...>;
...
template <typename... BAs>
tau<BAs...> make_node_hook_bf_and(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	// RULE(UNBINDED, UNBINDED_SUBEXPRESSIONS, NODE)
	if (unbinded_subexpressionns(n)) return std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
	//RULE(BF_SIMPLIFY_ONE_00, "1 & 1 := 1.")
	if (is_non_terminal<tau_parser::bf_t>(first_argument_expression(n))
...
template <typename...BAs>
tau<BAs...> make_node_hook_cte_neg(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto l = first_argument_expression(n)
		| tau_parser::constant
		| only_child_extractor<BAs...>
		| ba_extractor<BAs...>;
...
template <typename... BAs>
tau<BAs...> make_node_hook_bf_xor(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	// RULE(UNBINDED, UNBINDED_SUBEXPRESSIONS, NODE)
	if (unbinded_subexpressionns(n)) return std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
...
template <typename...BAs>
tau<BAs...> make_node_hook_cte(const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
	auto l = n
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_ctn(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_bf(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	...
	if (is_non_terminal_node<BAs...>(n.child[0]))
		switch (std::get<tau_source_sym>(n.child[0]->value).n()) {
			...
			default: return std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
		}
	return std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
}

template <typename... BAs>
tau<BAs...> make_node_hook_wff_and(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_or(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_z3_literal(const tau_parser::nonterminal nt, const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_neg(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	...
	switch (get_non_terminal_node(first_argument_expression(n))) {
		case tau_parser::bv_eq:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_neq, n);
		case tau_parser::bv_neq:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_eq, n);
		case tau_parser::bv_less_equal:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_nleq, n);
		case tau_parser::bv_nleq:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_less_equal, n);
		case tau_parser::bv_greater_equal:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_ngeq, n);
		case tau_parser::bv_ngeq:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_greater_equal, n);
		case tau_parser::bv_less:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_nless, n);
		case tau_parser::bv_nless:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_less, n);
		case tau_parser::bv_greater:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_ngreater, n);
		case tau_parser::bv_ngreater:
			return make_node_hook_z3_literal<BAs...>(tau_parser::bv_greater, n);
	}
	return std::make_shared<rewriter::depreciating::node<tau_sym<BAs...>>>(n);
}

template <typename...BAs>
tau<BAs...> make_node_hook_wff_eq_cte(const rewriter::depreciating::node<tau_sym<BAs...>>& n){
	auto l = n
		| tau_parser::bf_eq
		| tau_parser::bf
		| tau_parser::bf_constant
...
template<typename... BAs>
tau<BAs...> build_wff_t(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau<BAs...> build_wff_f(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	auto type_l = type_of(first_argument_expression(n));
	auto type_r = type_of(second_argument_expression(n));
...
template<typename... BAs>
tau<BAs...> make_node_hook_wff_eq(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename...BAs>
tau<BAs...> make_node_hook_wff_neq_cte(const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
	auto l = n
		| tau_parser::bf_neq
		| tau_parser::bf
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_neq(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_less(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_nless(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_nleq(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_greater(const rewriter::depreciating::node<tau_sym<BAs...>>& n)
{
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_ngeq(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_xor(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_imply(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_rimply(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
	//RULE(WFF_IMPLY_SIMPLIFY_0, "F -> $X ::= T.")
	if (is_non_terminal<tau_parser::wff_f>(second_argument_expression(n)))
		return _T<BAs...>;
	//RULE(WFF_IMPLY_SIMPLIFY_1, "T -> $X ::= $X.")
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff_equiv(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_wff(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_shift(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
template <typename... BAs>
tau<BAs...> make_node_hook_bitvector(const rewriter::depreciating::node<tau_sym<BAs...>>& n) {
...
std::optional<idni::tau_lang::tau<BAs...>> make_node_hook<idni::tau_lang::tau_sym<BAs...>>::operator()(
		const rewriter::depreciating::node<idni::tau_lang::tau_sym<BAs...>>& n) {
