 ...
 * rewriter::depreciating::pre_order class
 */
enum MemorySlotPre {
	normalize_ba_m,
	push_negation_in_m,
...
/**
 * This enum holds the possible memory slots for traversals using the
 * rewriter::depreciating::post_order class
 */
enum MemorySlotPost {
	anti_prenex_m
};
...
tau<BAs...> to_mnf (const tau<BAs...>& fm) {
	...
	return rewriter::depreciating::pre_order(fm).apply_unique(neq_to_eq, visit_wff<BAs...>, rewriter::depreciating::identity);
}
...
tau<BAs...> from_mnf_to_nnf (const tau<BAs...>& fm) {
	...
	return rewriter::depreciating::pre_order(fm).apply_unique(ne_to_neq, visit_wff<BAs...>, rewriter::depreciating::identity);
}
...
tau<BAs...> unsqueeze_wff (const tau<BAs...>& fm) {
	...
	return rewriter::depreciating::pre_order(fm).apply_unique(f, visit_wff<BAs...>, rewriter::depreciating::identity);
}
...
tau<BAs...> squeeze_wff (const tau<BAs...>& fm) {
	...
	return rewriter::depreciating::post_order(fm).apply_unique(f, visit_wff<BAs...>);
}
...
tau<BAs...> push_negation_in(const tau<BAs...>& fm) {
	...
	apply_unique<MemorySlotPre::push_negation_in_m>(
		pn, idni::all, rewriter::depreciating::identity);
}
...
tau<BAs...> to_cnf(const tau<BAs...>& fm) {
	...
	// if (is_wff) return rewriter::depreciating::pre_order(fm).template apply_unique<6>(pn, all, layer_to_cnf);
	if constexpr (is_wff) return rewriter::depreciating::pre_order(fm).template
	apply_unique<MemorySlotPre::to_cnf2_m>(
		pn, visit_wff<BAs...>, layer_to_cnf);
	else return rewriter::depreciating::pre_order(fm).template
	apply_unique<MemorySlotPre::to_cnf2_m>(
		pn, idni::all, layer_to_cnf);
}
