...
add_test(NAME "test_repl-ltl_env-export_hoa"
	COMMAND bash -c "TAU_LTL_EXPORT_STRATEGY=hoa $<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (o1[t] = 1))\" 2>&1")
...
add_test(NAME "test_repl-ltl_env-export_dot"
	COMMAND bash -c "TAU_LTL_EXPORT_STRATEGY=dot $<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (o1[t] = 1))\" 2>&1")
...
add_test(NAME "test_repl-ltl_env-export_off_by_default"
	COMMAND bash -c "$<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (o1[t] = 1))\" 2>&1")
...
add_test(NAME "test_repl-ltl_env-witness"
	COMMAND bash -c "TAU_LTL_WITNESS=1 $<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (i1[t] = 1))\" 2>&1")
...
add_test(NAME "test_repl-ltl_env-bad_simplification_is_unknown"
	COMMAND bash -c "TAU_LTL_SIMPLIFICATION=definitely-not-a-level $<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (o1[t] = 1))\" 2>&1")
...
add_test(NAME "test_repl-ltl_env-timeout_garbage_warns"
	COMMAND bash -c "TAU_LTL_TIMEOUT_SEC=abc $<TARGET_FILE:${TAU_EXECUTABLE_NAME}> -e \"ltl G (F (o1[t] = 1))\" 2>&1")
