...
TEST_SUITE("parsing bf rules") {
	...
	TEST_CASE("BF_SIMPLIFY_ONE_0") {
		CHECK( test_rule(BF_SIMPLIFY_ONE_0, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ONE_1") {
		CHECK( test_rule(BF_SIMPLIFY_ONE_1, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ONE_2") {
		CHECK( test_rule(BF_SIMPLIFY_ONE_2, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ONE_3") {
		CHECK( test_rule(BF_SIMPLIFY_ONE_3, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ONE_4") {
		CHECK( test_rule(BF_SIMPLIFY_ONE_4, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ZERO_0") {
		CHECK( test_rule(BF_SIMPLIFY_ZERO_0, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ZERO_1") {
		CHECK( test_rule(BF_SIMPLIFY_ZERO_1, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ZERO_2") {
		CHECK( test_rule(BF_SIMPLIFY_ZERO_2, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ZERO_3") {
		CHECK( test_rule(BF_SIMPLIFY_ZERO_3, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_ZERO_4") {
		CHECK( test_rule(BF_SIMPLIFY_ZERO_4, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_0") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_0, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_1") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_1, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_2") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_2, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_3") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_3, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_4") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_4, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_SIMPLIFY_SELF_5") {
		CHECK( test_rule(BF_SIMPLIFY_SELF_5, tau_parser::bf_rule) );
	}

	TEST_CASE("BF_DEF_XOR") {
		CHECK( test_rule(BF_DEF_XOR, tau_parser::bf_rule) );
	}
