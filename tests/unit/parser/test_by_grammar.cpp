...
TEST_CASE("[SHAPE-A-01] F(F(F(A1)))") { tref fm = spec("F (F (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-02] F(F(G(A1)))") { tref fm = spec("F (F (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-03] F(F(!A1))") { tref fm = spec("F (F (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-04] F(G(F(A1)))") { tref fm = spec("F (G (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-05] F(G(G(A1)))") { tref fm = spec("F (G (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-06] F(G(!A1))") { tref fm = spec("F (G (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-07] F(!(F(A1)))") { tref fm = spec("F (! (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-08] F(!(G(A1)))") { tref fm = spec("F (! (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-09] F(!(!A1))") { tref fm = spec("F (! (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }

TEST_CASE("[SHAPE-A-10] G(F(F(A1)))") { tref fm = spec("G (F (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-11] G(F(G(A1)))") { tref fm = spec("G (F (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-12] G(F(!A1))") { tref fm = spec("G (F (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-13] G(G(F(A1)))") { tref fm = spec("G (G (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-14] G(G(G(A1)))") { tref fm = spec("G (G (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-15] G(G(!A1))") { tref fm = spec("G (G (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-16] G(!(F(A1)))") { tref fm = spec("G (! (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-17] G(!(F(A1))) — G(!(G())) triggers nested-G restriction") { tref fm = spec("G (! (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-18] G(!(!A1))") { tref fm = spec("G (! (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }

TEST_CASE("[SHAPE-A-19] !(F(F(A1)))") { tref fm = spec("! (F (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-20] !(F(G(A1)))") { tref fm = spec("! (F (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-21] !(F(!A1))") { tref fm = spec("! (F (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-22] !(G(F(A1)))") { tref fm = spec("! (G (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-23] !(G(G(A1)))") { tref fm = spec("! (G (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-24] !(G(!A1))") { tref fm = spec("! (G (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-25] !(!(F(A1)))") { tref fm = spec("! (! (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-26] !(!(G(A1)))") { tref fm = spec("! (! (G (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-A-27] !(!(!A1))") { tref fm = spec("! (! (! (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-D-01] bf_eq: F(F(F(o1 = {1/2}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt = {1/2}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-02] bf_neq: F(F(F(o1 != {1/2}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt != {1/2}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-03] bf_lt: F(F(F(o1 < {1}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt < {1}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-04] bf_nlt: F(F(F(o1 !< {1}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt !< {1}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-05] bf_lteq: F(F(F(o1 <= {1}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt <= {1}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-06] bf_nlteq: F(F(F(o1 !<= {0}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt !<= {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-07] bf_gt: F(F(F(o1 > {0}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-D-08] bf_ngt: F(F(F(o1 !> {1}:qlt)))") { tref fm = spec("F (F (F (o1[t]:qlt !> {1}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-F-01] bf_and: F(F(F(o1={X&Y}:sbf)))") { tref fm = spec("F (F (F (o1[t]:sbf = {X & Y}:sbf)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-F-02] bf_or: F(F(F(o1={X|(Y&Z)}:sbf)))") { tref fm = spec("F (F (F (o1[t]:sbf = {X | (Y & Z)}:sbf)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-F-03] bf_xor: F(F(F(o1={X^Y}:sbf)))") { tref fm = spec("F (F (F (o1[t]:sbf = {X ^ Y}:sbf)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-J-01] G(all x F(F(F(o1:bv[8]=x:bv[8]))))") { tref fm = spec("G (all x F (F (F (o1[t]:bv[8] = x:bv[8]))))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-J-02] G(ex x F(F(F(o1:bv[8]=x:bv[8]))))") { tref fm = spec("G (ex x F (F (F (o1[t]:bv[8] = x:bv[8]))))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-J-03] F(all x G(o1:bv[8]=x:bv[8]))") { tref fm = spec("F (all x G (o1[t]:bv[8] = x:bv[8]))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-J-04] F(ex x G(F(o1:bv[8]=x:bv[8])))") { tref fm = spec("F (ex x G (F (o1[t]:bv[8] = x:bv[8])))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-J-05] G(all x ex y F((o1:bv[8]=x)&&(o2:bv[8]=y)))") { tref fm = spec("G (all x ex y F ((o1[t]:bv[8] = x:bv[8]) && (o2[t]:bv[8] = y:bv[8])))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-K-01] F(F T) — wff_t in F") { tref fm = spec("F (F T)."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-K-02] G(T)") { tref fm = spec("G T."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-K-03] G(F T)") { tref fm = spec("G (F T)."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-L-01] F(F(A1?A2:A3))") { tref fm = spec("F (F ((o1[t]:qlt > {0}:qlt) ? (o2[t]:qlt > {0}:qlt) : (o3[t]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
...
TEST_CASE("[SHAPE-N-01] F(F(F(o1[t-1]>{0}:qlt)))") { tref fm = spec("F (F (F (o1[t-1]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-N-02] F(F(F(o1[t-2]>{0}:qlt)))") { tref fm = spec("F (F (F (o1[t-2]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
TEST_CASE("[SHAPE-N-03] F(F(F(o1[t-3]>{0}:qlt)))") { tref fm = spec("F (F (F (o1[t-3]:qlt > {0}:qlt)))."); REQUIRE(fm != nullptr); CHECK(sat(fm)); }
