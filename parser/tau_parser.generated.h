...
//G539: cli_command(260)     => toggle_cmd(389).
	p(NT(260), (NT(389)));
//G540: cli_command(260)     => comment(253).
	p(NT(260), (NT(253)));
//G541: bf_cmd_arg(318)      => memory(357).
	p(NT(318), (NT(357)));
//G542: bf_cmd_arg(318)      => bf_selection(393).
	p(NT(318), (NT(393)));
//G543: bf_cmd_arg(318)      => bf(41).
	p(NT(318), (NT(41)));
//G544: bf_cmd_out_arg(319)  => memory(357).
	p(NT(319), (NT(357)));
//G545: bf_cmd_out_arg(319)  => bf_selection(393).
	p(NT(319), (NT(393)));
//G546: wff_cmd_arg(295)     => memory(357).
	p(NT(295), (NT(357)));
//G547: wff_cmd_arg(295)     => wff_selection(394).
	p(NT(295), (NT(394)));
//G548: wff_cmd_arg(295)     => wff(32).
	p(NT(295), (NT(32)));
//G549: wff_cmd_out_arg(311) => memory(357).
	p(NT(311), (NT(357)));
//G550: wff_cmd_out_arg(311) => wff_selection(394).
	p(NT(311), (NT(394)));
//G551: nf_cmd_arg(325)      => memory(357).
	p(NT(325), (NT(357)));
//G552: nf_cmd_arg(325)      => bf(41).
	p(NT(325), (NT(41)));
//G553: nf_cmd_arg(325)      => wff(32).
	p(NT(325), (NT(32)));
//G554: onf_cmd_arg(347)     => memory(357).
	p(NT(347), (NT(357)));
//G555: onf_cmd_arg(347)     => wff(32).
	p(NT(347), (NT(32)));
//G556: normalize_cmd_arg(306) => memory(357).
	p(NT(306), (NT(357)));
//G557: normalize_cmd_arg(306) => bf(41).
	p(NT(306), (NT(41)));
//G558: normalize_cmd_arg(306) => wff(32).
	p(NT(306), (NT(32)));
//G559: normalize_cmd_arg(306) => nso_rr(14).
	p(NT(306), (NT(14)));
//G560: help_arg(277)        => help_sym(274).
	p(NT(277), (NT(274)));
//G561: help_arg(277)        => version_sym(267).
	p(NT(277), (NT(267)));
//G562: help_arg(277)        => quit_sym(264).
	p(NT(277), (NT(264)));
//G563: help_arg(277)        => clear_sym(270).
	p(NT(277), (NT(270)));
//G564: help_arg(277)        => get_sym(381).
	p(NT(277), (NT(381)));
//G565: help_arg(277)        => set_sym(386).
	p(NT(277), (NT(386)));
//G566: help_arg(277)        => toggle_sym(391).
	p(NT(277), (NT(391)));
//G567: help_arg(277)        => file_sym(280).
	p(NT(277), (NT(280)));
//G568: help_arg(277)        => memory_sym(364).
	p(NT(277), (NT(364)));
//G569: help_arg(277)        => abs_memory_sym(395).
	p(NT(277), (NT(395)));
//G570: help_arg(277)        => rel_memory_sym(396).
	p(NT(277), (NT(396)));
//G571: help_arg(277)        => selection_sym(397).
	p(NT(277), (NT(397)));
//G572: help_arg(277)        => def_sym(350).
	p(NT(277), (NT(350)));
//G573: help_arg(277)        => inst_sym(309).
	p(NT(277), (NT(309)));
//G574: help_arg(277)        => subst_sym(314).
	p(NT(277), (NT(314)));
//G575: help_arg(277)        => normalize_sym(304).
	p(NT(277), (NT(304)));
//G576: help_arg(277)        => execute_sym(298).
	p(NT(277), (NT(298)));
//G577: help_arg(277)        => solve_sym(293).
	p(NT(277), (NT(293)));
//G578: help_arg(277)        => valid_sym(284).
	p(NT(277), (NT(284)));
//G579: help_arg(277)        => sat_sym(287).
	p(NT(277), (NT(287)));
//G580: help_arg(277)        => unsat_sym(290).
	p(NT(277), (NT(290)));
//G581: help_arg(277)        => dnf_sym(324).
	p(NT(277), (NT(324)));
//G582: help_arg(277)        => cnf_sym(328).
	p(NT(277), (NT(328)));
//G583: help_arg(277)        => anf_sym(331).
	p(NT(277), (NT(331)));
//G584: help_arg(277)        => snf_sym(343).
	p(NT(277), (NT(343)));
//G585: help_arg(277)        => nnf_sym(334).
	p(NT(277), (NT(334)));
//G586: help_arg(277)        => pnf_sym(337).
	p(NT(277), (NT(337)));
//G587: help_arg(277)        => mnf_sym(340).
	p(NT(277), (NT(340)));
//G588: help_arg(277)        => onf_sym(346).
	p(NT(277), (NT(346)));
//G589: help_arg(277)        => qelim_sym(378).
	p(NT(277), (NT(378)));
//G590: __E___E_help_arg_160_161(400) => 's'.
	p(NT(400), (T(36)));
//G591: __E___E_help_arg_160_161(400) => null.
	p(NT(400), (nul));
//G592: __E_help_arg_160(399) => 'e' 'x' 'a' 'm' 'p' 'l' 'e' __E___E_help_arg_160_161(400).
	p(NT(399), (T(19)+T(20)+T(18)+T(47)+T(35)+T(16)+T(19)+NT(400)));
//G593: examples_sym(398)    => __E_help_arg_160(399).
	p(NT(398), (NT(399)));
//G594: help_arg(277)        => examples_sym(398).
	p(NT(277), (NT(398)));
//G595: rel_memory_sym(396)  => '%'.
	p(NT(396), (T(57)));
//G596: memory_id(404)       => digits(239).
	p(NT(404), (NT(239)));
//G597: __E___E_memory_162_163(403) => memory_id(404).
	p(NT(403), (NT(404)));
//G598: __E___E_memory_162_163(403) => null.
	p(NT(403), (nul));
//G599: __E_memory_162(402)  => rel_memory_sym(396) __E___E_memory_162_163(403).
	p(NT(402), (NT(396)+NT(403)));
//G600: rel_memory(401)      => __E_memory_162(402).
	p(NT(401), (NT(402)));
//G601: memory(357)          => rel_memory(401).
	p(NT(357), (NT(401)));
//G602: abs_memory_sym(395)  => '%' '-'.
	p(NT(395), (T(57)+T(21)));
//G603: __E___E_memory_164_165(407) => abs_memory_sym(395).
	p(NT(407), (NT(395)));
//G604: __E___E_memory_164_165(407) => memory_sym(364) __(72).
	p(NT(407), (NT(364)+NT(72)));
//G605: __E_memory_164(406)  => __E___E_memory_164_165(407) memory_id(404).
	p(NT(406), (NT(407)+NT(404)));
//G606: abs_memory(405)      => __E_memory_164(406).
	p(NT(405), (NT(406)));
//G607: memory(357)          => abs_memory(405).
	p(NT(357), (NT(405)));
//G608: selection_sym(397)   => 's'.
	p(NT(397), (T(36)));
//G609: selection_sym(397)   => 's' 'e' 'l' 'e' 'c' 't' 'i' 'o' 'n'.
	p(NT(397), (T(36)+T(19)+T(16)+T(19)+T(34)+T(32)+T(37)+T(15)+T(44)));
//G610: wff_selection(394)   => selection_sym(397) __(72) digits(239).
	p(NT(394), (NT(397)+NT(72)+NT(239)));
//G611: bf_selection(393)    => selection_sym(397) __(72) digits(239).
	p(NT(393), (NT(397)+NT(72)+NT(239)));
//G612: bf_var_selection(408) => selection_sym(397) __(72) digits(239).
	p(NT(408), (NT(397)+NT(72)+NT(239)));
//G613: wff_var_selection(409) => selection_sym(397) __(72) digits(239).
	p(NT(409), (NT(397)+NT(72)+NT(239)));
//G614: option(383)          => bool_option(392).
	p(NT(383), (NT(392)));
//G615: __E_option_166(412)  => 's' 'e' 'v'.
	p(NT(412), (T(36)+T(19)+T(38)));
//G616: __E_option_166(412)  => 's' 'e' 'v' 'e' 'r' 'i' 't' 'y'.
	p(NT(412), (T(36)+T(19)+T(38)+T(19)+T(40)+T(37)+T(32)+T(56)));
//G617: severity_opt(411)    => __E_option_166(412).
	p(NT(411), (NT(412)));
//G618: enum_option(410)     => severity_opt(411).
	p(NT(410), (NT(411)));
//G619: option(383)          => enum_option(410).
	p(NT(383), (NT(410)));
//G620: __E_bool_option_167(414) => 's'.
	p(NT(414), (T(36)));
//G621: __E_bool_option_167(414) => 's' 't' 'a' 't' 'u' 's'.
	p(NT(414), (T(36)+T(32)+T(18)+T(32)+T(33)+T(36)));
//G622: status_opt(413)      => __E_bool_option_167(414).
	p(NT(413), (NT(414)));
//G623: bool_option(392)     => status_opt(413).
	p(NT(392), (NT(413)));
//G624: __E_bool_option_168(416) => 'c'.
	p(NT(416), (T(34)));
//G625: __E_bool_option_168(416) => 'c' 'o' 'l' 'o' 'r'.
	p(NT(416), (T(34)+T(15)+T(16)+T(15)+T(40)));
//G626: __E_bool_option_168(416) => 'c' 'o' 'l' 'o' 'r' 's'.
	p(NT(416), (T(34)+T(15)+T(16)+T(15)+T(40)+T(36)));
//G627: colors_opt(415)      => __E_bool_option_168(416).
	p(NT(415), (NT(416)));
//G628: bool_option(392)     => colors_opt(415).
	p(NT(392), (NT(415)));
//G629: __E_bool_option_169(418) => 'd'.
	p(NT(418), (T(41)));
//G630: __E_bool_option_169(418) => 'd' 'b' 'g'.
	p(NT(418), (T(41)+T(14)+T(46)));
//G631: __E_bool_option_169(418) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(418), (T(41)+T(19)+T(14)+T(33)+T(46)));
//G632: debug_repl_opt(417)  => __E_bool_option_169(418).
	p(NT(417), (NT(418)));
//G633: bool_option(392)     => debug_repl_opt(417).
	p(NT(392), (NT(417)));
//G634: option_value(388)    => option_value_true(419).
	p(NT(388), (NT(419)));
//G635: option_value(388)    => option_value_false(420).
	p(NT(388), (NT(420)));
//G636: option_value(388)    => severity(421).
	p(NT(388), (NT(421)));
//G637: option_value_true(419) => 't'.
	p(NT(419), (T(32)));
//G638: option_value_true(419) => 't' 'r' 'u' 'e'.
	p(NT(419), (T(32)+T(40)+T(33)+T(19)));
//G639: option_value_true(419) => 'o' 'n'.
	p(NT(419), (T(15)+T(44)));
//G640: option_value_true(419) => '1'.
	p(NT(419), (T(29)));
//G641: option_value_true(419) => 'y'.
	p(NT(419), (T(56)));
//G642: option_value_true(419) => 'y' 'e' 's'.
	p(NT(419), (T(56)+T(19)+T(36)));
//G643: option_value_false(420) => 'f'.
	p(NT(420), (T(42)));
//G644: option_value_false(420) => 'f' 'a' 'l' 's' 'e'.
	p(NT(420), (T(42)+T(18)+T(16)+T(36)+T(19)));
//G645: option_value_false(420) => 'o' 'f' 'f'.
	p(NT(420), (T(15)+T(42)+T(42)));
//G646: option_value_false(420) => '0'.
	p(NT(420), (T(30)));
//G647: option_value_false(420) => 'n'.
	p(NT(420), (T(44)));
//G648: option_value_false(420) => 'n' 'o'.
	p(NT(420), (T(44)+T(15)));
//G649: __E_severity_170(423) => 'e'.
	p(NT(423), (T(19)));
//G650: __E_severity_170(423) => 'e' 'r' 'r' 'o' 'r'.
	p(NT(423), (T(19)+T(40)+T(40)+T(15)+T(40)));
//G651: error_sym(422)       => __E_severity_170(423).
	p(NT(422), (NT(423)));
//G652: severity(421)        => error_sym(422).
	p(NT(421), (NT(422)));
//G653: __E_severity_171(425) => 'i'.
	p(NT(425), (T(37)));
//G654: __E_severity_171(425) => 'i' 'n' 'f' 'o'.
	p(NT(425), (T(37)+T(44)+T(42)+T(15)));
//G655: info_sym(424)        => __E_severity_171(425).
	p(NT(424), (NT(425)));
//G656: severity(421)        => info_sym(424).
	p(NT(421), (NT(424)));
//G657: __E_severity_172(427) => 'd'.
	p(NT(427), (T(41)));
//G658: __E_severity_172(427) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(427), (T(41)+T(19)+T(14)+T(33)+T(46)));
//G659: debug_sym(426)       => __E_severity_172(427).
	p(NT(426), (NT(427)));
//G660: severity(421)        => debug_sym(426).
	p(NT(421), (NT(426)));
//G661: __E_severity_173(429) => 't'.
	p(NT(429), (T(32)));
//G662: __E_severity_173(429) => 't' 'r' 'a' 'c' 'e'.
	p(NT(429), (T(32)+T(40)+T(18)+T(34)+T(19)));
//G663: trace_sym(428)       => __E_severity_173(429).
	p(NT(428), (NT(429)));
//G664: severity(421)        => trace_sym(428).
	p(NT(421), (NT(428)));
	#undef T
	#undef NT
