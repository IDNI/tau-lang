...
struct tau_parser {
	tau_parser() :
		...
		g(nts, load_prods(), nt(159), cc), p(g, load_opts()) {}
   ...
   enum nonterminal {
			...
			var_in, var_out, _Rtimed_9, wff_def, wff_rule, wff_head, wff_body, wff, wff_head_args, _Rwff_head_args_10, 
			_Rwff_head_args_11, wff_eq, wff_neq, wff_ref, wff_and, wff_neg, wff_xor, wff_or, wff_all, wff_ex, 
			bf, F, wff_and_sym, wff_or_sym, wff_xor_sym, wff_neg_sym, wff_all_sym, wff_ex_sym, cbf_def, cbf_rule, 
			cbf_head, cbf, _Rcbf_head_12, _Rcbf_head_13, cbf_if, cbf_ref, cbf_and, cbf_neg, cbf_xor, cbf_or, 
			...
			bf_rule, bf_constant, bf_ref, bf_and, bf_neg, bf_xor, bf_or, bf_all, bf_ex, bf_and_sym, 
			bf_or_sym, bf_xor_sym, bf_neg_sym, bf_all_sym, bf_ex_sym, constant, T, bf_builtin, binding, bf_and_cb, 
			bf_or_cb, bf_xor_cb, bf_neg_cb, bf_subs_cb, source_binding, named_binding, type, source, source_punct, _Rsource_punct_14, 
			_Rsource_punct_15, _Rsource_punct_16, source0, _Rsource_17, _Rsource_18, bf_cb_arg, bf_and_cb_sym, bf_or_cb_sym, bf_xor_cb_sym, neg_cb_sym, 
			subs_cb_sym, bf_neg_cb_sym, main, rule, program, _Rprogram_19, _Rprogram_20, library, _Rlibrary_21, start, 
   };
...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(63), (nt(64)+nt(36)));
		q(nt(64), (nt(65)+nt(34)+nt(66)+nt(36)));
		q(nt(66), (nt(67)));
		q(nt(65), (nt(33)+nt(48)+nt(68)));
		q(nt(69), (nt(52)));
		q(nt(70), (nt(69)+nt(70)));
		q(nt(70), (nul));
		q(nt(68), (nt(37)+nt(70)+nt(38)));
		q(nt(67), (nt(71)));
		q(nt(67), (nt(72)));
		q(nt(67), (nt(73)));
		q(nt(67), (nt(74)));
		...
		q(nt(67), (nt(78)));
		q(nt(67), (nt(79)));
		q(nt(71), (nt(37)+nt(80)+nt(34)+nt(81)+nt(38)));
		q(nt(72), (nt(37)+nt(80)+nt(35)+nt(81)+nt(38)));
		q(nt(73), (nt(65)));
		q(nt(74), (nt(37)+nt(67)+nt(82)+nt(67)+nt(38)));
		q(nt(77), (nt(37)+nt(67)+nt(83)+nt(67)+nt(38)));
		q(nt(76), (nt(37)+nt(67)+nt(84)+nt(67)+nt(38)));
		q(nt(75), (nt(85)+nt(37)+nt(67)+nt(38)));
		q(nt(78), (nt(86)+nt(52)+nt(37)+nt(67)+nt(38)));
		q(nt(79), (nt(87)+nt(52)+nt(37)+nt(67)+nt(38)));
		...
		q(nt(88), (nt(89)+nt(36)));
		q(nt(89), (nt(90)+nt(34)+nt(91)+nt(36)));
		q(nt(92), (nt(52)));
		q(nt(93), (nt(92)+nt(93)));
		q(nt(93), (nul));
		q(nt(90), (nt(33)+nt(48)+nt(37)+nt(93)+nt(38)));
		q(nt(91), (nt(80)));
		q(nt(91), (nt(94)));
		q(nt(91), (nt(95)));
		q(nt(91), (nt(96)));
		...
		q(nt(91), (nt(99)));
		q(nt(95), (nt(90)));
		q(nt(94), (nt(100)+nt(37)+nt(101)+nt(38)+nt(102)+nt(103)+nt(104)+nt(105)));
		q(nt(101), (nt(67)));
		q(nt(103), (nt(91)));
		q(nt(105), (nt(91)));
		q(nt(96), (nt(37)+nt(91)+nt(106)+nt(91)+nt(38)));
		q(nt(97), (nt(107)+nt(37)+nt(91)+nt(38)));
		q(nt(98), (nt(37)+nt(91)+nt(108)+nt(91)+nt(38)));
		q(nt(99), (nt(37)+nt(91)+nt(109)+nt(91)+nt(38)));
		...
		q(nt(110), (nt(13)+nt(80)+nt(34)+nt(80)+nt(13)+nt(36)));
		q(nt(80), (nt(52)));
		q(nt(80), (nt(59)));
		q(nt(80), (nt(80)));
		q(nt(80), (nt(111)));
		...
		q(nt(80), (nt(117)));
		q(nt(80), (nt(118)));
		q(nt(113), (nt(37)+nt(80)+nt(119)+nt(80)+nt(38)));
		q(nt(116), (nt(37)+nt(80)+nt(120)+nt(38)));
		q(nt(115), (nt(37)+nt(80)+nt(121)+nt(13)+nt(80)+nt(38)));
		q(nt(114), (nt(122)+nt(37)+nt(80)+nt(38)));
		q(nt(117), (nt(123)+nt(52)+nt(37)+nt(80)+nt(38)));
		q(nt(118), (nt(124)+nt(52)+nt(37)+nt(80)+nt(38)));
		...
		q(nt(128), (nt(135)));
		q(nt(135), (nt(29)));
		q(nt(134), (nt(136)+nt(47)+nt(137)));
		q(nt(136), (nt(29)));
		q(nt(139), (nt(17)+nt(18)));
		q(nt(140), (nt(17)+nt(19)));
		q(nt(141), (nt(17)+nt(20)));
		q(nt(138), (nt(7)) & ~(nt(18)) & ~(nt(19)) & ~(nt(20)) & ~(nt(41)) & ~(nt(42)) & ~(nt(139)) & ~(nt(140)) & ~(nt(141)));
		q(nt(142), (nt(2)));
		q(nt(142), (nt(6)));
		q(nt(142), (nt(16)));
		q(nt(142), (nt(138)));
		q(nt(143), (nt(142)));
		q(nt(144), (nt(143)));
		q(nt(144), (nt(143)+nt(144)));
		q(nt(137), (nt(144)));
		q(nt(129), (nt(145)+nt(146)+nt(145)));
		q(nt(130), (nt(145)+nt(147)+nt(145)));
		q(nt(131), (nt(145)+nt(148)+nt(145)));
		q(nt(132), (nt(149)+nt(145)));
		q(nt(133), (nt(150)+nt(145)+nt(145)+nt(145)));
		q(nt(145), (nt(58)));
		q(nt(145), (nt(81)));
		q(nt(145), (nt(126)));
		q(nt(146), (nt(13)+t(16)+t(26)+t(43)+t(10)+t(12)+t(21)+t(43)+t(18)+t(16)+nt(13)));
		q(nt(147), (nt(13)+t(16)+t(26)+t(43)+t(25)+t(20)+t(43)+t(18)+t(16)+nt(13)));
		q(nt(148), (nt(13)+t(16)+t(26)+t(43)+t(5)+t(25)+t(20)+t(43)+t(18)+t(16)+nt(13)));
		q(nt(151), (nt(13)+t(16)+t(26)+t(43)+t(12)+t(24)+t(23)+t(43)+t(18)+t(16)+nt(13)));
		q(nt(150), (nt(13)+t(16)+t(26)+t(43)+t(28)+t(6)+t(16)+t(28)+t(43)+t(18)+t(16)+nt(13)));
		q(nt(152), (nt(67)+nt(36)));
		q(nt(153), (nt(63)));
		q(nt(153), (nt(88)));
		q(nt(153), (nt(110)));
		q(nt(155), (nt(153)));
		q(nt(156), (nt(155)+nt(156)));
		q(nt(156), (nul));
		q(nt(154), (nt(156)+nt(152)+nt(36)));
		q(nt(158), (nt(153)));
		q(nt(158), (nt(153)+nt(158)));
		q(nt(157), (nt(158)));
		q(nt(159), (nt(154)));
		q(nt(159), (nt(157)));
		return q;
