...
struct tau_parser {
	...
	tau_parser() :
		...
		g(nts, load_prods(), nt(243), cc), p(g, load_opts()) {}
	...
	enum nonterminal {
		...
		io_var, in, out, in_var_name, out_var_name, bool_variable, capture_var, tau_rule, tau_matcher, tau_body, 
		tau, tau_collapse_positives_cb, tau_positives_upwards_cb, tau_rec_relation, tau_and, tau_neg, tau_or, tau_wff, _Rtau_rec_relation_10, tau_ref, 
		tau_ref_args, _Rtau_ref_args_11, _Rtau_ref_args_12, _Rtau_ref_args_13, tau_and_sym, tau_or_sym, tau_neg_sym, wff, wff_rule, wff_matcher, 
		wff_body, bf_eq_cb, bf_neq_cb, wff_has_clashing_subformulas_cb, wff_has_subformula_cb, wff_remove_existential_cb, wff_remove_bexistential_cb, wff_remove_buniversal_cb, wff_rec_relation, wff_and, 
		wff_neg, wff_xor, wff_conditional, wff_or, wff_all, wff_ex, wff_imply, wff_equiv, wff_t, wff_f, 
		wff_ball, wff_bex, bf_eq, bf_neq, bf_less, bf_less_equal, bf_greater, _Rwff_rec_relation_14, wff_ref, wff_ref_args, 
		_Rwff_ref_args_15, _Rwff_ref_args_16, _Rwff_ref_args_17, wff_and_sym, wff_or_sym, wff_xor_sym, wff_conditional_sym, wff_neg_sym, wff_imply_sym, wff_equiv_sym, 
		wff_all_sym, _Rwff_all_18, wff_ex_sym, _Rwff_ex_19, wff_ball_sym, _Rwff_ball_20, wff_bex_sym, _Rwff_bex_21, bf, bf_equality_sym, 
		bf_nequality_sym, bf_less_sym, bf_less_equal_sym, bf_greater_sym, bf_rule, bf_matcher, bf_body, bf_is_zero_cb, bf_is_one_cb, bf_has_clashing_subformulas_cb, 
		bf_has_subformula_cb, bf_remove_funiversal_cb, bf_remove_fexistential_cb, bf_and_cb, bf_or_cb, bf_xor_cb, bf_neg_cb, bf_ref, bf_constant, bf_and, 
		bf_neg, bf_xor, bf_or, bf_all, bf_ex, bf_t, bf_f, bf_rec_relation, _Rbf_rec_relation_22, bf_ref_args, 
		_Rbf_ref_args_23, _Rbf_ref_args_24, _Rbf_ref_args_25, bf_and_sym, bf_or_sym, bf_xor_sym, bf_neg_sym, bf_all_sym, _Rbf_all_26, bf_ex_sym, 
		_Rbf_ex_27, constant, binding, source_binding, named_binding, type, source, source0, _Rsource_28, _Rsource_29, 
		bf_and_cb_sym, bf_cb_arg, bf_or_cb_sym, bf_xor_cb_sym, bf_neg_cb_sym, bf_eq_cb_sym, wff_cb_arg, bf_neq_cb_sym, bf_is_zero_cb_sym, bf_is_one_cb_sym, 
		bf_remove_funiversal_cb_sym, bf_remove_fexistential_cb_sym, wff_remove_existential_cb_sym, wff_remove_bexistential_cb_sym, wff_remove_buniversal_cb_sym, bf_has_clashing_subformulas_cb_sym, wff_has_clashing_subformulas_cb_sym, bf_has_subformula_cb_sym, wff_has_subformula_cb_sym, tau_collapse_positives_cb_sym, 
		tau_cb_arg, _Rtau_collapse_positives_cb_30, _Rtau_collapse_positives_cb_31, tau_positives_upwards_cb_sym, inputs, input, _Rinputs_32, _Rinputs_33, builder, builder_head, 
		builder_body, _Rbuilder_head_34, _Rbuilder_head_35, bf_builder_body, wff_builder_body, tau_builder_body, library, rules, rule, _Rrules_36, 
		_Rrules_37, nso_rr, nso_rec_relations, nso_main, nso_rec_relation, _Rnso_rec_relations_38, _Rnso_rec_relations_39, gssotc_rr, gssotc_rec_relations, gssotc_main, 
		gssotc_rec_relation, _Rgssotc_rec_relations_40, _Rgssotc_rec_relations_41, start, _Rstart_42, __neg_0, __neg_1, __neg_2, __neg_3, __neg_4, 
		...
		__neg_35, __neg_36, __neg_37, __neg_38, __neg_39, __neg_40, __neg_41, __neg_42, __neg_43, 
	};
...
private:
	...
	idni::prods<char_type, terminal_type> load_prods() {
		...
		q(nt(22), (nt(7)) & ~(nt(245)) & ~(nt(246)) & ~(nt(247)) & ~(nt(248)) & ~(nt(249)) & ~(nt(250)));
		// char0 => space.
		q(nt(26), (nt(2)));
		// char0 => alnum.
		q(nt(26), (nt(6)));
		...
		q(nt(61), (nt(63)+nt(41)+nt(52)+nt(42)));
		...
		q(nt(63), (t(26)+t(27)+nt(30)));
		// out_var_name => 'o' '_' chars.
		q(nt(64), (t(28)+t(27)+nt(30)));
		// tau_rule => tau_matcher ws tau_def ws tau_body ws dot.
		q(nt(67), (nt(68)+nt(14)+nt(37)+nt(14)+nt(69)+nt(14)+nt(38)));
		// tau_matcher => tau.
		q(nt(68), (nt(70)));
		// tau_body => tau.
		q(nt(69), (nt(70)));
		...
		q(nt(78), ~(nt(251)) & (nt(70)) & ~(nt(252)) & ~(nt(253)) & ~(nt(254)) & ~(nt(255)));
		// tau_rec_relation => _Rtau_rec_relation_10 ws tau_def ws tau ws dot.
		q(nt(73), (nt(78)+nt(14)+nt(37)+nt(14)+nt(70)+nt(14)+nt(38)));
		// tau_ref => sym ws offsets ws tau_ref_args.
		q(nt(79), (nt(50)+nt(14)+nt(51)+nt(14)+nt(80)));
		...
		q(nt(80), (nt(39)+nt(14)+nt(83)+nt(14)+nt(40)));
		// tau => capture.
		q(nt(70), (nt(56)));
		// tau => tau_and.
		q(nt(70), (nt(74)));
		...
		q(nt(74), (nt(39)+nt(14)+nt(70)+nt(14)+nt(84)+nt(14)+nt(70)+nt(14)+nt(40)));
		// tau_or => open_parenthesis ws tau ws tau_or_sym ws tau ws close_parenthesis.
		q(nt(76), (nt(39)+nt(14)+nt(70)+nt(14)+nt(85)+nt(14)+nt(70)+nt(14)+nt(40)));
		// tau_neg => tau_neg_sym ws tau.
		q(nt(75), (nt(86)+nt(14)+nt(70)));
		// tau_wff => open_brace ws wff ws close_brace.
		q(nt(77), (nt(43)+nt(14)+nt(87)+nt(14)+nt(44)));
		// tau_and_sym => '&' '&' '&'.
		q(nt(84), (t(29)+t(29)+t(29)));
		// tau_or_sym => '|' '|' '|'.
		q(nt(85), (t(30)+t(30)+t(30)));
		// tau_neg_sym => '!' '!' '!'.
		q(nt(86), (t(31)+t(31)+t(31)));
		// wff_rule => wff_matcher ws wff_def ws wff_body ws dot.
		q(nt(88), (nt(89)+nt(14)+nt(36)+nt(14)+nt(90)+nt(14)+nt(38)));
		// wff_matcher => wff.
		q(nt(89), (nt(87)));
		// wff_body => wff.
		q(nt(90), (nt(87)));
		...
		q(nt(117), ~(nt(256)) & ~(nt(257)) & (nt(87)) & ~(nt(258)) & ~(nt(259)) & ~(nt(260)) & ~(nt(261)) & ~(nt(262)) & ~(nt(263)) & ~(nt(264)) & ~(nt(265)) & ~(nt(266)) & ~(nt(267)) & ~(nt(268)) & ~(nt(269)) & ~(nt(270)) & ~(nt(271)) & ~(nt(272)) & ~(nt(273)) & ~(nt(274)) & ~(nt(275)));
		// wff_rec_relation => _Rwff_rec_relation_14 ws wff_def ws wff ws dot.
		q(nt(98), (nt(117)+nt(14)+nt(36)+nt(14)+nt(87)+nt(14)+nt(38)));
		// wff => capture.
		q(nt(87), (nt(56)));
		// wff => bool_variable.
		q(nt(87), (nt(65)));
		...
		q(nt(118), (nt(50)+nt(14)+nt(51)+nt(14)+nt(119)));
		...
		q(nt(128), (t(20)+t(33)));
		// wff_equiv_sym => '<' '-' '>'.
		q(nt(129), (t(22)+t(20)+t(33)));
		// wff_all_sym => 'a' 'l' 'l'.
		q(nt(130), (t(34)+t(35)+t(35)));
		// wff_ex_sym => 'e' 'x'.
		q(nt(132), (t(36)+t(6)));
		// wff_ball_sym => 'b' 'a' 'l' 'l'.
		q(nt(134), (t(37)+t(34)+t(35)+t(35)));
		// wff_bex_sym => 'b' 'e' 'x'.
		q(nt(136), (t(37)+t(36)+t(6)));
		// wff_t => 'T'.
		q(nt(108), (t(38)));
		// wff_f => 'F'.
		q(nt(109), (t(39)));
		// bf_rule => bf_matcher ws bf_def ws bf_body ws dot.
		q(nt(144), (nt(145)+nt(14)+nt(35)+nt(14)+nt(146)+nt(14)+nt(38)));
		// bf_matcher => bf.
		q(nt(145), (nt(138)));
		// bf_body => bf.
		q(nt(146), (nt(138)));
		...
		q(nt(168), ~(nt(276)) & ~(nt(277)) & ~(nt(278)) & ~(nt(279)) & (nt(138)) & ~(nt(280)) & ~(nt(281)) & ~(nt(282)) & ~(nt(283)) & ~(nt(284)) & ~(nt(285)) & ~(nt(286)) & ~(nt(287)) & ~(nt(288)));
		// bf_rec_relation => _Rbf_rec_relation_22 ws bf_def ws bf ws dot.
		q(nt(167), (nt(168)+nt(14)+nt(35)+nt(14)+nt(138)+nt(14)+nt(38)));
		// bf_ref => sym offsets bf_ref_args.
		q(nt(157), (nt(50)+nt(51)+nt(169)));
		...
		q(nt(143), (t(33)));
		// bf_all_sym => 'f' 'a' 'l' 'l'.
		q(nt(177), (t(42)+t(34)+t(35)+t(35)));
		// bf_ex_sym => 'f' 'e' 'x'.
		q(nt(179), (t(42)+t(36)+t(6)));
		// bf_t => '1'.
		q(nt(165), (t(43)));
		// bf_f => '0'.
		q(nt(166), (t(44)));
		// bf_constant => open_brace ws constant ws close_brace.
		q(nt(158), (nt(43)+nt(14)+nt(181)+nt(14)+nt(44)));
		// constant => capture.
		q(nt(181), (nt(56)));
		// constant => binding.
		q(nt(181), (nt(182)));
		...
		q(nt(183), (nt(185)+nt(14)+nt(46)+nt(14)+nt(186)));
		// type => null.
		q(nt(185), (nul));
		// type => chars.
		q(nt(185), (nt(30)));
		...
		q(nt(151), (nt(200)+nt(14)+nt(191)+nt(13)+nt(191)+nt(13)+nt(191)+nt(13)+nt(191)));
		...
		q(nt(152), (nt(201)+nt(14)+nt(191)+nt(13)+nt(191)+nt(13)+nt(191)+nt(13)+nt(191)));
		// wff_remove_existential_cb => wff_remove_existential_cb_sym ws wff_cb_arg ws_required wff_cb_arg.
		q(nt(95), (nt(202)+nt(14)+nt(196)+nt(13)+nt(196)));
		...
		q(nt(96), (nt(203)+nt(14)+nt(196)+nt(13)+nt(196)+nt(13)+nt(196)+nt(13)+nt(196)));
		...
		q(nt(97), (nt(204)+nt(14)+nt(196)+nt(13)+nt(196)+nt(13)+nt(196)+nt(13)+nt(196)));
		// bf_has_clashing_subformulas_cb => bf_has_clashing_subformulas_cb_sym ws bf_cb_arg ws_required bf_cb_arg.
		q(nt(149), (nt(205)+nt(14)+nt(191)+nt(13)+nt(191)));
		// wff_has_clashing_subformulas_cb => wff_has_clashing_subformulas_cb_sym ws wff_cb_arg ws_required wff_cb_arg.
		q(nt(93), (nt(206)+nt(14)+nt(196)+nt(13)+nt(196)));
		// bf_has_subformula_cb => bf_has_subformula_cb_sym ws bf_cb_arg ws_required bf_cb_arg ws_required bf_cb_arg.
		q(nt(150), (nt(207)+nt(14)+nt(191)+nt(13)+nt(191)+nt(13)+nt(191)));
		// wff_has_subformula_cb => wff_has_subformula_cb_sym ws wff_cb_arg ws_required wff_cb_arg ws_required wff_cb_arg.
		q(nt(94), (nt(208)+nt(14)+nt(196)+nt(13)+nt(196)+nt(13)+nt(196)));
		// bf_has_clashing_subformulas_cb_sym => 'b' 'f' '_' 'h' 'a' 's' '_' 'c' 'l' 'a' 's' 'h' 'i' 'n' 'g' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' 's' '_' 'c' 'b'.
		q(nt(205), (t(37)+t(42)+t(27)+t(45)+t(34)+t(46)+t(27)+t(47)+t(35)+t(34)+t(46)+t(45)+t(26)+t(48)+t(49)+t(27)+t(46)+t(7)+t(37)+t(42)+t(28)+t(50)+t(51)+t(7)+t(35)+t(34)+t(46)+t(27)+t(47)+t(37)));
		// bf_has_subformula_cb_sym => 'b' 'f' '_' 'h' 'a' 's' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' '_' 'c' 'b'.
		q(nt(207), (t(37)+t(42)+t(27)+t(45)+t(34)+t(46)+t(27)+t(46)+t(7)+t(37)+t(42)+t(28)+t(50)+t(51)+t(7)+t(35)+t(34)+t(27)+t(47)+t(37)));
		// wff_has_clashing_subformulas_cb_sym => 'w' 'f' 'f' '_' 'h' 'a' 's' '_' 'c' 'l' 'a' 's' 'h' 'i' 'n' 'g' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' 's' '_' 'c' 'b'.
		q(nt(206), (t(52)+t(42)+t(42)+t(27)+t(45)+t(34)+t(46)+t(27)+t(47)+t(35)+t(34)+t(46)+t(45)+t(26)+t(48)+t(49)+t(27)+t(46)+t(7)+t(37)+t(42)+t(28)+t(50)+t(51)+t(7)+t(35)+t(34)+t(46)+t(27)+t(47)+t(37)));
		// wff_has_subformula_cb_sym => 'w' 'f' 'f' '_' 'h' 'a' 's' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' '_' 'c' 'b'.
		q(nt(208), (t(52)+t(42)+t(42)+t(27)+t(45)+t(34)+t(46)+t(27)+t(46)+t(7)+t(37)+t(42)+t(28)+t(50)+t(51)+t(7)+t(35)+t(34)+t(27)+t(47)+t(37)));
		// wff_remove_existential_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(202), (t(52)+t(42)+t(42)+t(27)+t(50)+t(36)+t(51)+t(28)+t(53)+t(36)+t(27)+t(36)+t(6)+t(26)+t(46)+t(54)+t(36)+t(48)+t(54)+t(26)+t(34)+t(35)+t(27)+t(47)+t(37)));
		// wff_remove_bexistential_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'b' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(203), (t(52)+t(42)+t(42)+t(27)+t(50)+t(36)+t(51)+t(28)+t(53)+t(36)+t(27)+t(37)+t(36)+t(6)+t(26)+t(46)+t(54)+t(36)+t(48)+t(54)+t(26)+t(34)+t(35)+t(27)+t(47)+t(37)));
		// wff_remove_buniversal_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'b' 'u' 'n' 'i' 'v' 'e' 'r' 's' 'a' 'l' '_' 'c' 'b'.
		q(nt(204), (t(52)+t(42)+t(42)+t(27)+t(50)+t(36)+t(51)+t(28)+t(53)+t(36)+t(27)+t(37)+t(7)+t(48)+t(26)+t(53)+t(36)+t(50)+t(46)+t(34)+t(35)+t(27)+t(47)+t(37)));
		// bf_remove_fexistential_cb_sym => 'b' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'f' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(201), (t(37)+t(42)+t(27)+t(50)+t(36)+t(51)+t(28)+t(53)+t(36)+t(27)+t(42)+t(36)+t(6)+t(26)+t(46)+t(54)+t(36)+t(48)+t(54)+t(26)+t(34)+t(35)+t(27)+t(47)+t(37)));
		// bf_remove_funiversal_cb_sym => 'b' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'f' 'u' 'n' 'i' 'v' 'e' 'r' 's' 'a' 'l' '_' 'c' 'b'.
		q(nt(200), (t(37)+t(42)+t(27)+t(50)+t(36)+t(51)+t(28)+t(53)+t(36)+t(27)+t(42)+t(7)+t(48)+t(26)+t(53)+t(36)+t(50)+t(46)+t(34)+t(35)+t(27)+t(47)+t(37)));
		// bf_cb_arg => bf.
		q(nt(191), (nt(138)));
		// wff_cb_arg => wff.
		q(nt(196), (nt(87)));
		// bf_and_cb_sym => 'b' 'f' '_' 'a' 'n' 'd' '_' 'c' 'b'.
		q(nt(190), (t(37)+t(42)+t(27)+t(34)+t(48)+t(55)+t(27)+t(47)+t(37)));
		// bf_or_cb_sym => 'b' 'f' '_' 'o' 'r' '_' 'c' 'b'.
		q(nt(192), (t(37)+t(42)+t(27)+t(28)+t(50)+t(27)+t(47)+t(37)));
		// bf_xor_cb_sym => 'b' 'f' '_' 'x' 'o' 'r' '_' 'c' 'b'.
		q(nt(193), (t(37)+t(42)+t(27)+t(6)+t(28)+t(50)+t(27)+t(47)+t(37)));
		// bf_neg_cb_sym => 'b' 'f' '_' 'n' 'e' 'g' '_' 'c' 'b'.
		q(nt(194), (t(37)+t(42)+t(27)+t(48)+t(36)+t(49)+t(27)+t(47)+t(37)));
		// bf_eq_cb_sym => 'b' 'f' '_' 'e' 'q' '_' 'c' 'b'.
		q(nt(195), (t(37)+t(42)+t(27)+t(36)+t(56)+t(27)+t(47)+t(37)));
		// bf_neq_cb_sym => 'b' 'f' '_' 'n' 'e' 'q' '_' 'c' 'b'.
		q(nt(197), (t(37)+t(42)+t(27)+t(48)+t(36)+t(56)+t(27)+t(47)+t(37)));
		// bf_is_zero_cb_sym => 'b' 'f' '_' 'i' 's' '_' 'z' 'e' 'r' 'o' '_' 'c' 'b'.
		q(nt(198), (t(37)+t(42)+t(27)+t(26)+t(46)+t(27)+t(57)+t(36)+t(50)+t(28)+t(27)+t(47)+t(37)));
		// bf_is_one_cb_sym => 'b' 'f' '_' 'i' 's' '_' 'o' 'n' 'e' '_' 'c' 'b'.
		q(nt(199), (t(37)+t(42)+t(27)+t(26)+t(46)+t(27)+t(28)+t(48)+t(36)+t(27)+t(47)+t(37)));
		...
		q(nt(72), (nt(213)+nt(13)+nt(210)+nt(13)+nt(210)));
		// tau_cb_arg => capture.
		q(nt(210), (nt(56)));
		// tau_cb_arg => tau.
		q(nt(210), (nt(70)));
		// tau_collapse_positives_cb_sym => 't' 'a' 'u' '_' 'c' 'o' 'l' 'l' 'a' 'p' 's' 'e' '_' 'p' 'o' 's' 'i' 't' 'i' 'v' 'e' 's' '_' 'c' 'b'.
		q(nt(209), (t(54)+t(34)+t(7)+t(27)+t(47)+t(28)+t(35)+t(35)+t(34)+t(58)+t(46)+t(36)+t(27)+t(58)+t(28)+t(46)+t(26)+t(54)+t(26)+t(53)+t(36)+t(46)+t(27)+t(47)+t(37)));
		// tau_positives_upwards_cb_sym => 't' 'a' 'u' '_' 'p' 'o' 's' 'i' 't' 'i' 'v' 'e' 's' '_' 'u' 'p' 'w' 'a' 'r' 'd' 's' '_' 'c' 'b'.
		q(nt(213), (t(54)+t(34)+t(7)+t(27)+t(58)+t(28)+t(46)+t(26)+t(54)+t(26)+t(53)+t(36)+t(46)+t(27)+t(7)+t(58)+t(52)+t(34)+t(50)+t(55)+t(46)+t(27)+t(47)+t(37)));
		// _Rinputs_32 => ws input.
		q(nt(216), (nt(14)+nt(215)));
		// _Rinputs_33 => null.
		q(nt(217), (nul));
		// _Rinputs_33 => _Rinputs_32 _Rinputs_33.
		q(nt(217), (nt(216)+nt(217)));
		// inputs => ws less ws input _Rinputs_33 ws dot.
		q(nt(214), (nt(14)+nt(48)+nt(14)+nt(215)+nt(217)+nt(14)+nt(38)));
		// input => in ws colon ws open_brace ws source_binding ws close_brace.
		q(nt(215), (nt(61)+nt(14)+nt(46)+nt(14)+nt(43)+nt(14)+nt(183)+nt(14)+nt(44)));
		// builder => ws builder_head ws builder_body ws dot.
		q(nt(218), (nt(14)+nt(219)+nt(14)+nt(220)+nt(14)+nt(38)));
		// _Rbuilder_head_34 => ws_required capture.
		q(nt(221), (nt(13)+nt(56)));
		...
		q(nt(219), (nt(39)+nt(14)+nt(56)+nt(222)+nt(14)+nt(40)));
		...
		q(nt(223), (nt(35)+nt(14)+nt(138)));
		// wff_builder_body => wff_def ws wff.
		q(nt(224), (nt(36)+nt(14)+nt(87)));
		// tau_builder_body => tau_def ws tau.
		q(nt(225), (nt(37)+nt(14)+nt(70)));
		// library => rules.
		q(nt(226), (nt(227)));
		// _Rrules_36 => ws rule.
		q(nt(229), (nt(14)+nt(228)));
		// _Rrules_37 => null.
		q(nt(230), (nul));
		...
		q(nt(233), (nt(14)+nt(87)+nt(14)+nt(38)));
		...
		q(nt(239), (nt(14)+nt(70)+nt(14)+nt(47)));
		// _Rstart_42 => inputs.
		q(nt(244), (nt(214)));
		// _Rstart_42 => builder.
		q(nt(244), (nt(218)));
