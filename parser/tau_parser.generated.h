...
inline const std::vector<std::string> symbol_names{
	...
	"__E_history_173", "__N_0", "__N_1", "__N_2", "__N_3", "__N_4", "__N_5", "__N_6", "__N_7", "__N_8", 
	"__N_9", "__N_10", "__N_11", "__N_12", "__N_13", "__N_14", "__N_15", "__N_16", 
};
	...
	grammar_options
{
	...
	.shaping = {
		...
		.dont_trim_terminals_of = {
			29, 31, 40, 172, 185, 196, 205, 213, 220, 223,
			225, 321, 326, 362
		},
		.to_inline = {
			{ 14, 55, 14 },
...
//G158: bf(30)               => bf_ref(118).
	p(NT(30), (NT(118)));
//G159: __N_0(381)           => bf_shr(119).
	p(NT(381), (NT(119)));
//G160: __E___E_bf_47_48(121) => bf(30) & ~( __N_0(381) ).	 # conjunctive
	p(NT(121), (NT(30)) & ~(NT(381)));
...
//G163: bf(30)               => bf_shr(119).
	p(NT(30), (NT(119)));
//G164: __N_1(382)           => bf_shl(122).
	p(NT(382), (NT(122)));
//G165: __E___E_bf_49_50(124) => bf(30) & ~( __N_1(382) ).	 # conjunctive
	p(NT(124), (NT(30)) & ~(NT(382)));
...
//G171: bf(30)               => bf_add(125).
	p(NT(30), (NT(125)));
//G172: __N_2(383)           => bf_sub(127).
	p(NT(383), (NT(127)));
//G173: __E___E_bf_52_53(129) => bf(30) & ~( __N_2(383) ).	 # conjunctive
	p(NT(129), (NT(30)) & ~(NT(383)));
...
//G176: bf(30)               => bf_sub(127).
	p(NT(30), (NT(127)));
//G177: __N_3(384)           => bf_mod(130).
	p(NT(384), (NT(130)));
//G178: __E___E_bf_54_55(132) => bf(30) & ~( __N_3(384) ).	 # conjunctive
	p(NT(132), (NT(30)) & ~(NT(384)));
...
//G184: bf(30)               => bf_mul(133).
	p(NT(30), (NT(133)));
//G185: __N_4(385)           => bf_div(135).
	p(NT(385), (NT(135)));
//G186: __E___E_bf_57_58(137) => bf(30) & ~( __N_4(385) ).	 # conjunctive
	p(NT(137), (NT(30)) & ~(NT(385)));
...
//G189: bf(30)               => bf_div(135).
	p(NT(30), (NT(135)));
//G190: __N_5(386)           => bf_nor(138).
	p(NT(386), (NT(138)));
//G191: __E___E_bf_59_60(140) => bf(30) & ~( __N_5(386) ).	 # conjunctive
	p(NT(140), (NT(30)) & ~(NT(386)));
...
//G194: bf(30)               => bf_nor(138).
	p(NT(30), (NT(138)));
//G195: __N_6(387)           => bf_xnor(141).
	p(NT(387), (NT(141)));
//G196: __E___E_bf_61_62(143) => bf(30) & ~( __N_6(387) ).	 # conjunctive
	p(NT(143), (NT(30)) & ~(NT(387)));
...
//G199: bf(30)               => bf_xnor(141).
	p(NT(30), (NT(141)));
//G200: __N_7(388)           => bf_nand(144).
	p(NT(388), (NT(144)));
//G201: __E___E_bf_63_64(146) => bf(30) & ~( __N_7(388) ).	 # conjunctive
	p(NT(146), (NT(30)) & ~(NT(388)));
...
//G294: __N_9(390)           => '}'.
	p(NT(390), (T(45)));
//G295: src_c(187)           => ~( __N_8(389) ) & ~( __N_9(390) ) & punct(7).	 # conjunctive
	p(NT(187), ~(NT(389)) & ~(NT(390)) & (NT(7)));
...
//G308: __N_11(392)          => 'T'.
	p(NT(392), (T(35)));
//G309: __E_var_name_93(198) => ~( __N_10(391) ) & ~( __N_11(392) ) & alpha(5).	 # conjunctive
	p(NT(198), ~(NT(391)) & ~(NT(392)) & (NT(5)));
...
//G314: __N_13(394)          => 'T'.
	p(NT(394), (T(35)));
//G315: __E_var_name_95(200) => ~( __N_12(393) ) & ~( __N_13(394) ) & alpha(5).	 # conjunctive
	p(NT(200), ~(NT(393)) & ~(NT(394)) & (NT(5)));
...
//G332: q_var(208)           => capture(29).
	p(NT(208), (NT(29)));
//G333: __N_14(395)          => uconst(194).
	p(NT(395), (NT(194)));
//G334: q_var(208)           => variable(113) & ~( __N_14(395) ).	 # conjunctive
	p(NT(208), (NT(113)) & ~(NT(395)));
...
//G339: offsets(42)          => '[' _(11) offset(203) __E_offsets_103(212) _(11) ']'.
	p(NT(42), (T(26)+NT(11)+NT(203)+NT(212)+NT(11)+T(27)));
...
//G342: offset(203)          => shift(214).
	p(NT(203), (NT(214)));
//G343: __N_15(396)          => io_var(195).
	p(NT(396), (NT(195)));
//G344: __E_offset_104(215)  => variable(113) & ~( __N_15(396) ).	 # conjunctive
	p(NT(215), (NT(113)) & ~(NT(396)));
//G345: offset(203)          => __E_offset_104(215).
	p(NT(203), (NT(215)));
//G346: __E_shift_105(216)   => capture(29).
	p(NT(216), (NT(29)));
//G347: __N_16(397)          => io_var(195).
	p(NT(397), (NT(195)));
//G348: __E___E_shift_105_106(217) => variable(113) & ~( __N_16(397) ).	 # conjunctive
	p(NT(217), (NT(113)) & ~(NT(397)));
...
//G545: cli_command(231)     => history_print_cmd(349).
	p(NT(231), (NT(349)));
//G546: __E_cli_command_160(352) => wff(14).
	p(NT(352), (NT(14)));
//G547: __E_cli_command_160(352) => bf(30).
	p(NT(352), (NT(30)));
//G548: history_store_cmd(351) => __E_cli_command_160(352).
	p(NT(351), (NT(352)));
//G549: cli_command(231)     => history_store_cmd(351).
	p(NT(231), (NT(351)));
//G550: __E_solve_options_161(353) => __(34) solve_option(354).
	p(NT(353), (NT(34)+NT(354)));
//G551: __E_solve_options_162(355) => null.
	p(NT(355), (nul));
//G552: __E_solve_options_162(355) => __E_solve_options_161(353) __E_solve_options_162(355).
	p(NT(355), (NT(353)+NT(355)));
//G553: solve_options(267)   => __E_solve_options_162(355).
	p(NT(267), (NT(355)));
//G554: __E_solve_option_163(356) => solver_mode(357).
	p(NT(356), (NT(357)));
//G555: __E_solve_option_163(356) => type(223).
	p(NT(356), (NT(223)));
//G556: solve_option(354)    => '-' '-' __E_solve_option_163(356).
	p(NT(354), (T(30)+T(30)+NT(356)));
//G557: __E_solver_mode_164(359) => 'm' 'i' 'n' 'i' 'm' 'u' 'm'.
	p(NT(359), (T(21)+T(4)+T(5)+T(4)+T(21)+T(7)+T(21)));
//G558: __E_solver_mode_164(359) => 'm' 'i' 'n'.
	p(NT(359), (T(21)+T(4)+T(5)));
//G559: solver_mode_minimum(358) => __E_solver_mode_164(359).
	p(NT(358), (NT(359)));
//G560: solver_mode(357)     => solver_mode_minimum(358).
	p(NT(357), (NT(358)));
//G561: __E_solver_mode_165(361) => 'm' 'a' 'x' 'i' 'm' 'u' 'm'.
	p(NT(361), (T(21)+T(16)+T(29)+T(4)+T(21)+T(7)+T(21)));
//G562: __E_solver_mode_165(361) => 'm' 'a' 'x'.
	p(NT(361), (T(21)+T(16)+T(29)));
//G563: solver_mode_maximum(360) => __E_solver_mode_165(361).
	p(NT(360), (NT(361)));
//G564: solver_mode(357)     => solver_mode_maximum(360).
	p(NT(357), (NT(360)));
//G565: q_file_name(38)      => '"' file_name(362) '"'.
	p(NT(38), (T(59)+NT(362)+T(59)));
//G566: __E_file_name_166(363) => printable(8).
	p(NT(363), (NT(8)));
//G567: __E_file_name_166(363) => printable(8) __E_file_name_166(363).
	p(NT(363), (NT(8)+NT(363)));
//G568: file_name(362)       => __E_file_name_166(363).
	p(NT(362), (NT(363)));
//G569: __E_option_name_167(364) => alnum(6).
	p(NT(364), (NT(6)));
//G570: __E_option_name_167(364) => alnum(6) __E_option_name_167(364).
	p(NT(364), (NT(6)+NT(364)));
//G571: option_name(321)     => __E_option_name_167(364).
	p(NT(321), (NT(364)));
//G572: __E_option_value_168(365) => alnum(6).
	p(NT(365), (NT(6)));
//G573: __E_option_value_168(365) => alnum(6) __E_option_value_168(365).
	p(NT(365), (NT(6)+NT(365)));
//G574: option_value(326)    => __E_option_value_168(365).
	p(NT(326), (NT(365)));
//G575: bf_cmd_arg(366)      => history(277).
	p(NT(366), (NT(277)));
//G576: bf_cmd_arg(366)      => bf(30).
	p(NT(366), (NT(30)));
//G577: wff_cmd_arg(268)     => history(277).
	p(NT(268), (NT(277)));
//G578: wff_cmd_arg(268)     => wff(14).
	p(NT(268), (NT(14)));
//G579: nf_cmd_arg(286)      => history(277).
	p(NT(286), (NT(277)));
//G580: nf_cmd_arg(286)      => ref(27).
	p(NT(286), (NT(27)));
//G581: nf_cmd_arg(286)      => wff(14).
	p(NT(286), (NT(14)));
//G582: nf_cmd_arg(286)      => bf(30).
	p(NT(286), (NT(30)));
//G583: onf_cmd_arg(313)     => history(277).
	p(NT(313), (NT(277)));
//G584: onf_cmd_arg(313)     => wff(14).
	p(NT(313), (NT(14)));
//G585: normalize_cmd_arg(256) => history(277).
	p(NT(256), (NT(277)));
//G586: normalize_cmd_arg(256) => spec(10).
	p(NT(256), (NT(10)));
//G587: normalize_cmd_arg(256) => ref(27).
	p(NT(256), (NT(27)));
//G588: normalize_cmd_arg(256) => wff(14).
	p(NT(256), (NT(14)));
//G589: normalize_cmd_arg(256) => bf(30).
	p(NT(256), (NT(30)));
//G590: inst_args(291)       => wff_cmd_arg(268) _(11) '[' _(11) bf(30) _(11) '/' _(11) bf_cmd_arg(366) _(11) ']'.
	p(NT(291), (NT(268)+NT(11)+T(26)+NT(11)+NT(30)+NT(11)+T(40)+NT(11)+NT(366)+NT(11)+T(27)));
//G591: inst_args(291)       => bf_cmd_arg(366) _(11) '[' _(11) bf(30) _(11) '/' _(11) bf_cmd_arg(366) _(11) ']'.
	p(NT(291), (NT(366)+NT(11)+T(26)+NT(11)+NT(30)+NT(11)+T(40)+NT(11)+NT(366)+NT(11)+T(27)));
//G592: help_arg(248)        => help_sym(245).
	p(NT(248), (NT(245)));
//G593: help_arg(248)        => version_sym(238).
	p(NT(248), (NT(238)));
//G594: help_arg(248)        => quit_sym(235).
	p(NT(248), (NT(235)));
//G595: help_arg(248)        => clear_sym(241).
	p(NT(248), (NT(241)));
//G596: help_arg(248)        => get_sym(319).
	p(NT(248), (NT(319)));
//G597: help_arg(248)        => set_sym(324).
	p(NT(248), (NT(324)));
//G598: help_arg(248)        => enable_sym(329).
	p(NT(248), (NT(329)));
//G599: help_arg(248)        => disable_sym(332).
	p(NT(248), (NT(332)));
//G600: help_arg(248)        => toggle_sym(335).
	p(NT(248), (NT(335)));
//G601: help_arg(248)        => file_sym(251).
	p(NT(248), (NT(251)));
//G602: help_arg(248)        => history_sym(347).
	p(NT(248), (NT(347)));
//G603: help_arg(248)        => abs_history_sym(367).
	p(NT(248), (NT(367)));
//G604: help_arg(248)        => rel_history_sym(368).
	p(NT(248), (NT(368)));
//G605: help_arg(248)        => selection_sym(369).
	p(NT(248), (NT(369)));
//G606: help_arg(248)        => def_sym(338).
	p(NT(248), (NT(338)));
//G607: help_arg(248)        => inst_sym(289).
	p(NT(248), (NT(289)));
//G608: help_arg(248)        => subst_sym(284).
	p(NT(248), (NT(284)));
//G609: help_arg(248)        => normalize_sym(280).
	p(NT(248), (NT(280)));
//G610: help_arg(248)        => execute_sym(370).
	p(NT(248), (NT(370)));
//G611: help_arg(248)        => solve_sym(265).
	p(NT(248), (NT(265)));
//G612: help_arg(248)        => valid_sym(255).
	p(NT(248), (NT(255)));
//G613: help_arg(248)        => sat_sym(259).
	p(NT(248), (NT(259)));
//G614: help_arg(248)        => unsat_sym(262).
	p(NT(248), (NT(262)));
//G615: help_arg(248)        => run_sym(274).
	p(NT(248), (NT(274)));
//G616: help_arg(248)        => dnf_sym(294).
	p(NT(248), (NT(294)));
//G617: help_arg(248)        => cnf_sym(297).
	p(NT(248), (NT(297)));
//G618: help_arg(248)        => anf_sym(300).
	p(NT(248), (NT(300)));
//G619: help_arg(248)        => snf_sym(371).
	p(NT(248), (NT(371)));
//G620: help_arg(248)        => nnf_sym(303).
	p(NT(248), (NT(303)));
//G621: help_arg(248)        => pnf_sym(306).
	p(NT(248), (NT(306)));
//G622: help_arg(248)        => mnf_sym(309).
	p(NT(248), (NT(309)));
//G623: help_arg(248)        => onf_sym(312).
	p(NT(248), (NT(312)));
//G624: help_arg(248)        => qelim_sym(316).
	p(NT(248), (NT(316)));
//G625: __E___E_help_arg_169_170(374) => 's'.
	p(NT(374), (T(15)));
//G626: __E___E_help_arg_169_170(374) => null.
	p(NT(374), (nul));
//G627: __E_help_arg_169(373) => 'e' 'x' 'a' 'm' 'p' 'l' 'e' __E___E_help_arg_169_170(374).
	p(NT(373), (T(11)+T(29)+T(16)+T(21)+T(55)+T(10)+T(11)+NT(374)));
//G628: examples_sym(372)    => __E_help_arg_169(373).
	p(NT(372), (NT(373)));
//G629: help_arg(248)        => examples_sym(372).
	p(NT(248), (NT(372)));
//G630: __E_history_171(376) => '%'.
	p(NT(376), (T(38)));
//G631: rel_history_sym(368) => '%' '-'.
	p(NT(368), (T(38)+T(30)));
//G632: history_id(378)      => digits(220).
	p(NT(378), (NT(220)));
//G633: __E___E_history_171_172(377) => history_id(378).
	p(NT(377), (NT(378)));
//G634: __E___E_history_171_172(377) => null.
	p(NT(377), (nul));
//G635: __E_history_171(376) => rel_history_sym(368) __E___E_history_171_172(377).
	p(NT(376), (NT(368)+NT(377)));
//G636: rel_history(375)     => __E_history_171(376).
	p(NT(375), (NT(376)));
//G637: history(277)         => rel_history(375).
	p(NT(277), (NT(375)));
//G638: abs_history_sym(367) => '%'.
	p(NT(367), (T(38)));
//G639: __E_history_173(380) => abs_history_sym(367) history_id(378).
	p(NT(380), (NT(367)+NT(378)));
//G640: abs_history(379)     => __E_history_173(380).
	p(NT(379), (NT(380)));
//G641: history(277)         => abs_history(379).
	p(NT(277), (NT(379)));
	#undef T
	#undef NT
