...
//G230: __N_1(369)           => 'T'.
	p(NT(369), (T(33)));
//G231: __E_variable_66(160) => ~( __N_0(368) ) & ~( __N_1(369) ) & alpha(5).	 # conjunctive
...
//G236: __N_3(371)           => 'T'.
	p(NT(371), (T(33)));
//G237: __E_variable_68(162) => ~( __N_2(370) ) & ~( __N_3(371) ) & alpha(5).	 # conjunctive
...
//G264: q_var(178)           => capture(20).
	p(NT(178), (NT(20)));
//G265: __N_4(372)           => uninterpreted_constant(169).
	p(NT(372), (NT(169)));
//G266: q_var(178)           => variable(120) & ~( __N_4(372) ).	 # conjunctive
...
//G273: offset(173)          => shift(183).
	p(NT(173), (NT(183)));
//G274: __N_5(373)           => io_var(165).
	p(NT(373), (NT(165)));
//G275: __E_offset_80(184)   => variable(120) & ~( __N_5(373) ).	 # conjunctive
	p(NT(184), (NT(120)) & ~(NT(373)));
//G276: offset(173)          => __E_offset_80(184).
	p(NT(173), (NT(184)));
//G277: __E_shift_81(185)    => capture(20).
	p(NT(185), (NT(20)));
//G278: __N_6(374)           => io_var(165).
	p(NT(374), (NT(165)));
//G279: __E___E_shift_81_82(186) => variable(120) & ~( __N_6(374) ).	 # conjunctive
...
//G306: __N_8(376)           => '}'.
	p(NT(376), (T(43)));
//G307: src_c(197)           => ~( __N_7(375) ) & ~( __N_8(376) ) & punct(7).	 # conjunctive
...
//G381: __E___E_cli_command_113_114(248) => __(27) type(131).
	p(NT(248), (NT(27)+NT(131)));
//G382: __E___E_cli_command_113_114(248) => null.
	p(NT(248), (nul));
//G383: __E_cli_command_113(246) => solve_sym(247) __E___E_cli_command_113_114(248) __(27) solve_cmd_arg(249).
	p(NT(246), (NT(247)+NT(248)+NT(27)+NT(249)));
//G384: solve_cmd(245)       => __E_cli_command_113(246).
	p(NT(245), (NT(246)));
//G385: cli_command(213)     => solve_cmd(245).
	p(NT(213), (NT(245)));
//G386: lgrs_sym(252)        => 'l' 'g' 'r' 's'.
	p(NT(252), (T(6)+T(55)+T(11)+T(12)));
//G387: __E___E_cli_command_115_116(253) => __type(254).
	p(NT(253), (NT(254)));
//G388: __E___E_cli_command_115_116(253) => null.
	p(NT(253), (nul));
//G389: __E_cli_command_115(251) => lgrs_sym(252) __E___E_cli_command_115_116(253) __(27) wff_cmd_arg(255).
	p(NT(251), (NT(252)+NT(253)+NT(27)+NT(255)));
//G390: lgrs_cmd(250)        => __E_cli_command_115(251).
	p(NT(250), (NT(251)));
//G391: cli_command(213)     => lgrs_cmd(250).
	p(NT(213), (NT(250)));
...
//G509: cli_command(213)     => history_store_cmd(343).
	p(NT(213), (NT(343)));
//G510: __E_input_stream_151(345) => 'i' 'f' 'i' 'l' 'e' _(11) '(' _(11) q_file_name(346) _(11) ')'.
	p(NT(345), (T(10)+T(4)+T(10)+T(6)+T(19)+NT(11)+T(15)+NT(11)+NT(346)+NT(11)+T(16)));
//G511: input_stream(333)    => __E_input_stream_151(345).
	p(NT(333), (NT(345)));
//G512: console_sym(347)     => 'c' 'o' 'n' 's' 'o' 'l' 'e'.
	p(NT(347), (T(8)+T(17)+T(51)+T(12)+T(17)+T(6)+T(19)));
//G513: input_stream(333)    => console_sym(347).
	p(NT(333), (NT(347)));
//G514: __E_output_stream_152(348) => 'o' 'f' 'i' 'l' 'e' _(11) '(' _(11) q_file_name(346) _(11) ')'.
	p(NT(348), (T(17)+T(4)+T(10)+T(6)+T(19)+NT(11)+T(15)+NT(11)+NT(346)+NT(11)+T(16)));
//G515: output_stream(336)   => __E_output_stream_152(348).
	p(NT(336), (NT(348)));
//G516: output_stream(336)   => console_sym(347).
	p(NT(336), (NT(347)));
//G517: q_file_name(346)     => '"' file_name(349) '"'.
	p(NT(346), (T(58)+NT(349)+T(58)));
//G518: __E_file_name_153(350) => printable(8).
	p(NT(350), (NT(8)));
//G519: __E_file_name_153(350) => printable(8) __E_file_name_153(350).
	p(NT(350), (NT(8)+NT(350)));
//G520: file_name(349)       => __E_file_name_153(350).
	p(NT(349), (NT(350)));
//G521: __E_option_name_154(351) => alnum(6).
	p(NT(351), (NT(6)));
//G522: __E_option_name_154(351) => alnum(6) __E_option_name_154(351).
	p(NT(351), (NT(6)+NT(351)));
//G523: option_name(316)     => __E_option_name_154(351).
	p(NT(316), (NT(351)));
//G524: __E_option_value_155(352) => alnum(6).
	p(NT(352), (NT(6)));
//G525: __E_option_value_155(352) => alnum(6) __E_option_value_155(352).
	p(NT(352), (NT(6)+NT(352)));
//G526: option_value(321)    => __E_option_value_155(352).
	p(NT(321), (NT(352)));
//G527: number(307)          => digits(187).
	p(NT(307), (NT(187)));
//G528: bf_cmd_arg(353)      => memory(261).
	p(NT(353), (NT(261)));
//G529: bf_cmd_arg(353)      => bf(21).
	p(NT(353), (NT(21)));
//G530: wff_cmd_arg(255)     => memory(261).
	p(NT(255), (NT(261)));
//G531: wff_cmd_arg(255)     => wff(14).
	p(NT(255), (NT(14)));
//G532: solve_cmd_arg(249)   => memory(261).
	p(NT(249), (NT(261)));
//G533: solve_cmd_arg(249)   => wff(14).
	p(NT(249), (NT(14)));
//G534: nf_cmd_arg(270)      => memory(261).
	p(NT(270), (NT(261)));
//G535: nf_cmd_arg(270)      => ref(18).
	p(NT(270), (NT(18)));
//G536: nf_cmd_arg(270)      => wff(14).
	p(NT(270), (NT(14)));
//G537: nf_cmd_arg(270)      => bf(21).
	p(NT(270), (NT(21)));
//G538: onf_cmd_arg(300)     => memory(261).
	p(NT(300), (NT(261)));
//G539: onf_cmd_arg(300)     => wff(14).
	p(NT(300), (NT(14)));
//G540: normalize_cmd_arg(238) => memory(261).
	p(NT(238), (NT(261)));
//G541: normalize_cmd_arg(238) => rr(10).
	p(NT(238), (NT(10)));
//G542: normalize_cmd_arg(238) => ref(18).
	p(NT(238), (NT(18)));
//G543: normalize_cmd_arg(238) => wff(14).
	p(NT(238), (NT(14)));
//G544: normalize_cmd_arg(238) => bf(21).
	p(NT(238), (NT(21)));
//G545: inst_args(275)       => wff_cmd_arg(255) _(11) '[' _(11) variable(120) _(11) '/' _(11) bf_cmd_arg(353) _(11) ']'.
	p(NT(275), (NT(255)+NT(11)+T(24)+NT(11)+NT(120)+NT(11)+T(57)+NT(11)+NT(353)+NT(11)+T(25)));
//G546: inst_args(275)       => bf_cmd_arg(353) _(11) '[' _(11) variable(120) _(11) '/' _(11) bf_cmd_arg(353) _(11) ']'.
	p(NT(275), (NT(353)+NT(11)+T(24)+NT(11)+NT(120)+NT(11)+T(57)+NT(11)+NT(353)+NT(11)+T(25)));
//G547: help_arg(230)        => help_sym(227).
	p(NT(230), (NT(227)));
//G548: help_arg(230)        => version_sym(220).
	p(NT(230), (NT(220)));
//G549: help_arg(230)        => quit_sym(217).
	p(NT(230), (NT(217)));
//G550: help_arg(230)        => clear_sym(223).
	p(NT(230), (NT(223)));
//G551: help_arg(230)        => get_sym(314).
	p(NT(230), (NT(314)));
//G552: help_arg(230)        => set_sym(319).
	p(NT(230), (NT(319)));
//G553: help_arg(230)        => enable_sym(324).
	p(NT(230), (NT(324)));
//G554: help_arg(230)        => disable_sym(327).
	p(NT(230), (NT(327)));
//G555: help_arg(230)        => toggle_sym(330).
	p(NT(230), (NT(330)));
//G556: help_arg(230)        => file_sym(233).
	p(NT(230), (NT(233)));
//G557: help_arg(230)        => history_sym(339).
	p(NT(230), (NT(339)));
//G558: help_arg(230)        => abs_memory_sym(354).
	p(NT(230), (NT(354)));
//G559: help_arg(230)        => rel_memory_sym(355).
	p(NT(230), (NT(355)));
//G560: help_arg(230)        => selection_sym(356).
	p(NT(230), (NT(356)));
//G561: help_arg(230)        => def_sym(303).
	p(NT(230), (NT(303)));
//G562: help_arg(230)        => inst_sym(273).
	p(NT(230), (NT(273)));
//G563: help_arg(230)        => subst_sym(268).
	p(NT(230), (NT(268)));
//G564: help_arg(230)        => normalize_sym(264).
	p(NT(230), (NT(264)));
//G565: help_arg(230)        => execute_sym(357).
	p(NT(230), (NT(357)));
//G566: help_arg(230)        => solve_sym(247).
	p(NT(230), (NT(247)));
//G567: help_arg(230)        => valid_sym(237).
	p(NT(230), (NT(237)));
//G568: help_arg(230)        => sat_sym(241).
	p(NT(230), (NT(241)));
//G569: help_arg(230)        => unsat_sym(244).
	p(NT(230), (NT(244)));
//G570: help_arg(230)        => run_sym(258).
	p(NT(230), (NT(258)));
//G571: help_arg(230)        => dnf_sym(278).
	p(NT(230), (NT(278)));
//G572: help_arg(230)        => cnf_sym(281).
	p(NT(230), (NT(281)));
//G573: help_arg(230)        => anf_sym(284).
	p(NT(230), (NT(284)));
//G574: help_arg(230)        => snf_sym(296).
	p(NT(230), (NT(296)));
//G575: help_arg(230)        => nnf_sym(287).
	p(NT(230), (NT(287)));
//G576: help_arg(230)        => pnf_sym(290).
	p(NT(230), (NT(290)));
//G577: help_arg(230)        => mnf_sym(293).
	p(NT(230), (NT(293)));
//G578: help_arg(230)        => onf_sym(299).
	p(NT(230), (NT(299)));
//G579: help_arg(230)        => qelim_sym(311).
	p(NT(230), (NT(311)));
//G580: __E___E_help_arg_156_157(360) => 's'.
	p(NT(360), (T(12)));
//G581: __E___E_help_arg_156_157(360) => null.
	p(NT(360), (nul));
//G582: __E_help_arg_156(359) => 'e' 'x' 'a' 'm' 'p' 'l' 'e' __E___E_help_arg_156_157(360).
	p(NT(359), (T(19)+T(27)+T(5)+T(18)+T(53)+T(6)+T(19)+NT(360)));
//G583: examples_sym(358)    => __E_help_arg_156(359).
	p(NT(358), (NT(359)));
//G584: help_arg(230)        => examples_sym(358).
	p(NT(230), (NT(358)));
//G585: __E_memory_158(362)  => '%'.
	p(NT(362), (T(59)));
//G586: rel_memory_sym(355)  => '%' '-'.
	p(NT(355), (T(59)+T(28)));
//G587: memory_id(364)       => digits(187).
	p(NT(364), (NT(187)));
//G588: __E___E_memory_158_159(363) => memory_id(364).
	p(NT(363), (NT(364)));
//G589: __E___E_memory_158_159(363) => null.
	p(NT(363), (nul));
//G590: __E_memory_158(362)  => rel_memory_sym(355) __E___E_memory_158_159(363).
	p(NT(362), (NT(355)+NT(363)));
//G591: rel_memory(361)      => __E_memory_158(362).
	p(NT(361), (NT(362)));
//G592: memory(261)          => rel_memory(361).
	p(NT(261), (NT(361)));
//G593: abs_memory_sym(354)  => '%'.
	p(NT(354), (T(59)));
//G594: __E_memory_160(366)  => abs_memory_sym(354) memory_id(364).
	p(NT(366), (NT(354)+NT(364)));
//G595: abs_memory(365)      => __E_memory_160(366).
	p(NT(365), (NT(366)));
//G596: memory(261)          => abs_memory(365).
	p(NT(261), (NT(365)));
	#undef T
	#undef NT
