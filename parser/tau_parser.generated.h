...
private:
	...
	idni::prods<char_type, terminal_type> load_prods() {
		...
		q(nt(311), (nt(248)));
		//       file(270)            => file_sym(312) quote(39) file_path(313) quote(39).
		q(nt(270), (nt(312)+nt(39)+nt(313)+nt(39)));
		//       __E_bf_instantiate_cmd_53(315) => bf(14).
		q(nt(315), (nt(14)));
		...
		//       __E_wff_instantiate_cmd_55(318) => wff(16).
		q(nt(318), (nt(16)));
		...
		//       __E_bf_substitute_cmd_57(321) => bf(14).
		q(nt(321), (nt(14)));
		...
		//       __E_wff_substitute_cmd_60(325) => wff(16).
		q(nt(325), (nt(16)));
