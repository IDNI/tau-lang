...
// 
// # TODO (MEDIUM) move this to a lowr level
// wff_matcher		=> (wff | bf_less | bf_less_equal ).
// 
...
// 					| bf_imply | bf_equiv | bf_coimply | bf_add
// 					| bf_less | bf_less_equal | bf_greater | bf_eq
// 					| bf_all | bf_ex | variable | timed | bf_subs_cb | bf_eq_cb.
...
// bf_add			=> open_parenthesis bf bf_add_sym bf close_parenthesis.
...
struct tau_parser {
	tau_parser() :
		...
		g(nts, load_prods(), nt(197), cc), p(g, load_opts()) {}
   ...
   enum nonterminal {
			...
			_Rtimed_9, wff_rule, wff_matcher, wff_ref, _Rwff_rule_10, wff, bf_eq_cb, _Rwff_rule_11, bf_less, bf_less_equal, 
			_Rwff_matcher_12, wff_ref_args, _Rwff_ref_args_13, _Rwff_ref_args_14, wff_eq, wff_neq, wff_and, wff_neg, wff_xor, wff_or, 
			wff_all, wff_ex, T, F, wff_imply, wff_equiv, wff_coimply, cbf, wff_and_sym, wff_or_sym, 
			wff_xor_sym, wff_neg_sym, wff_imply_sym, wff_equiv_sym, wff_coimply_sym, wff_all_sym, wff_ex_sym, cbf_rule, cbf_matcher, cbf_ref, 
			_Rcbf_rule_15, cbf_ref_args, _Rcbf_ref_args_16, _Rcbf_ref_args_17, bf, cbf_if, cbf_and, cbf_neg, cbf_xor, cbf_or, 
			cbf_imply, cbf_equiv, cbf_coimply, cbf_if_sym, cbf_if_condition, cbf_then_sym, cbf_if_then, cbf_else_sym, cbf_if_else, cbf_and_sym, 
			cbf_or_sym, cbf_xor_sym, cbf_neg_sym, cbf_imply_sym, cbf_equiv_sym, cbf_coimply_sym, bf_rule, bf_matcher, bf_constant, bf_and, 
			bf_neg, bf_xor, bf_or, bf_imply, bf_equiv, bf_coimply, bf_add, bf_greater, bf_eq, bf_all, 
			bf_ex, bf_subs_cb, bf_and_sym, bf_or_sym, bf_xor_sym, bf_neg_sym, bf_less_sym, bf_less_equal_sym, bf_greater_sym, bf_imply_sym, 
			bf_equiv_sym, bf_coimply_sym, bf_add_sym, bf_all_sym, _Rbf_all_18, bf_ex_sym, _Rbf_ex_19, constant, bf_cte_cb, binding, 
			bf_and_cb, bf_or_cb, bf_xor_cb, bf_neg_cb, bf_imply_cb, bf_equiv_cb, bf_coimply_cb, bf_less_cb, bf_less_equal_cb, bf_greater_cb, 
			source_binding, named_binding, type, source, source0, _Rsource_20, _Rsource_21, bf_cb_arg, bf_and_cb_sym, bf_or_cb_sym, 
			bf_xor_cb_sym, bf_neg_cb_sym, bf_less_cb_sym, bf_less_equal_cb_sym, bf_greater_cb_sym, bf_imply_cb_sym, bf_equiv_cb_sym, bf_coimply_cb_sym, bf_subs_cb_sym, bf_eq_cb_sym, 
...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(70), (nt(69)));
		q(nt(62), (nt(70)));
		q(nt(63), (nt(33)+nt(46)+nt(71)));
		q(nt(72), (nt(50)));
		q(nt(73), (nt(72)+nt(73)));
		q(nt(73), (nul));
		q(nt(71), (nt(38)+nt(73)+nt(39)));
		q(nt(65), (nt(50)));
		q(nt(65), (nt(57)));
		q(nt(65), (nt(63)));
		q(nt(65), (nt(74)));
		...
		q(nt(65), (nt(85)));
		q(nt(65), (nt(86)));
		q(nt(74), (nt(38)+nt(87)+nt(35)+nt(87)+nt(39)));
		q(nt(75), (nt(38)+nt(87)+nt(36)+nt(87)+nt(39)));
		q(nt(76), (nt(38)+nt(65)+nt(88)+nt(65)+nt(39)));
		q(nt(79), (nt(38)+nt(65)+nt(89)+nt(65)+nt(39)));
		q(nt(78), (nt(38)+nt(65)+nt(90)+nt(65)+nt(39)));
		q(nt(77), (nt(91)+nt(65)));
		q(nt(84), (nt(38)+nt(65)+nt(92)+nt(65)+nt(39)));
		q(nt(85), (nt(38)+nt(65)+nt(93)+nt(65)+nt(39)));
		q(nt(86), (nt(38)+nt(65)+nt(94)+nt(65)+nt(39)));
		q(nt(80), (nt(95)+nt(50)+nt(65)));
		q(nt(81), (nt(96)+nt(50)+nt(65)));
		q(nt(88), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(89), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(90), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(91), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(92), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(93), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(94), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(95), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(10)+t(11)+t(11)+nt(13)));
		q(nt(96), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(100), (nt(98)));
		q(nt(100), (nt(99)));
		q(nt(97), (nt(100)+nt(34)+nt(87)+nt(37)));
		q(nt(98), (nt(87)));
		...
		q(nt(87), (nt(111)));
		q(nt(87), (nt(112)));
		q(nt(105), (nt(113)+nt(114)+nt(115)+nt(116)+nt(117)+nt(118)));
		q(nt(114), (nt(65)));
		q(nt(116), (nt(87)));
		q(nt(118), (nt(87)));
		q(nt(106), (nt(38)+nt(87)+nt(119)+nt(87)+nt(39)));
		q(nt(109), (nt(38)+nt(87)+nt(120)+nt(87)+nt(39)));
		q(nt(108), (nt(38)+nt(87)+nt(121)+nt(87)+nt(39)));
		q(nt(107), (nt(122)+nt(87)));
		q(nt(110), (nt(38)+nt(87)+nt(123)+nt(87)+nt(39)));
		q(nt(111), (nt(38)+nt(87)+nt(124)+nt(87)+nt(39)));
		q(nt(112), (nt(38)+nt(87)+nt(125)+nt(87)+nt(39)));
		q(nt(119), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(120), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(121), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(122), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(123), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(124), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(125), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(113), (nt(13)+t(22)+t(26)+nt(13)));
		q(nt(115), (nt(13)+t(19)+t(15)+t(24)+t(12)+nt(13)));
		q(nt(117), (nt(13)+t(24)+t(11)+t(28)+t(24)+nt(13)));
		q(nt(126), (nt(127)+nt(34)+nt(104)+nt(37)));
		q(nt(127), (nt(104)));
		q(nt(104), (nt(50)));
		q(nt(104), (nt(57)));
		q(nt(104), (nt(66)));
		...
		q(nt(104), (nt(140)));
		q(nt(104), (nt(141)));
		q(nt(129), (nt(38)+nt(104)+nt(142)+nt(104)+nt(39)));
		q(nt(132), (nt(38)+nt(104)+nt(143)+nt(104)+nt(39)));
		q(nt(131), (nt(38)+nt(104)+nt(144)+nt(13)+nt(104)+nt(39)));
		q(nt(130), (nt(145)+nt(104)));
		q(nt(68), (nt(38)+nt(104)+nt(146)+nt(104)+nt(39)));
		q(nt(69), (nt(38)+nt(104)+nt(147)+nt(104)+nt(39)));
		q(nt(137), (nt(38)+nt(104)+nt(148)+nt(104)+nt(39)));
		q(nt(133), (nt(38)+nt(104)+nt(149)+nt(104)+nt(39)));
		q(nt(134), (nt(38)+nt(104)+nt(150)+nt(104)+nt(39)));
		q(nt(135), (nt(38)+nt(104)+nt(151)+nt(104)+nt(39)));
		q(nt(136), (nt(38)+nt(104)+nt(152)+nt(104)+nt(39)));
		q(nt(154), (nt(56)));
		q(nt(154), (nt(104)));
		q(nt(139), (nt(153)+nt(50)+nt(154)));
		q(nt(156), (nt(56)));
		q(nt(156), (nt(104)));
		q(nt(140), (nt(155)+nt(50)+nt(156)));
		q(nt(142), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(143), (nt(13)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(144), (nt(13)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(145), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(146), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+nt(13)));
		q(nt(147), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(24)+t(44)+t(6)+t(10)+t(11)+nt(13)));
		q(nt(148), (nt(13)+t(16)+t(26)+t(40)+t(23)+t(20)+t(24)+t(10)+t(19)+t(24)+t(20)+nt(13)));
		q(nt(149), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(150), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(151), (nt(13)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(152), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(21)+t(21)+nt(13)));
		q(nt(153), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(11)+t(11)+nt(13)));
		q(nt(155), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(128), (nt(42)+nt(157)+nt(43)));
		q(nt(128), (nt(82)));
		q(nt(128), (nt(83)));
		q(nt(157), (nt(55)));
		q(nt(157), (nt(56)));
		...
		q(nt(173), (nt(176)));
		q(nt(160), (nt(177)+nt(178)+nt(177)));
		q(nt(161), (nt(177)+nt(179)+nt(177)));
		q(nt(162), (nt(177)+nt(180)+nt(177)));
		q(nt(163), (nt(181)+nt(177)));
		q(nt(167), (nt(177)+nt(182)+nt(177)));
		q(nt(168), (nt(177)+nt(183)+nt(177)));
		q(nt(169), (nt(177)+nt(184)+nt(177)));
		q(nt(164), (nt(177)+nt(185)+nt(177)));
		q(nt(165), (nt(177)+nt(186)+nt(177)));
		q(nt(166), (nt(177)+nt(187)+nt(177)));
		q(nt(141), (nt(188)+nt(177)+nt(177)+nt(177)));
		q(nt(66), (nt(189)+nt(177)+nt(177)+nt(177)+nt(177)));
		q(nt(177), (nt(56)));
		q(nt(177), (nt(82)));
		q(nt(177), (nt(83)));
		q(nt(177), (nt(159)));
		...
		q(nt(185), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(186), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(187), (nt(13)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+t(40)+t(18)+t(16)+nt(13)));
