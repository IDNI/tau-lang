...
// wff_matcher	=> wff | cbf_if | wff_ref.
...
// # TODO (HIGH) add parenthesisis around if then else
...
struct tau_parser {
	tau_parser() :
		...
		g(nts, load_prods(), nt(203), cc), p(g, load_opts()) {}
   ...
   enum nonterminal {
			...
			timed, in, out, _Rtimed_11, wff_rule, wff_matcher, wff_body, wff, cbf_if, wff_ref, 
			bf_eq_cb, bf_neq_cb, wff_has_clashing_subformulas_cb, wff_has_subformula_cb, wff_ref_args, _Rwff_ref_args_12, _Rwff_ref_args_13, wff_eq, wff_neq, wff_and, 
			wff_neg, wff_xor, wff_or, wff_all, wff_ex, wff_imply, wff_equiv, wff_coimply, wff_t, wff_f, 
			cbf, wff_and_sym, wff_or_sym, wff_xor_sym, wff_neg_sym, wff_imply_sym, wff_equiv_sym, wff_coimply_sym, wff_all_sym, _Rwff_all_14, 
			wff_ex_sym, _Rwff_ex_15, cbf_rule, cbf_matcher, cbf_body, cbf_ref, cbf_ref_args, _Rcbf_ref_args_16, _Rcbf_ref_args_17, bf, 
			cbf_and, cbf_neg, cbf_xor, cbf_or, cbf_imply, cbf_equiv, cbf_coimply, cbf_if_sym, cbf_if_condition, cbf_then_sym, 
			cbf_if_then, cbf_else_sym, cbf_if_else, cbf_and_sym, cbf_or_sym, cbf_xor_sym, cbf_neg_sym, cbf_imply_sym, cbf_equiv_sym, cbf_coimply_sym, 
			bf_rule, bf_matcher, bf_body, bf_is_zero_cb, bf_is_one_cb, bf_has_clashing_subformulas_cb, bf_has_subformula_cb, bf_constant, bf_and, bf_neg, 
			bf_xor, bf_or, bf_all, bf_ex, bf_less, bf_less_equal, bf_greater, bf_less_cb, bf_less_equal_cb, bf_greater_cb, 
			bf_subs_cb, bf_t, bf_f, bf_and_sym, bf_or_sym, bf_xor_sym, bf_neg_sym, bf_less_sym, bf_less_equal_sym, bf_greater_sym, 
			...
			bf_xor_cb_sym, bf_neg_cb_sym, bf_less_cb_sym, bf_less_equal_cb_sym, bf_greater_cb_sym, bf_subs_cb_sym, bf_eq_cb_sym, wff_cb_arg, bf_neq_cb_sym, bf_is_zero_cb_sym, 
			bf_is_one_cb_sym, bf_has_clashing_subformulas_cb_sym, wff_has_clashing_subformulas_cb_sym, bf_has_subformula_cb_sym, wff_has_subformula_cb_sym, main, rule, rules, _Rrules_22, _Rrules_23, 
			formula, library, builder, start, 
   };
...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(67), (nt(88)));
		q(nt(67), (nt(89)));
		q(nt(77), (nt(38)+nt(90)+nt(35)+nt(89)+nt(39)));
		q(nt(78), (nt(38)+nt(90)+nt(36)+nt(89)+nt(39)));
		q(nt(79), (nt(38)+nt(67)+nt(91)+nt(67)+nt(39)));
		q(nt(82), (nt(38)+nt(67)+nt(92)+nt(67)+nt(39)));
		q(nt(81), (nt(38)+nt(67)+nt(93)+nt(67)+nt(39)));
		q(nt(80), (nt(94)+nt(67)));
		q(nt(85), (nt(38)+nt(67)+nt(95)+nt(67)+nt(39)));
		q(nt(86), (nt(38)+nt(67)+nt(96)+nt(67)+nt(39)));
		q(nt(87), (nt(38)+nt(67)+nt(97)+nt(67)+nt(39)));
		q(nt(99), (nt(50)));
		q(nt(99), (nt(51)));
		q(nt(99), (nt(52)));
		q(nt(83), (nt(98)+nt(99)+nt(12)+nt(67)));
		q(nt(101), (nt(50)));
		q(nt(101), (nt(51)));
		q(nt(101), (nt(52)));
		q(nt(84), (nt(100)+nt(101)+nt(12)+nt(67)));
		q(nt(91), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(92), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(93), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(94), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(95), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(96), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(97), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(98), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(10)+t(11)+t(11)+nt(13)));
		q(nt(100), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(88), (nt(13)+t(46)+nt(13)));
		q(nt(89), (nt(13)+t(47)+nt(13)));
		q(nt(102), (nt(103)+nt(34)+nt(104)+nt(37)));
		q(nt(103), (nt(90)));
		q(nt(103), (nt(105)));
		q(nt(104), (nt(90)));
		q(nt(105), (nt(33)+nt(46)+nt(106)));
		q(nt(107), (nt(50)));
		q(nt(108), (nt(107)+nt(108)));
		q(nt(108), (nul));
		q(nt(106), (nt(38)+nt(108)+nt(39)));
		q(nt(90), (nt(105)));
		q(nt(90), (nt(109)));
		q(nt(90), (nt(110)));
		q(nt(90), (nt(111)));
		...
		q(nt(90), (nt(115)));
		q(nt(90), (nt(116)));
		q(nt(68), (nt(117)+nt(118)+nt(119)+nt(120)+nt(121)+nt(122)));
		q(nt(118), (nt(67)));
		q(nt(120), (nt(90)));
		q(nt(122), (nt(90)));
		q(nt(110), (nt(38)+nt(90)+nt(123)+nt(90)+nt(39)));
		q(nt(113), (nt(38)+nt(90)+nt(124)+nt(90)+nt(39)));
		q(nt(112), (nt(38)+nt(90)+nt(125)+nt(90)+nt(39)));
		q(nt(111), (nt(126)+nt(90)));
		q(nt(114), (nt(38)+nt(90)+nt(127)+nt(90)+nt(39)));
		q(nt(115), (nt(38)+nt(90)+nt(128)+nt(90)+nt(39)));
		q(nt(116), (nt(38)+nt(90)+nt(129)+nt(90)+nt(39)));
		q(nt(123), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(124), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(125), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(126), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(127), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(128), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(129), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(117), (nt(13)+t(22)+t(26)+nt(13)));
		q(nt(119), (nt(13)+t(19)+t(15)+t(24)+t(12)+nt(13)));
		q(nt(121), (nt(13)+t(24)+t(11)+t(28)+t(24)+nt(13)));
		q(nt(130), (nt(131)+nt(34)+nt(132)+nt(37)));
		q(nt(131), (nt(109)));
		q(nt(132), (nt(109)));
		q(nt(132), (nt(133)));
		q(nt(132), (nt(134)));
		...
		q(nt(109), (nt(151)));
		q(nt(109), (nt(152)));
		q(nt(138), (nt(38)+nt(109)+nt(153)+nt(109)+nt(39)));
		q(nt(141), (nt(38)+nt(109)+nt(154)+nt(109)+nt(39)));
		q(nt(140), (nt(38)+nt(109)+nt(155)+nt(13)+nt(109)+nt(39)));
		q(nt(139), (nt(156)+nt(109)));
		q(nt(144), (nt(38)+nt(109)+nt(157)+nt(109)+nt(39)));
		q(nt(145), (nt(38)+nt(109)+nt(158)+nt(109)+nt(39)));
		q(nt(146), (nt(38)+nt(109)+nt(159)+nt(109)+nt(39)));
		q(nt(161), (nt(50)));
		q(nt(161), (nt(51)));
		q(nt(142), (nt(160)+nt(12)+nt(161)+nt(12)+nt(109)));
		q(nt(163), (nt(50)));
		q(nt(163), (nt(51)));
		q(nt(143), (nt(162)+nt(12)+nt(163)+nt(12)+nt(109)));
		q(nt(153), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(154), (nt(13)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(155), (nt(13)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(156), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(157), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+nt(13)));
		q(nt(158), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(24)+t(44)+t(6)+t(10)+t(11)+nt(13)));
		q(nt(159), (nt(13)+t(16)+t(26)+t(40)+t(23)+t(20)+t(24)+t(10)+t(19)+t(24)+t(20)+nt(13)));
		q(nt(160), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(11)+t(11)+nt(13)));
		q(nt(162), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(151), (nt(13)+t(46)+nt(13)));
		q(nt(152), (nt(13)+t(47)+nt(13)));
		q(nt(137), (nt(42)+nt(164)+nt(43)));
		q(nt(164), (nt(51)));
		q(nt(164), (nt(52)));
		q(nt(164), (nt(165)));
		q(nt(164), (nt(166)));
		...
		q(nt(173), (nt(176)));
		q(nt(166), (nt(177)+nt(178)+nt(177)));
		q(nt(167), (nt(177)+nt(179)+nt(177)));
		q(nt(168), (nt(177)+nt(180)+nt(177)));
		q(nt(169), (nt(181)+nt(177)));
		q(nt(147), (nt(182)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)));
		q(nt(148), (nt(183)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)));
		q(nt(149), (nt(184)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)));
		q(nt(150), (nt(185)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)));
		q(nt(70), (nt(186)+nt(177)+nt(12)+nt(187)+nt(12)+nt(187)));
		q(nt(71), (nt(188)+nt(177)+nt(12)+nt(187)+nt(12)+nt(187)));
		q(nt(133), (nt(189)+nt(177)+nt(12)+nt(177)));
		q(nt(134), (nt(190)+nt(177)+nt(12)+nt(177)));
		q(nt(135), (nt(191)+nt(177)+nt(12)+nt(177)));
		q(nt(72), (nt(192)+nt(187)+nt(12)+nt(187)));
		q(nt(136), (nt(193)+nt(177)+nt(12)+nt(177)+nt(12)+nt(177)));
		q(nt(73), (nt(194)+nt(187)+nt(12)+nt(187)+nt(12)+nt(187)));
		q(nt(177), (nt(51)));
		q(nt(177), (nt(52)));
		q(nt(177), (nt(109)));
		q(nt(187), (nt(51)));
		q(nt(187), (nt(52)));
		q(nt(187), (nt(67)));
		q(nt(178), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(179), (nt(13)+t(16)+t(26)+t(40)+t(25)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(180), (nt(13)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(181), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(182), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(183), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(24)+t(44)+t(6)+t(10)+t(11)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(184), (nt(13)+t(16)+t(26)+t(40)+t(23)+t(20)+t(24)+t(10)+t(19)+t(24)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		...
		q(nt(188), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(44)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(189), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(28)+t(40)+t(48)+t(24)+t(20)+t(25)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(190), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(28)+t(40)+t(25)+t(12)+t(24)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(191), (nt(13)+t(16)+t(26)+t(40)+t(15)+t(10)+t(28)+t(40)+t(18)+t(11)+t(10)+t(28)+t(15)+t(22)+t(12)+t(23)+t(40)+t(28)+t(6)+t(16)+t(26)+t(25)+t(20)+t(13)+t(6)+t(11)+t(10)+t(28)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(193), (nt(13)+t(16)+t(26)+t(40)+t(15)+t(10)+t(28)+t(40)+t(28)+t(6)+t(16)+t(26)+t(25)+t(20)+t(13)+t(6)+t(11)+t(10)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(192), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(15)+t(10)+t(28)+t(40)+t(18)+t(11)+t(10)+t(28)+t(15)+t(22)+t(12)+t(23)+t(40)+t(28)+t(6)+t(16)+t(26)+t(25)+t(20)+t(13)+t(6)+t(11)+t(10)+t(28)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(194), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(15)+t(10)+t(28)+t(40)+t(28)+t(6)+t(16)+t(26)+t(25)+t(20)+t(13)+t(6)+t(11)+t(10)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(195), (nt(67)+nt(37)));
		q(nt(196), (nt(64)));
		q(nt(196), (nt(102)));
		q(nt(196), (nt(130)));
		q(nt(198), (nt(196)));
		...
		q(nt(199), (nul));
		q(nt(197), (nt(199)));
		q(nt(200), (nt(197)+nt(195)));
		q(nt(201), (nt(197)));
		q(nt(202), (nt(56)+nt(34)+nt(67)+nt(37)));
		q(nt(203), (nt(200)));
		q(nt(203), (nt(201)));
		q(nt(203), (nt(202)));
		return q;
