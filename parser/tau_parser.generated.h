...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(67), (nt(40)+nt(55)+nt(41)));
		// relative_pos => open_bracket pos_var minus num close_bracket.
		q(nt(68), (nt(40)+nt(71)+nt(44)+nt(55)+nt(41)));
		...
		q(nt(225), (nt(38)+nt(14)+nt(56)+nt(228)+nt(14)+nt(39)));
		// builder_body => tau.
		q(nt(226), (nt(75)));
		// builder_body => wff.
		q(nt(226), (nt(78)));
