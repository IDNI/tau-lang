...
private:
	...
	idni::nonterminals<char> load_nonterminals() const {
		...
		for (const auto& nt : {
			...
			"_Rchars_4", "_Rchars_5", "sym", "rvar", "lvar", "term", "negative_term", "positive_term", "relname", "args", 
			"elems", "elem", "elems_rest", "char_class", "fof", "preds", "form", "form1", "causal_op", "_Rform_6", 
			"_Rform_7", "matrix", "junct_op", "_Rform1_8", "_Rform1_9", "implies", "coimplies", "and_", "or_", "neg_matrix", 
			"matrix_block", "prefix_decl", "prefix", "prefix_arg", "start", "program", 
		}) nts.get(nt);
		return nts;
	}
	...
	idni::prods<char> load_prods() {
		...
		q(nt(44), (nt(45)+nt(13)+t(33)+t(34)+nt(13)+nt(46)+nt(13)+t(35)));
		q(nt(49), (nt(13)+nt(48)+nt(13)+nt(47)));
		q(nt(50), (nt(49)+nt(50)));
		q(nt(50), (nul));
		q(nt(46), (nt(47)+nt(50)));
		q(nt(53), (nt(13)+nt(52)+nt(13)+nt(51)));
		q(nt(54), (nt(53)+nt(54)));
		q(nt(54), (nul));
		q(nt(47), (nt(51)+nt(54)));
		q(nt(48), (nt(55)));
		...
		q(nt(58), (t(37)+t(37)));
		q(nt(55), (t(34)+t(38)));
		q(nt(56), (t(39)+t(34)+t(38)));
		q(nt(51), (nt(37)));
		q(nt(51), (nt(59)));
		q(nt(51), (nt(60)));
		q(nt(51), (nt(61)));
		q(nt(59), (t(11)+nt(51)));
		q(nt(60), (t(40)+nt(13)+nt(46)+nt(13)+t(41)));
		q(nt(61), (nt(62)+nt(13)+nt(63)+nt(13)+nt(46)));
		q(nt(62), (t(28)+t(5)+t(26)+t(32)+t(23)+t(32)));
		q(nt(62), (t(30)+t(29)+t(24)+t(14)+t(15)+t(15)));
		q(nt(62), (t(6)+t(16)+t(26)+t(42)+t(6)+t(28)));
		q(nt(63), (nt(33)));
		q(nt(63), (nt(34)));
		q(nt(64), (nt(65)));
		return q;
