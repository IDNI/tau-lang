...
// 
// # wff
// wff_rule		=> (wff_matcher | wff_ref) definition (wff | bf_eq_cb) dot.
// 
// wff_matcher		=> wff.
// 
...
// wff 			=> wff_eq | wff_neq 
// 					| wff_ref | wff_and | wff_neg | wff_xor 
// 					| wff_or | wff_all | wff_ex | T | F | variable | timed
// 					| wff_imply | wff_equiv | wff_coimply
// 					| bf_eq_cb | bf_neq_cb.
// wff_eq 			=> open_parenthesis cbf equality cbf close_parenthesis.
// wff_neq 		=> open_parenthesis cbf nequality cbf close_parenthesis.
...
// 						| cbf_imply | cbf_equiv | cbf_coimply | cbf_ref | T | F.
...
// 					| bf_subs_cb | bf_xor_cb | bf_and_cb | bf_or_cb | bf_neg_cb
// 					| bf_less_cb | bf_less_equal_cb | bf_greater_cb | bf_imply_cb
// 					| bf_coimply_cb | bf_equiv_cb.
...
// bf_less_cb			=> bf_less_cb_sym bf_cb_arg bf_cb_arg bf_cb_arg bf_cb_arg.
// bf_less_equal_cb	=> bf_less_equal_cb_sym bf_cb_arg bf_cb_arg bf_cb_arg bf_cb_arg.
// bf_greater_cb		=> bf_greater_cb_sym bf_cb_arg bf_cb_arg bf_cb_arg bf_cb_arg.
...
// bf_eq_cb			=> bf_eq_cb_sym bf_cb_arg bf_cb_arg bf_cb_arg bf_cb_arg.
// bf_neq_cb			=> bf_neq_cb_sym bf_cb_arg bf_cb_arg bf_cb_arg bf_cb_arg.
// 
// # bf_bultin_arg
...
struct tau_parser {
	tau_parser() :
		...
		g(nts, load_prods(), nt(195), cc), p(g, load_opts()) {}
   ...
   enum nonterminal {
			...
			variable, offset, num, _Rnum_8, var, ignore, capture, timed, var_in, var_out, 
			_Rtimed_9, wff_rule, wff_matcher, wff_ref, _Rwff_rule_10, wff, bf_eq_cb, _Rwff_rule_11, wff_ref_args, _Rwff_ref_args_12, 
			_Rwff_ref_args_13, wff_eq, wff_neq, wff_and, wff_neg, wff_xor, wff_or, wff_all, wff_ex, T, 
			F, wff_imply, wff_equiv, wff_coimply, bf_neq_cb, cbf, wff_and_sym, wff_or_sym, wff_xor_sym, wff_neg_sym, 
			wff_imply_sym, wff_equiv_sym, wff_coimply_sym, wff_all_sym, wff_ex_sym, cbf_rule, cbf_matcher, cbf_ref, _Rcbf_rule_14, cbf_ref_args, 
			_Rcbf_ref_args_15, _Rcbf_ref_args_16, bf, cbf_if, cbf_and, cbf_neg, cbf_xor, cbf_or, cbf_imply, cbf_equiv, 
			cbf_coimply, cbf_if_sym, cbf_if_condition, cbf_then_sym, cbf_if_then, cbf_else_sym, cbf_if_else, cbf_and_sym, cbf_or_sym, cbf_xor_sym, 
			cbf_neg_sym, cbf_imply_sym, cbf_equiv_sym, cbf_coimply_sym, bf_rule, bf_matcher, bf_constant, bf_and, bf_neg, bf_xor, 
			bf_or, bf_imply, bf_equiv, bf_coimply, bf_all, bf_ex, bf_less, bf_less_equal, bf_greater, bf_subs_cb, 
			bf_xor_cb, bf_and_cb, bf_or_cb, bf_neg_cb, bf_less_cb, bf_less_equal_cb, bf_greater_cb, bf_imply_cb, bf_coimply_cb, bf_equiv_cb, 
			bf_and_sym, bf_or_sym, bf_xor_sym, bf_neg_sym, bf_less_sym, bf_less_equal_sym, bf_greater_sym, bf_imply_sym, bf_equiv_sym, bf_coimply_sym, 
			bf_all_sym, _Rbf_all_17, bf_ex_sym, _Rbf_ex_18, constant, bf_cte_cb, binding, source_binding, named_binding, type, 
			source, source0, _Rsource_19, _Rsource_20, bf_cb_arg, bf_and_cb_sym, bf_or_cb_sym, bf_xor_cb_sym, bf_neg_cb_sym, bf_less_cb_sym, 
			bf_less_equal_cb_sym, bf_greater_cb_sym, bf_imply_cb_sym, bf_equiv_cb_sym, bf_coimply_cb_sym, bf_subs_cb_sym, bf_eq_cb_sym, bf_neq_cb_sym, main, rule, 
			rules, _Rrules_21, _Rrules_22, formula, library, start, 
   };
...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(57), (nt(60)+nt(46)));
		q(nt(51), (nt(50)));
		q(nt(51), (nt(50)+nt(44)+nt(52)));
		q(nt(55), (t(40)));
		q(nt(56), (nt(13)+t(41)+nt(29)+nt(13)));
		q(nt(54), (nt(13)+t(42)+nt(29)+nt(13)));
		q(nt(58), (nt(13)+t(42)+t(22)+t(40)+nt(29)+nt(13)));
		q(nt(59), (nt(13)+t(42)+t(25)+t(40)+nt(29)+nt(13)));
		q(nt(64), (nt(62)));
		q(nt(64), (nt(63)));
		q(nt(67), (nt(65)));
		q(nt(67), (nt(66)));
		q(nt(61), (nt(64)+nt(34)+nt(67)+nt(37)));
		q(nt(62), (nt(65)));
		q(nt(63), (nt(33)+nt(46)+nt(68)));
		q(nt(69), (nt(50)));
		q(nt(70), (nt(69)+nt(70)));
		q(nt(70), (nul));
		q(nt(68), (nt(38)+nt(70)+nt(39)));
		q(nt(65), (nt(50)));
		q(nt(65), (nt(57)));
		q(nt(65), (nt(63)));
		q(nt(65), (nt(66)));
		...
		q(nt(65), (nt(83)));
		q(nt(65), (nt(84)));
		q(nt(71), (nt(38)+nt(85)+nt(35)+nt(85)+nt(39)));
		q(nt(72), (nt(38)+nt(85)+nt(36)+nt(85)+nt(39)));
		q(nt(73), (nt(38)+nt(65)+nt(86)+nt(65)+nt(39)));
		q(nt(76), (nt(38)+nt(65)+nt(87)+nt(65)+nt(39)));
		q(nt(75), (nt(38)+nt(65)+nt(88)+nt(65)+nt(39)));
		q(nt(74), (nt(89)+nt(65)));
		q(nt(81), (nt(38)+nt(65)+nt(90)+nt(65)+nt(39)));
		q(nt(82), (nt(38)+nt(65)+nt(91)+nt(65)+nt(39)));
		q(nt(83), (nt(38)+nt(65)+nt(92)+nt(65)+nt(39)));
		q(nt(77), (nt(93)+nt(50)+nt(65)));
		q(nt(78), (nt(94)+nt(50)+nt(65)));
		...
		q(nt(94), (nt(13)+t(27)+t(26)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(98), (nt(96)));
		q(nt(98), (nt(97)));
		q(nt(95), (nt(98)+nt(34)+nt(85)+nt(37)));
		q(nt(96), (nt(85)));
		q(nt(97), (nt(33)+nt(46)+nt(99)));
		q(nt(100), (nt(50)));
		q(nt(101), (nt(100)+nt(101)));
		q(nt(101), (nul));
		q(nt(99), (nt(38)+nt(101)+nt(39)));
		q(nt(85), (nt(79)));
		q(nt(85), (nt(80)));
		q(nt(85), (nt(97)));
		q(nt(85), (nt(102)));
		...
		q(nt(85), (nt(109)));
		q(nt(85), (nt(110)));
		q(nt(103), (nt(111)+nt(112)+nt(113)+nt(114)+nt(115)+nt(116)));
		q(nt(112), (nt(65)));
		q(nt(114), (nt(85)));
		q(nt(116), (nt(85)));
		q(nt(104), (nt(38)+nt(85)+nt(117)+nt(85)+nt(39)));
		q(nt(107), (nt(38)+nt(85)+nt(118)+nt(85)+nt(39)));
		q(nt(106), (nt(38)+nt(85)+nt(119)+nt(85)+nt(39)));
		q(nt(105), (nt(120)+nt(85)));
		q(nt(108), (nt(38)+nt(85)+nt(121)+nt(85)+nt(39)));
		q(nt(109), (nt(38)+nt(85)+nt(122)+nt(85)+nt(39)));
		q(nt(110), (nt(38)+nt(85)+nt(123)+nt(85)+nt(39)));
		q(nt(117), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(118), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(119), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(120), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(121), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(122), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(123), (nt(13)+t(18)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(111), (nt(13)+t(22)+t(26)+nt(13)));
		q(nt(113), (nt(13)+t(19)+t(15)+t(24)+t(12)+nt(13)));
		q(nt(115), (nt(13)+t(24)+t(11)+t(28)+t(24)+nt(13)));
		q(nt(124), (nt(125)+nt(34)+nt(102)+nt(37)));
		q(nt(125), (nt(102)));
		q(nt(102), (nt(50)));
		q(nt(102), (nt(57)));
		q(nt(102), (nt(126)));
		...
		q(nt(102), (nt(148)));
		q(nt(102), (nt(149)));
		q(nt(127), (nt(38)+nt(102)+nt(150)+nt(102)+nt(39)));
		q(nt(130), (nt(38)+nt(102)+nt(151)+nt(102)+nt(39)));
		q(nt(129), (nt(38)+nt(102)+nt(152)+nt(13)+nt(102)+nt(39)));
		q(nt(128), (nt(153)+nt(102)));
		q(nt(136), (nt(38)+nt(102)+nt(154)+nt(102)+nt(39)));
		q(nt(137), (nt(38)+nt(102)+nt(155)+nt(102)+nt(39)));
		q(nt(138), (nt(38)+nt(102)+nt(156)+nt(102)+nt(39)));
		q(nt(131), (nt(38)+nt(102)+nt(157)+nt(102)+nt(39)));
		q(nt(132), (nt(38)+nt(102)+nt(158)+nt(102)+nt(39)));
		q(nt(133), (nt(38)+nt(102)+nt(159)+nt(102)+nt(39)));
		q(nt(161), (nt(56)));
		q(nt(161), (nt(102)));
		q(nt(134), (nt(160)+nt(50)+nt(161)));
		q(nt(163), (nt(56)));
		q(nt(163), (nt(102)));
		q(nt(135), (nt(162)+nt(50)+nt(163)));
		q(nt(150), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+nt(13)));
		q(nt(151), (nt(13)+t(16)+t(26)+t(40)+t(25)+t(20)+nt(13)));
		q(nt(152), (nt(13)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+nt(13)));
		q(nt(153), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+nt(13)));
		q(nt(154), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+nt(13)));
		q(nt(155), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(24)+t(44)+t(6)+t(10)+t(11)+nt(13)));
		q(nt(156), (nt(13)+t(16)+t(26)+t(40)+t(23)+t(20)+t(24)+t(10)+t(19)+t(24)+t(20)+nt(13)));
		q(nt(157), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(158), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+nt(13)));
		q(nt(159), (nt(13)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+nt(13)));
		q(nt(160), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(11)+t(11)+nt(13)));
		q(nt(162), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(5)+nt(13)));
		q(nt(126), (nt(42)+nt(164)+nt(43)));
		q(nt(126), (nt(79)));
		q(nt(126), (nt(80)));
		q(nt(164), (nt(55)));
		q(nt(164), (nt(56)));
		...
		q(nt(170), (nt(173)));
		q(nt(141), (nt(174)+nt(175)+nt(174)));
		q(nt(142), (nt(174)+nt(176)+nt(174)));
		q(nt(140), (nt(174)+nt(177)+nt(174)));
		q(nt(143), (nt(178)+nt(174)));
		q(nt(144), (nt(179)+nt(174)+nt(174)+nt(174)+nt(174)));
		q(nt(145), (nt(180)+nt(174)+nt(174)+nt(174)+nt(174)));
		q(nt(146), (nt(181)+nt(174)+nt(174)+nt(174)+nt(174)));
		q(nt(147), (nt(174)+nt(182)+nt(174)));
		q(nt(149), (nt(174)+nt(183)+nt(174)));
		q(nt(148), (nt(174)+nt(184)+nt(174)));
		q(nt(139), (nt(185)+nt(174)+nt(174)+nt(174)));
		q(nt(66), (nt(186)+nt(174)+nt(174)+nt(174)+nt(174)));
		q(nt(84), (nt(187)+nt(174)+nt(174)+nt(174)+nt(174)));
		q(nt(174), (nt(56)));
		q(nt(174), (nt(79)));
		q(nt(174), (nt(80)));
		q(nt(174), (nt(166)));
		q(nt(175), (nt(13)+t(16)+t(26)+t(40)+t(10)+t(12)+t(21)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(176), (nt(13)+t(16)+t(26)+t(40)+t(25)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(177), (nt(13)+t(16)+t(26)+t(40)+t(5)+t(25)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(178), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(23)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(179), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(180), (nt(13)+t(16)+t(26)+t(40)+t(11)+t(24)+t(28)+t(28)+t(40)+t(24)+t(44)+t(6)+t(10)+t(11)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(181), (nt(13)+t(16)+t(26)+t(40)+t(23)+t(20)+t(24)+t(10)+t(19)+t(24)+t(20)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(182), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(13)+t(14)+t(11)+t(43)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(183), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(44)+t(6)+t(22)+t(45)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(184), (nt(13)+t(16)+t(26)+t(40)+t(18)+t(25)+t(22)+t(13)+t(14)+t(11)+t(43)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(185), (nt(13)+t(16)+t(26)+t(40)+t(28)+t(6)+t(16)+t(28)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(186), (nt(13)+t(16)+t(26)+t(40)+t(24)+t(44)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(187), (nt(13)+t(16)+t(26)+t(40)+t(12)+t(24)+t(44)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(188), (nt(65)+nt(37)));
		q(nt(189), (nt(61)));
		q(nt(189), (nt(95)));
		q(nt(189), (nt(124)));
		q(nt(191), (nt(189)));
