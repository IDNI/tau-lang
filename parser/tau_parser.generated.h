...
inline std::vector<std::string> symbol_names{
	...
	"normalize_sym", "__E___E_cli_command_128_129", "normalize_cmd_arg", "wff_inst_cmd", "__E_cli_command_130", "inst_sym", "__E___E_cli_command_130_131", "wff_cmd_out_arg", "wff_subst_cmd", "__E_cli_command_132", 
	"subst_sym", "__E___E_cli_command_132_133", "bf_inst_cmd", "__E_cli_command_134", "bf_cmd_arg", "bf_cmd_out_arg", "bf_subst_cmd", "__E_cli_command_135", "dnf_cmd", "__E_cli_command_136", 
	"dnf_sym", "nf_cmd_arg", "cnf_cmd", "__E_cli_command_137", "cnf_sym", "anf_cmd", "__E_cli_command_138", "anf_sym", "nnf_cmd", "__E_cli_command_139", 
	"nnf_sym", "pnf_cmd", "__E_cli_command_140", "pnf_sym", "mnf_cmd", "__E_cli_command_141", "mnf_sym", "snf_cmd", "__E_cli_command_142", "snf_sym", 
	"onf_cmd", "__E_cli_command_143", "onf_sym", "onf_cmd_arg", "def_list_cmd", "__E_cli_command_144", "def_sym", "def_rr_cmd", "__E_cli_command_145", "def_del_cmd", 
	"__E_cli_command_146", "del_sym", "__E___E_cli_command_146_147", "memory", "def_clear_cmd", "__E_cli_command_148", "def_print_cmd", "__E_cli_command_149", "memory_list_cmd", "__E_cli_command_150", 
	"memory_sym", "__E___E_cli_command_150_151", "memory_del_cmd", "__E_cli_command_152", "memory_clear_cmd", "__E_cli_command_153", "memory_print_cmd", "__E_cli_command_154", "memory_store_cmd", "__E_cli_command_155", 
	"memory_store_cmd_arg", "__E___E_cli_command_155_156", "qelim_cmd", "__E_cli_command_157", "qelim_sym", "get_cmd", "__E_cli_command_158", "get_sym", "__E___E_cli_command_158_159", "option", 
	"set_cmd", "__E_cli_command_160", "set_sym", "__E___E_cli_command_160_161", "option_value", "toggle_cmd", "__E_cli_command_162", "toggle_sym", "bool_option", "bf_selection", 
	"wff_selection", "abs_memory_sym", "rel_memory_sym", "selection_sym", "examples_sym", "__E_help_arg_163", "__E___E_help_arg_163_164", "rel_memory", "__E_memory_165", "__E___E_memory_165_166", 
	"memory_id", "abs_memory", "__E_memory_167", "__E___E_memory_167_168", "bf_var_selection", "wff_var_selection", "enum_option", "severity_opt", "__E_option_169", "status_opt", 
	"__E_bool_option_170", "colors_opt", "__E_bool_option_171", "debug_repl_opt", "__E_bool_option_172", "option_value_true", "option_value_false", "severity", "error_sym", "__E_severity_173", 
	"info_sym", "__E_severity_174", "debug_sym", "__E_severity_175", "trace_sym", "__E_severity_176", "bf_all", "bf_ex", "__N_0", "__N_1", 
	"__N_2", "__N_3", 
};
	...
	grammar_options
{
	...
	.shaping = {
		...
		.to_trim_children_terminals = {
			...
			320, 330, 334, 337, 340, 343, 346, 349, 352, 356,
			361, 370, 384, 387, 390, 392, 397, 401, 402, 403,
			404, 417, 419, 421, 423, 425, 426, 428, 430, 432,
			434, 436, 437
		},
...
//G288: __N_1(439)           => 'T'.
	p(NT(439), (T(24)));
//G289: __E_charvar_87(224)  => ~( __N_0(438) ) & ~( __N_1(439) ) & alpha(5).	 # conjunctive
	p(NT(224), ~(NT(438)) & ~(NT(439)) & (NT(5)));
...
//G316: offset(232)          => shift(238).
	p(NT(232), (NT(238)));
//G317: __N_2(440)           => io_var(226).
	p(NT(440), (NT(226)));
//G318: __E_offset_94(239)   => variable(163) & ~( __N_2(440) ).	 # conjunctive
	p(NT(239), (NT(163)) & ~(NT(440)));
//G319: offset(232)          => __E_offset_94(239).
	p(NT(232), (NT(239)));
//G320: __E_shift_95(240)    => capture(70).
	p(NT(240), (NT(70)));
//G321: __N_3(441)           => io_var(226).
	p(NT(441), (NT(226)));
//G322: __E___E_shift_95_96(241) => variable(163) & ~( __N_3(441) ).	 # conjunctive
	p(NT(241), (NT(163)) & ~(NT(441)));
...
//G330: uninterpreted_constant(142) => '<' uninter_const_name(243) _(16) '>'.
	p(NT(142), (T(5)+NT(243)+NT(16)+T(22)));
...
//G445: subst_sym(320)       => __E___E_cli_command_132_133(321).
	p(NT(320), (NT(321)));
//G446: __E_cli_command_132(319) => subst_sym(320) __(72) wff_cmd_arg(301) __(72) wff_cmd_arg(301) __(72) wff_cmd_out_arg(317).
	p(NT(319), (NT(320)+NT(72)+NT(301)+NT(72)+NT(301)+NT(72)+NT(317)));
//G447: wff_subst_cmd(318)   => __E_cli_command_132(319).
	p(NT(318), (NT(319)));
//G448: cli_command(266)     => wff_subst_cmd(318).
	p(NT(266), (NT(318)));
//G449: __E_cli_command_134(323) => inst_sym(315) __(72) variable(163) __(72) bf_cmd_arg(324) __(72) bf_cmd_out_arg(325).
	p(NT(323), (NT(315)+NT(72)+NT(163)+NT(72)+NT(324)+NT(72)+NT(325)));
//G450: bf_inst_cmd(322)     => __E_cli_command_134(323).
	p(NT(322), (NT(323)));
//G451: cli_command(266)     => bf_inst_cmd(322).
	p(NT(266), (NT(322)));
//G452: __E_cli_command_135(327) => subst_sym(320) __(72) bf_cmd_arg(324) __(72) bf_cmd_arg(324) __(72) bf_cmd_out_arg(325).
	p(NT(327), (NT(320)+NT(72)+NT(324)+NT(72)+NT(324)+NT(72)+NT(325)));
//G453: bf_subst_cmd(326)    => __E_cli_command_135(327).
	p(NT(326), (NT(327)));
//G454: cli_command(266)     => bf_subst_cmd(326).
	p(NT(266), (NT(326)));
//G455: dnf_sym(330)         => 'd' 'n' 'f'.
	p(NT(330), (T(41)+T(44)+T(42)));
//G456: __E_cli_command_136(329) => dnf_sym(330) __(72) nf_cmd_arg(331).
	p(NT(329), (NT(330)+NT(72)+NT(331)));
//G457: dnf_cmd(328)         => __E_cli_command_136(329).
	p(NT(328), (NT(329)));
//G458: cli_command(266)     => dnf_cmd(328).
	p(NT(266), (NT(328)));
//G459: cnf_sym(334)         => 'c' 'n' 'f'.
	p(NT(334), (T(34)+T(44)+T(42)));
//G460: __E_cli_command_137(333) => cnf_sym(334) __(72) nf_cmd_arg(331).
	p(NT(333), (NT(334)+NT(72)+NT(331)));
//G461: cnf_cmd(332)         => __E_cli_command_137(333).
	p(NT(332), (NT(333)));
//G462: cli_command(266)     => cnf_cmd(332).
	p(NT(266), (NT(332)));
//G463: anf_sym(337)         => 'a' 'n' 'f'.
	p(NT(337), (T(18)+T(44)+T(42)));
//G464: __E_cli_command_138(336) => anf_sym(337) __(72) nf_cmd_arg(331).
	p(NT(336), (NT(337)+NT(72)+NT(331)));
//G465: anf_cmd(335)         => __E_cli_command_138(336).
	p(NT(335), (NT(336)));
//G466: cli_command(266)     => anf_cmd(335).
	p(NT(266), (NT(335)));
//G467: nnf_sym(340)         => 'n' 'n' 'f'.
	p(NT(340), (T(44)+T(44)+T(42)));
//G468: __E_cli_command_139(339) => nnf_sym(340) __(72) nf_cmd_arg(331).
	p(NT(339), (NT(340)+NT(72)+NT(331)));
//G469: nnf_cmd(338)         => __E_cli_command_139(339).
	p(NT(338), (NT(339)));
//G470: cli_command(266)     => nnf_cmd(338).
	p(NT(266), (NT(338)));
//G471: pnf_sym(343)         => 'p' 'n' 'f'.
	p(NT(343), (T(35)+T(44)+T(42)));
//G472: __E_cli_command_140(342) => pnf_sym(343) __(72) nf_cmd_arg(331).
	p(NT(342), (NT(343)+NT(72)+NT(331)));
//G473: pnf_cmd(341)         => __E_cli_command_140(342).
	p(NT(341), (NT(342)));
//G474: cli_command(266)     => pnf_cmd(341).
	p(NT(266), (NT(341)));
//G475: mnf_sym(346)         => 'm' 'n' 'f'.
	p(NT(346), (T(47)+T(44)+T(42)));
//G476: __E_cli_command_141(345) => mnf_sym(346) __(72) nf_cmd_arg(331).
	p(NT(345), (NT(346)+NT(72)+NT(331)));
//G477: mnf_cmd(344)         => __E_cli_command_141(345).
	p(NT(344), (NT(345)));
//G478: cli_command(266)     => mnf_cmd(344).
	p(NT(266), (NT(344)));
//G479: snf_sym(349)         => 's' 'n' 'f'.
	p(NT(349), (T(36)+T(44)+T(42)));
//G480: __E_cli_command_142(348) => snf_sym(349) __(72) nf_cmd_arg(331).
	p(NT(348), (NT(349)+NT(72)+NT(331)));
//G481: snf_cmd(347)         => __E_cli_command_142(348).
	p(NT(347), (NT(348)));
//G482: cli_command(266)     => snf_cmd(347).
	p(NT(266), (NT(347)));
//G483: onf_sym(352)         => 'o' 'n' 'f'.
	p(NT(352), (T(15)+T(44)+T(42)));
//G484: __E_cli_command_143(351) => onf_sym(352) __(72) variable(163) __(72) onf_cmd_arg(353).
	p(NT(351), (NT(352)+NT(72)+NT(163)+NT(72)+NT(353)));
//G485: onf_cmd(350)         => __E_cli_command_143(351).
	p(NT(350), (NT(351)));
//G486: cli_command(266)     => onf_cmd(350).
	p(NT(266), (NT(350)));
//G487: def_sym(356)         => 'd' 'e' 'f'.
	p(NT(356), (T(41)+T(19)+T(42)));
//G488: __E_cli_command_144(355) => def_sym(356).
	p(NT(355), (NT(356)));
//G489: def_list_cmd(354)    => __E_cli_command_144(355).
	p(NT(354), (NT(355)));
//G490: cli_command(266)     => def_list_cmd(354).
	p(NT(266), (NT(354)));
//G491: __E_cli_command_145(358) => def_sym(356) __(72) gssotc_rec_relation_form(24).
	p(NT(358), (NT(356)+NT(72)+NT(24)));
//G492: def_rr_cmd(357)      => __E_cli_command_145(358).
	p(NT(357), (NT(358)));
//G493: cli_command(266)     => def_rr_cmd(357).
	p(NT(266), (NT(357)));
//G494: __E___E_cli_command_146_147(362) => 'd'.
	p(NT(362), (T(41)));
//G495: __E___E_cli_command_146_147(362) => 'd' 'e' 'l'.
	p(NT(362), (T(41)+T(19)+T(16)));
//G496: __E___E_cli_command_146_147(362) => 'd' 'e' 'l' 'e' 't' 'e'.
	p(NT(362), (T(41)+T(19)+T(16)+T(19)+T(32)+T(19)));
//G497: del_sym(361)         => __E___E_cli_command_146_147(362).
	p(NT(361), (NT(362)));
//G498: __E_cli_command_146(360) => def_sym(356) __(72) del_sym(361) __(72) memory(363).
	p(NT(360), (NT(356)+NT(72)+NT(361)+NT(72)+NT(363)));
//G499: def_del_cmd(359)     => __E_cli_command_146(360).
	p(NT(359), (NT(360)));
//G500: cli_command(266)     => def_del_cmd(359).
	p(NT(266), (NT(359)));
//G501: __E_cli_command_148(365) => def_sym(356) __(72) clear_sym(276).
	p(NT(365), (NT(356)+NT(72)+NT(276)));
//G502: def_clear_cmd(364)   => __E_cli_command_148(365).
	p(NT(364), (NT(365)));
//G503: cli_command(266)     => def_clear_cmd(364).
	p(NT(266), (NT(364)));
//G504: __E_cli_command_149(367) => def_sym(356) __(72) memory(363).
	p(NT(367), (NT(356)+NT(72)+NT(363)));
//G505: def_print_cmd(366)   => __E_cli_command_149(367).
	p(NT(366), (NT(367)));
//G506: cli_command(266)     => def_print_cmd(366).
	p(NT(266), (NT(366)));
//G507: __E___E_cli_command_150_151(371) => 'm'.
	p(NT(371), (T(47)));
//G508: __E___E_cli_command_150_151(371) => 'm' 'e' 'm'.
	p(NT(371), (T(47)+T(19)+T(47)));
//G509: __E___E_cli_command_150_151(371) => 'm' 'e' 'm' 'o' 'r' 'y'.
	p(NT(371), (T(47)+T(19)+T(47)+T(15)+T(40)+T(56)));
//G510: memory_sym(370)      => __E___E_cli_command_150_151(371).
	p(NT(370), (NT(371)));
//G511: __E_cli_command_150(369) => memory_sym(370).
	p(NT(369), (NT(370)));
//G512: memory_list_cmd(368) => __E_cli_command_150(369).
	p(NT(368), (NT(369)));
//G513: cli_command(266)     => memory_list_cmd(368).
	p(NT(266), (NT(368)));
//G514: __E_cli_command_152(373) => memory_sym(370) __(72) del_sym(361) __(72) memory(363).
	p(NT(373), (NT(370)+NT(72)+NT(361)+NT(72)+NT(363)));
//G515: memory_del_cmd(372)  => __E_cli_command_152(373).
	p(NT(372), (NT(373)));
//G516: cli_command(266)     => memory_del_cmd(372).
	p(NT(266), (NT(372)));
//G517: __E_cli_command_153(375) => memory_sym(370) __(72) clear_sym(276).
	p(NT(375), (NT(370)+NT(72)+NT(276)));
//G518: memory_clear_cmd(374) => __E_cli_command_153(375).
	p(NT(374), (NT(375)));
//G519: cli_command(266)     => memory_clear_cmd(374).
	p(NT(266), (NT(374)));
//G520: __E_cli_command_154(377) => memory_sym(370) __(72) memory(363).
	p(NT(377), (NT(370)+NT(72)+NT(363)));
//G521: memory_print_cmd(376) => __E_cli_command_154(377).
	p(NT(376), (NT(377)));
//G522: cli_command(266)     => memory_print_cmd(376).
	p(NT(266), (NT(376)));
//G523: __E___E_cli_command_155_156(381) => bf(41).
	p(NT(381), (NT(41)));
//G524: __E___E_cli_command_155_156(381) => wff(32).
	p(NT(381), (NT(32)));
//G525: __E___E_cli_command_155_156(381) => tau(20).
	p(NT(381), (NT(20)));
//G526: memory_store_cmd_arg(380) => __E___E_cli_command_155_156(381).
	p(NT(380), (NT(381)));
//G527: __E_cli_command_155(379) => memory_sym(370) __(72) memory_store_cmd_arg(380).
	p(NT(379), (NT(370)+NT(72)+NT(380)));
//G528: memory_store_cmd(378) => __E_cli_command_155(379).
	p(NT(378), (NT(379)));
//G529: cli_command(266)     => memory_store_cmd(378).
	p(NT(266), (NT(378)));
//G530: qelim_sym(384)       => 'q' 'e' 'l' 'i' 'm'.
	p(NT(384), (T(43)+T(19)+T(16)+T(37)+T(47)));
//G531: __E_cli_command_157(383) => qelim_sym(384) __(72) wff_cmd_arg(301).
	p(NT(383), (NT(384)+NT(72)+NT(301)));
//G532: qelim_cmd(382)       => __E_cli_command_157(383).
	p(NT(382), (NT(383)));
//G533: cli_command(266)     => qelim_cmd(382).
	p(NT(266), (NT(382)));
//G534: get_sym(387)         => 'g' 'e' 't'.
	p(NT(387), (T(46)+T(19)+T(32)));
//G535: __E___E_cli_command_158_159(388) => __(72) option(389).
	p(NT(388), (NT(72)+NT(389)));
//G536: __E___E_cli_command_158_159(388) => null.
	p(NT(388), (nul));
//G537: __E_cli_command_158(386) => get_sym(387) __E___E_cli_command_158_159(388).
	p(NT(386), (NT(387)+NT(388)));
//G538: get_cmd(385)         => __E_cli_command_158(386).
	p(NT(385), (NT(386)));
//G539: cli_command(266)     => get_cmd(385).
	p(NT(266), (NT(385)));
//G540: set_sym(392)         => 's' 'e' 't'.
	p(NT(392), (T(36)+T(19)+T(32)));
//G541: __E___E_cli_command_160_161(393) => __(72).
	p(NT(393), (NT(72)));
//G542: __E___E_cli_command_160_161(393) => _(16) '=' _(16).
	p(NT(393), (NT(16)+T(4)+NT(16)));
//G543: __E_cli_command_160(391) => set_sym(392) __(72) option(389) __E___E_cli_command_160_161(393) option_value(394).
	p(NT(391), (NT(392)+NT(72)+NT(389)+NT(393)+NT(394)));
//G544: set_cmd(390)         => __E_cli_command_160(391).
	p(NT(390), (NT(391)));
//G545: cli_command(266)     => set_cmd(390).
	p(NT(266), (NT(390)));
//G546: toggle_sym(397)      => 't' 'o' 'g' 'g' 'l' 'e'.
	p(NT(397), (T(32)+T(15)+T(46)+T(46)+T(16)+T(19)));
//G547: __E_cli_command_162(396) => toggle_sym(397) __(72) bool_option(398).
	p(NT(396), (NT(397)+NT(72)+NT(398)));
//G548: toggle_cmd(395)      => __E_cli_command_162(396).
	p(NT(395), (NT(396)));
//G549: cli_command(266)     => toggle_cmd(395).
	p(NT(266), (NT(395)));
//G550: bf_cmd_arg(324)      => memory(363).
	p(NT(324), (NT(363)));
//G551: bf_cmd_arg(324)      => bf_selection(399).
	p(NT(324), (NT(399)));
//G552: bf_cmd_arg(324)      => bf(41).
	p(NT(324), (NT(41)));
//G553: bf_cmd_out_arg(325)  => memory(363).
	p(NT(325), (NT(363)));
//G554: bf_cmd_out_arg(325)  => bf_selection(399).
	p(NT(325), (NT(399)));
//G555: wff_cmd_arg(301)     => memory(363).
	p(NT(301), (NT(363)));
//G556: wff_cmd_arg(301)     => wff_selection(400).
	p(NT(301), (NT(400)));
//G557: wff_cmd_arg(301)     => wff(32).
	p(NT(301), (NT(32)));
//G558: wff_cmd_out_arg(317) => memory(363).
	p(NT(317), (NT(363)));
//G559: wff_cmd_out_arg(317) => wff_selection(400).
	p(NT(317), (NT(400)));
//G560: nf_cmd_arg(331)      => memory(363).
	p(NT(331), (NT(363)));
//G561: nf_cmd_arg(331)      => bf(41).
	p(NT(331), (NT(41)));
//G562: nf_cmd_arg(331)      => wff(32).
	p(NT(331), (NT(32)));
//G563: onf_cmd_arg(353)     => memory(363).
	p(NT(353), (NT(363)));
//G564: onf_cmd_arg(353)     => wff(32).
	p(NT(353), (NT(32)));
//G565: normalize_cmd_arg(312) => memory(363).
	p(NT(312), (NT(363)));
//G566: normalize_cmd_arg(312) => bf(41).
	p(NT(312), (NT(41)));
//G567: normalize_cmd_arg(312) => wff(32).
	p(NT(312), (NT(32)));
//G568: normalize_cmd_arg(312) => nso_rr(14).
	p(NT(312), (NT(14)));
//G569: help_arg(283)        => help_sym(280).
	p(NT(283), (NT(280)));
//G570: help_arg(283)        => version_sym(273).
	p(NT(283), (NT(273)));
//G571: help_arg(283)        => quit_sym(270).
	p(NT(283), (NT(270)));
//G572: help_arg(283)        => clear_sym(276).
	p(NT(283), (NT(276)));
//G573: help_arg(283)        => get_sym(387).
	p(NT(283), (NT(387)));
//G574: help_arg(283)        => set_sym(392).
	p(NT(283), (NT(392)));
//G575: help_arg(283)        => toggle_sym(397).
	p(NT(283), (NT(397)));
//G576: help_arg(283)        => file_sym(286).
	p(NT(283), (NT(286)));
//G577: help_arg(283)        => memory_sym(370).
	p(NT(283), (NT(370)));
//G578: help_arg(283)        => abs_memory_sym(401).
	p(NT(283), (NT(401)));
//G579: help_arg(283)        => rel_memory_sym(402).
	p(NT(283), (NT(402)));
//G580: help_arg(283)        => selection_sym(403).
	p(NT(283), (NT(403)));
//G581: help_arg(283)        => def_sym(356).
	p(NT(283), (NT(356)));
//G582: help_arg(283)        => inst_sym(315).
	p(NT(283), (NT(315)));
//G583: help_arg(283)        => subst_sym(320).
	p(NT(283), (NT(320)));
//G584: help_arg(283)        => normalize_sym(310).
	p(NT(283), (NT(310)));
//G585: help_arg(283)        => execute_sym(304).
	p(NT(283), (NT(304)));
//G586: help_arg(283)        => solve_sym(299).
	p(NT(283), (NT(299)));
//G587: help_arg(283)        => valid_sym(290).
	p(NT(283), (NT(290)));
//G588: help_arg(283)        => sat_sym(293).
	p(NT(283), (NT(293)));
//G589: help_arg(283)        => unsat_sym(296).
	p(NT(283), (NT(296)));
//G590: help_arg(283)        => dnf_sym(330).
	p(NT(283), (NT(330)));
//G591: help_arg(283)        => cnf_sym(334).
	p(NT(283), (NT(334)));
//G592: help_arg(283)        => anf_sym(337).
	p(NT(283), (NT(337)));
//G593: help_arg(283)        => snf_sym(349).
	p(NT(283), (NT(349)));
//G594: help_arg(283)        => nnf_sym(340).
	p(NT(283), (NT(340)));
//G595: help_arg(283)        => pnf_sym(343).
	p(NT(283), (NT(343)));
//G596: help_arg(283)        => mnf_sym(346).
	p(NT(283), (NT(346)));
//G597: help_arg(283)        => onf_sym(352).
	p(NT(283), (NT(352)));
//G598: help_arg(283)        => qelim_sym(384).
	p(NT(283), (NT(384)));
//G599: __E___E_help_arg_163_164(406) => 's'.
	p(NT(406), (T(36)));
//G600: __E___E_help_arg_163_164(406) => null.
	p(NT(406), (nul));
//G601: __E_help_arg_163(405) => 'e' 'x' 'a' 'm' 'p' 'l' 'e' __E___E_help_arg_163_164(406).
	p(NT(405), (T(19)+T(20)+T(18)+T(47)+T(35)+T(16)+T(19)+NT(406)));
//G602: examples_sym(404)    => __E_help_arg_163(405).
	p(NT(404), (NT(405)));
//G603: help_arg(283)        => examples_sym(404).
	p(NT(283), (NT(404)));
//G604: rel_memory_sym(402)  => '%'.
	p(NT(402), (T(57)));
//G605: memory_id(410)       => digits(242).
	p(NT(410), (NT(242)));
//G606: __E___E_memory_165_166(409) => memory_id(410).
	p(NT(409), (NT(410)));
//G607: __E___E_memory_165_166(409) => null.
	p(NT(409), (nul));
//G608: __E_memory_165(408)  => rel_memory_sym(402) __E___E_memory_165_166(409).
	p(NT(408), (NT(402)+NT(409)));
//G609: rel_memory(407)      => __E_memory_165(408).
	p(NT(407), (NT(408)));
//G610: memory(363)          => rel_memory(407).
	p(NT(363), (NT(407)));
//G611: abs_memory_sym(401)  => '%' '-'.
	p(NT(401), (T(57)+T(21)));
//G612: __E___E_memory_167_168(413) => abs_memory_sym(401).
	p(NT(413), (NT(401)));
//G613: __E___E_memory_167_168(413) => memory_sym(370) __(72).
	p(NT(413), (NT(370)+NT(72)));
//G614: __E_memory_167(412)  => __E___E_memory_167_168(413) memory_id(410).
	p(NT(412), (NT(413)+NT(410)));
//G615: abs_memory(411)      => __E_memory_167(412).
	p(NT(411), (NT(412)));
//G616: memory(363)          => abs_memory(411).
	p(NT(363), (NT(411)));
//G617: selection_sym(403)   => 's'.
	p(NT(403), (T(36)));
//G618: selection_sym(403)   => 's' 'e' 'l' 'e' 'c' 't' 'i' 'o' 'n'.
	p(NT(403), (T(36)+T(19)+T(16)+T(19)+T(34)+T(32)+T(37)+T(15)+T(44)));
//G619: wff_selection(400)   => selection_sym(403) __(72) digits(242).
	p(NT(400), (NT(403)+NT(72)+NT(242)));
//G620: bf_selection(399)    => selection_sym(403) __(72) digits(242).
	p(NT(399), (NT(403)+NT(72)+NT(242)));
//G621: bf_var_selection(414) => selection_sym(403) __(72) digits(242).
	p(NT(414), (NT(403)+NT(72)+NT(242)));
//G622: wff_var_selection(415) => selection_sym(403) __(72) digits(242).
	p(NT(415), (NT(403)+NT(72)+NT(242)));
//G623: option(389)          => bool_option(398).
	p(NT(389), (NT(398)));
//G624: __E_option_169(418)  => 's' 'e' 'v'.
	p(NT(418), (T(36)+T(19)+T(38)));
//G625: __E_option_169(418)  => 's' 'e' 'v' 'e' 'r' 'i' 't' 'y'.
	p(NT(418), (T(36)+T(19)+T(38)+T(19)+T(40)+T(37)+T(32)+T(56)));
//G626: severity_opt(417)    => __E_option_169(418).
	p(NT(417), (NT(418)));
//G627: enum_option(416)     => severity_opt(417).
	p(NT(416), (NT(417)));
//G628: option(389)          => enum_option(416).
	p(NT(389), (NT(416)));
//G629: __E_bool_option_170(420) => 's'.
	p(NT(420), (T(36)));
//G630: __E_bool_option_170(420) => 's' 't' 'a' 't' 'u' 's'.
	p(NT(420), (T(36)+T(32)+T(18)+T(32)+T(33)+T(36)));
//G631: status_opt(419)      => __E_bool_option_170(420).
	p(NT(419), (NT(420)));
//G632: bool_option(398)     => status_opt(419).
	p(NT(398), (NT(419)));
//G633: __E_bool_option_171(422) => 'c'.
	p(NT(422), (T(34)));
//G634: __E_bool_option_171(422) => 'c' 'o' 'l' 'o' 'r'.
	p(NT(422), (T(34)+T(15)+T(16)+T(15)+T(40)));
//G635: __E_bool_option_171(422) => 'c' 'o' 'l' 'o' 'r' 's'.
	p(NT(422), (T(34)+T(15)+T(16)+T(15)+T(40)+T(36)));
//G636: colors_opt(421)      => __E_bool_option_171(422).
	p(NT(421), (NT(422)));
//G637: bool_option(398)     => colors_opt(421).
	p(NT(398), (NT(421)));
//G638: __E_bool_option_172(424) => 'd'.
	p(NT(424), (T(41)));
//G639: __E_bool_option_172(424) => 'd' 'b' 'g'.
	p(NT(424), (T(41)+T(14)+T(46)));
//G640: __E_bool_option_172(424) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(424), (T(41)+T(19)+T(14)+T(33)+T(46)));
//G641: debug_repl_opt(423)  => __E_bool_option_172(424).
	p(NT(423), (NT(424)));
//G642: bool_option(398)     => debug_repl_opt(423).
	p(NT(398), (NT(423)));
//G643: option_value(394)    => option_value_true(425).
	p(NT(394), (NT(425)));
//G644: option_value(394)    => option_value_false(426).
	p(NT(394), (NT(426)));
//G645: option_value(394)    => severity(427).
	p(NT(394), (NT(427)));
//G646: option_value_true(425) => 't'.
	p(NT(425), (T(32)));
//G647: option_value_true(425) => 't' 'r' 'u' 'e'.
	p(NT(425), (T(32)+T(40)+T(33)+T(19)));
//G648: option_value_true(425) => 'o' 'n'.
	p(NT(425), (T(15)+T(44)));
//G649: option_value_true(425) => '1'.
	p(NT(425), (T(29)));
//G650: option_value_true(425) => 'y'.
	p(NT(425), (T(56)));
//G651: option_value_true(425) => 'y' 'e' 's'.
	p(NT(425), (T(56)+T(19)+T(36)));
//G652: option_value_false(426) => 'f'.
	p(NT(426), (T(42)));
//G653: option_value_false(426) => 'f' 'a' 'l' 's' 'e'.
	p(NT(426), (T(42)+T(18)+T(16)+T(36)+T(19)));
//G654: option_value_false(426) => 'o' 'f' 'f'.
	p(NT(426), (T(15)+T(42)+T(42)));
//G655: option_value_false(426) => '0'.
	p(NT(426), (T(30)));
//G656: option_value_false(426) => 'n'.
	p(NT(426), (T(44)));
//G657: option_value_false(426) => 'n' 'o'.
	p(NT(426), (T(44)+T(15)));
//G658: __E_severity_173(429) => 'e'.
	p(NT(429), (T(19)));
//G659: __E_severity_173(429) => 'e' 'r' 'r' 'o' 'r'.
	p(NT(429), (T(19)+T(40)+T(40)+T(15)+T(40)));
//G660: error_sym(428)       => __E_severity_173(429).
	p(NT(428), (NT(429)));
//G661: severity(427)        => error_sym(428).
	p(NT(427), (NT(428)));
//G662: __E_severity_174(431) => 'i'.
	p(NT(431), (T(37)));
//G663: __E_severity_174(431) => 'i' 'n' 'f' 'o'.
	p(NT(431), (T(37)+T(44)+T(42)+T(15)));
//G664: info_sym(430)        => __E_severity_174(431).
	p(NT(430), (NT(431)));
//G665: severity(427)        => info_sym(430).
	p(NT(427), (NT(430)));
//G666: __E_severity_175(433) => 'd'.
	p(NT(433), (T(41)));
//G667: __E_severity_175(433) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(433), (T(41)+T(19)+T(14)+T(33)+T(46)));
//G668: debug_sym(432)       => __E_severity_175(433).
	p(NT(432), (NT(433)));
//G669: severity(427)        => debug_sym(432).
	p(NT(427), (NT(432)));
//G670: __E_severity_176(435) => 't'.
	p(NT(435), (T(32)));
//G671: __E_severity_176(435) => 't' 'r' 'a' 'c' 'e'.
	p(NT(435), (T(32)+T(40)+T(18)+T(34)+T(19)));
//G672: trace_sym(434)       => __E_severity_176(435).
	p(NT(434), (NT(435)));
//G673: severity(427)        => trace_sym(434).
	p(NT(427), (NT(434)));
	#undef T
	#undef NT
