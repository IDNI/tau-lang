...
struct tau_parser {
	...
	enum nonterminal {
		...
		_Rshift_10, var, in, out, in_var_name, out_var_name, bool_variable, capture_var, tau_rule, tau_matcher, 
		tau_body, tau, tau_collapse_positives_cb, tau_positives_upwards_cb, tau_rec_relation, tau_and, tau_neg, tau_or, tau_wff, _Rtau_rec_relation_11, 
		tau_ref, tau_ref_args, _Rtau_ref_args_12, _Rtau_ref_args_13, _Rtau_ref_args_14, tau_and_sym, tau_or_sym, tau_neg_sym, wff, wff_rule, 
		...
		wff_f, wff_ball, wff_bex, bf_eq, bf_neq, bf_less, bf_less_equal, bf_greater, _Rwff_rec_relation_15, wff_ref, 
		wff_ref_args, _Rwff_ref_args_16, _Rwff_ref_args_17, _Rwff_ref_args_18, wff_and_sym, wff_or_sym, wff_xor_sym, wff_conditional_sym, wff_neg_sym, wff_imply_sym, 
		wff_equiv_sym, wff_all_sym, _Rwff_all_19, wff_ex_sym, _Rwff_ex_20, wff_ball_sym, _Rwff_ball_21, wff_bex_sym, _Rwff_bex_22, bf, 
		...
		bf_and, bf_neg, bf_xor, bf_or, bf_all, bf_ex, bf_t, bf_f, bf_rec_relation, _Rbf_rec_relation_23, 
		bf_ref_args, _Rbf_ref_args_24, _Rbf_ref_args_25, _Rbf_ref_args_26, bf_and_sym, bf_or_sym, bf_xor_sym, bf_neg_sym, bf_all_sym, _Rbf_all_27, 
		bf_ex_sym, _Rbf_ex_28, constant, binding, source_binding, named_binding, type, source, source0, _Rsource_29, 
		_Rsource_30, bf_and_cb_sym, bf_cb_arg, bf_or_cb_sym, bf_xor_cb_sym, bf_neg_cb_sym, bf_eq_cb_sym, wff_cb_arg, bf_neq_cb_sym, bf_is_zero_cb_sym, 
		...
		tau_collapse_positives_cb_sym, tau_cb_arg, _Rtau_collapse_positives_cb_31, _Rtau_collapse_positives_cb_32, tau_positives_upwards_cb_sym, inputs, input, _Rinputs_33, _Rinputs_34, builder, 
		builder_head, builder_body, _Rbuilder_head_35, _Rbuilder_head_36, bf_builder_body, wff_builder_body, tau_builder_body, library, rules, rule, 
		_Rrules_37, _Rrules_38, nso_rr, nso_rec_relations, nso_main, nso_rec_relation, _Rnso_rec_relations_39, _Rnso_rec_relations_40, gssotc_rr, gssotc_rec_relations, 
		gssotc_main, gssotc_rec_relation, _Rgssotc_rec_relations_41, _Rgssotc_rec_relations_42, start, _Rstart_43, __neg_0, __neg_1, __neg_2, __neg_3, 
...
private:
	...
	idni::prods<char_type, terminal_type> load_prods() {
		...
		// __neg_6 => io_var.
		q(nt(252), (nt(59)));
		// offset => variable & ~( __neg_6 ).
		q(nt(52), (nt(58)) & ~(nt(252)));
		// _Rshift_10 => capture.
		q(nt(60), (nt(56)));
		// __neg_7 => io_var.
		q(nt(253), (nt(59)));
		// _Rshift_10 => variable & ~( __neg_7 ).
		q(nt(60), (nt(58)) & ~(nt(253)));
		// shift => _Rshift_10 ws minus ws num.
		q(nt(57), (nt(60)+nt(14)+nt(45)+nt(14)+nt(55)));
		// num => digits.
		q(nt(55), (nt(33)));
		// variable => io_var.
		q(nt(58), (nt(59)));
		...
		// __neg_12 => tau_wff.
		q(nt(258), (nt(78)));
		// _Rtau_rec_relation_11 => ~( __neg_8 ) & tau & ~( __neg_9 ) & ~( __neg_10 ) & ~( __neg_11 ) & ~( __neg_12 ).
		q(nt(79), ~(nt(254)) & (nt(71)) & ~(nt(255)) & ~(nt(256)) & ~(nt(257)) & ~(nt(258)));
		// tau_rec_relation => _Rtau_rec_relation_11 ws tau_def ws tau ws dot.
		...
		// _Rtau_ref_args_12 => capture.
		q(nt(82), (nt(56)));
		// _Rtau_ref_args_12 => variable.
		q(nt(82), (nt(58)));
		// _Rtau_ref_args_13 => _Rtau_ref_args_12.
		q(nt(83), (nt(82)));
		// _Rtau_ref_args_14 => null.
		q(nt(84), (nul));
		// _Rtau_ref_args_14 => _Rtau_ref_args_13 _Rtau_ref_args_14.
		q(nt(84), (nt(83)+nt(84)));
		// tau_ref_args => open_parenthesis ws _Rtau_ref_args_14 ws close_parenthesis.
		...
		// __neg_32 => bf_greater.
		q(nt(278), (nt(117)));
		// _Rwff_rec_relation_15 => ~( __neg_13 ) & ~( __neg_14 ) & wff & ~( __neg_15 ) & ~( __neg_16 ) & ~( __neg_17 ) & ~( __neg_18 ) & ~( __neg_19 ) & ~( __neg_20 ) & ~( __neg_21 ) & ~( __neg_22 ) & ~( __neg_23 ) & ~( __neg_24 ) & ~( __neg_25 ) & ~( __neg_26 ) & ~( __neg_27 ) & ~( __neg_28 ) & ~( __neg_29 ) & ~( __neg_30 ) & ~( __neg_31 ) & ~( __neg_32 ).
		q(nt(118), ~(nt(259)) & ~(nt(260)) & (nt(88)) & ~(nt(261)) & ~(nt(262)) & ~(nt(263)) & ~(nt(264)) & ~(nt(265)) & ~(nt(266)) & ~(nt(267)) & ~(nt(268)) & ~(nt(269)) & ~(nt(270)) & ~(nt(271)) & ~(nt(272)) & ~(nt(273)) & ~(nt(274)) & ~(nt(275)) & ~(nt(276)) & ~(nt(277)) & ~(nt(278)));
		// wff_rec_relation => _Rwff_rec_relation_15 ws wff_def ws wff ws dot.
		...
		// _Rwff_ref_args_16 => capture.
		q(nt(121), (nt(56)));
		// _Rwff_ref_args_16 => variable.
		q(nt(121), (nt(58)));
		// _Rwff_ref_args_17 => _Rwff_ref_args_16.
		q(nt(122), (nt(121)));
		// _Rwff_ref_args_18 => null.
		q(nt(123), (nul));
		// _Rwff_ref_args_18 => _Rwff_ref_args_17 _Rwff_ref_args_18.
		q(nt(123), (nt(122)+nt(123)));
		// wff_ref_args => open_parenthesis ws _Rwff_ref_args_18 ws close_parenthesis.
		...
		// _Rwff_all_19 => capture.
		q(nt(132), (nt(56)));
		// _Rwff_all_19 => variable.
		q(nt(132), (nt(58)));
		// wff_all => wff_all_sym ws_required _Rwff_all_19 ws_required wff.
		q(nt(105), (nt(131)+nt(13)+nt(132)+nt(13)+nt(88)));
		// _Rwff_ex_20 => capture.
		q(nt(134), (nt(56)));
		// _Rwff_ex_20 => variable.
		q(nt(134), (nt(58)));
		// wff_ex => wff_ex_sym ws_required _Rwff_ex_20 ws_required wff.
		q(nt(106), (nt(133)+nt(13)+nt(134)+nt(13)+nt(88)));
		// _Rwff_ball_21 => capture.
		q(nt(136), (nt(56)));
		// _Rwff_ball_21 => bool_variable.
		q(nt(136), (nt(66)));
		// wff_ball => wff_ball_sym ws_required _Rwff_ball_21 ws_required wff.
		q(nt(111), (nt(135)+nt(13)+nt(136)+nt(13)+nt(88)));
		// _Rwff_bex_22 => capture.
		q(nt(138), (nt(56)));
		// _Rwff_bex_22 => bool_variable.
		q(nt(138), (nt(66)));
		// wff_bex => wff_bex_sym ws_required _Rwff_bex_22 ws_required wff.
		...
		// __neg_45 => bf_f.
		q(nt(291), (nt(167)));
		// _Rbf_rec_relation_23 => ~( __neg_33 ) & ~( __neg_34 ) & ~( __neg_35 ) & ~( __neg_36 ) & bf & ~( __neg_37 ) & ~( __neg_38 ) & ~( __neg_39 ) & ~( __neg_40 ) & ~( __neg_41 ) & ~( __neg_42 ) & ~( __neg_43 ) & ~( __neg_44 ) & ~( __neg_45 ).
		q(nt(169), ~(nt(279)) & ~(nt(280)) & ~(nt(281)) & ~(nt(282)) & (nt(139)) & ~(nt(283)) & ~(nt(284)) & ~(nt(285)) & ~(nt(286)) & ~(nt(287)) & ~(nt(288)) & ~(nt(289)) & ~(nt(290)) & ~(nt(291)));
		// bf_rec_relation => _Rbf_rec_relation_23 ws bf_def ws bf ws dot.
		q(nt(168), (nt(169)+nt(14)+nt(35)+nt(14)+nt(139)+nt(14)+nt(38)));
		// bf_ref => sym offsets bf_ref_args.
		q(nt(158), (nt(50)+nt(51)+nt(170)));
		// _Rbf_ref_args_24 => capture.
		q(nt(171), (nt(56)));
		// _Rbf_ref_args_24 => variable.
		q(nt(171), (nt(58)));
		// _Rbf_ref_args_25 => _Rbf_ref_args_24.
		q(nt(172), (nt(171)));
		// _Rbf_ref_args_26 => null.
		q(nt(173), (nul));
		// _Rbf_ref_args_26 => _Rbf_ref_args_25 _Rbf_ref_args_26.
		q(nt(173), (nt(172)+nt(173)));
		// bf_ref_args => open_parenthesis ws _Rbf_ref_args_26 ws close_parenthesis.
		...
		// _Rbf_all_27 => capture.
		q(nt(179), (nt(56)));
		// _Rbf_all_27 => variable.
		q(nt(179), (nt(58)));
		// bf_all => bf_all_sym ws_required _Rbf_all_27 ws_required bf.
		q(nt(164), (nt(178)+nt(13)+nt(179)+nt(13)+nt(139)));
		// _Rbf_ex_28 => capture.
		q(nt(181), (nt(56)));
		// _Rbf_ex_28 => variable.
		q(nt(181), (nt(58)));
		// bf_ex => bf_ex_sym ws_required _Rbf_ex_28 ws_required bf.
		...
		// _Rsource_29 => source0.
		q(nt(189), (nt(188)));
		// _Rsource_30 => _Rsource_29.
		q(nt(190), (nt(189)));
		// _Rsource_30 => _Rsource_29 _Rsource_30.
		...
		// _Rtau_collapse_positives_cb_31 => tau_collapse_positives_cb_sym ws_required tau_cb_arg ws_required tau_cb_arg ws_required tau_cb_arg.
		q(nt(212), (nt(210)+nt(13)+nt(211)+nt(13)+nt(211)+nt(13)+nt(211)));
		// _Rtau_collapse_positives_cb_32 => tau_collapse_positives_cb_sym ws_required tau_cb_arg ws_required tau_cb_arg.
		q(nt(213), (nt(210)+nt(13)+nt(211)+nt(13)+nt(211)));
		// tau_collapse_positives_cb => _Rtau_collapse_positives_cb_31.
		q(nt(72), (nt(212)));
		// tau_collapse_positives_cb => _Rtau_collapse_positives_cb_32.
		q(nt(72), (nt(213)));
		...
		// _Rinputs_33 => ws input.
		q(nt(217), (nt(14)+nt(216)));
		// _Rinputs_34 => null.
		q(nt(218), (nul));
		// _Rinputs_34 => _Rinputs_33 _Rinputs_34.
		q(nt(218), (nt(217)+nt(218)));
		// inputs => ws less ws input _Rinputs_34 ws dot.
		...
		// _Rbuilder_head_35 => ws_required capture.
		q(nt(222), (nt(13)+nt(56)));
		// _Rbuilder_head_36 => null.
		q(nt(223), (nul));
		// _Rbuilder_head_36 => _Rbuilder_head_35 _Rbuilder_head_36.
		q(nt(223), (nt(222)+nt(223)));
		// builder_head => open_parenthesis ws capture _Rbuilder_head_36 ws close_parenthesis.
		...
		// _Rrules_38 => null.
		q(nt(231), (nul));
		// _Rrules_38 => _Rrules_37 _Rrules_38.
		...
		// _Rnso_rec_relations_39 => ws nso_rec_relation.
		q(nt(236), (nt(14)+nt(235)));
		// _Rnso_rec_relations_40 => null.
		q(nt(237), (nul));
		// _Rnso_rec_relations_40 => _Rnso_rec_relations_39 _Rnso_rec_relations_40.
		q(nt(237), (nt(236)+nt(237)));
		// nso_rec_relations => _Rnso_rec_relations_40.
		q(nt(233), (nt(237)));
		...
		// _Rgssotc_rec_relations_41 => ws gssotc_rec_relation.
		q(nt(242), (nt(14)+nt(241)));
		// _Rgssotc_rec_relations_42 => null.
		q(nt(243), (nul));
		// _Rgssotc_rec_relations_42 => _Rgssotc_rec_relations_41 _Rgssotc_rec_relations_42.
		q(nt(243), (nt(242)+nt(243)));
		// gssotc_rec_relations => _Rgssotc_rec_relations_42.
		q(nt(239), (nt(243)));
