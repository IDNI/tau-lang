...
// 					| wff_coimply | bf_eq_cb | bf_neq_cb | cbf_if
...
// bf_matcher		=> bf.
// bf				=> bf_constant | bf_and | bf_neg | bf_xor | bf_or | bf_imply 
// 					| bf_equiv | bf_coimply	| bf_all | bf_ex | variable | timed 
// 					| bf_less | bf_less_equal | bf_greater | bf_subs_cb
// 					| bf_xor_cb | bf_and_cb | bf_or_cb | bf_neg_cb | bf_less_cb 
// 					| bf_less_equal_cb | bf_greater_cb | bf_imply_cb 
...
// 					| bf_is_zero_cb | bf_is_one_cb | bf_subs_cb.
// T				=> ws 'T' ws.
// F				=> ws 'F' ws.
...
struct tau_parser {
   ...
   enum nonterminal {
			...
			bf_eq_cb, bf_neq_cb, cbf_if, T, F, cbf, wff_and_sym, wff_or_sym, wff_xor_sym, wff_neg_sym, 
			...
			bf_coimply_sym, bf_all_sym, _Rbf_all_16, bf_ex_sym, _Rbf_ex_17, constant, binding, source_binding, named_binding, type, 
			source, source0, _Rsource_18, _Rsource_19, bf_cb_arg, bf_and_cb_sym, bf_or_cb_sym, bf_xor_cb_sym, bf_neg_cb_sym, bf_less_cb_sym, 
			bf_less_equal_cb_sym, bf_greater_cb_sym, bf_imply_cb_sym, bf_equiv_cb_sym, bf_coimply_cb_sym, bf_subs_cb_sym, bf_eq_cb_sym, bf_neq_cb_sym, bf_is_zero_cb_sym, bf_is_one_cb_sym, 
			main, rule, rules, _Rrules_20, _Rrules_21, formula, library, start, 
   };
...
private:
	...
	idni::prods<char, char> load_prods() {
		...
		q(nt(65), (nt(83)));
		q(nt(65), (nt(84)));
		q(nt(69), (nt(38)+nt(85)+nt(35)+nt(84)+nt(39)));
		q(nt(70), (nt(38)+nt(85)+nt(36)+nt(84)+nt(39)));
		q(nt(71), (nt(38)+nt(65)+nt(86)+nt(65)+nt(39)));
		q(nt(74), (nt(38)+nt(65)+nt(87)+nt(65)+nt(39)));
		q(nt(73), (nt(38)+nt(65)+nt(88)+nt(65)+nt(39)));
		q(nt(72), (nt(89)+nt(65)));
		q(nt(77), (nt(38)+nt(65)+nt(90)+nt(65)+nt(39)));
		q(nt(78), (nt(38)+nt(65)+nt(91)+nt(65)+nt(39)));
		q(nt(79), (nt(38)+nt(65)+nt(92)+nt(65)+nt(39)));
		...
		q(nt(85), (nt(108)));
		q(nt(85), (nt(109)));
		q(nt(82), (nt(110)+nt(111)+nt(112)+nt(113)+nt(114)+nt(115)));
		q(nt(111), (nt(65)));
		q(nt(113), (nt(85)));
		q(nt(115), (nt(85)));
		...
		q(nt(162), (nt(50)));
		q(nt(162), (nt(51)));
		q(nt(133), (nt(161)+nt(12)+nt(162)+nt(12)+nt(102)));
		q(nt(164), (nt(50)));
		q(nt(164), (nt(51)));
		q(nt(134), (nt(163)+nt(12)+nt(164)+nt(12)+nt(102)));
		...
		q(nt(170), (nt(173)));
		q(nt(140), (nt(174)+nt(175)+nt(174)));
		q(nt(141), (nt(174)+nt(176)+nt(174)));
		q(nt(139), (nt(174)+nt(177)+nt(174)));
		q(nt(142), (nt(178)+nt(174)));
		q(nt(143), (nt(179)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(144), (nt(180)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(145), (nt(181)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(146), (nt(174)+nt(182)+nt(174)));
		q(nt(148), (nt(174)+nt(183)+nt(174)));
		q(nt(147), (nt(174)+nt(184)+nt(174)));
		q(nt(138), (nt(185)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(80), (nt(186)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(81), (nt(187)+nt(174)+nt(12)+nt(174)+nt(12)+nt(174)));
		q(nt(149), (nt(188)+nt(174)+nt(12)+nt(174)));
		q(nt(150), (nt(189)+nt(174)+nt(12)+nt(174)));
		q(nt(174), (nt(51)));
		q(nt(174), (nt(52)));
		q(nt(174), (nt(83)));
		q(nt(174), (nt(84)));
		...
		q(nt(188), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(28)+t(40)+t(48)+t(24)+t(20)+t(25)+t(40)+t(18)+t(16)+nt(13)));
		q(nt(189), (nt(13)+t(16)+t(26)+t(40)+t(22)+t(28)+t(40)+t(25)+t(12)+t(24)+t(40)+t(18)+t(16)+nt(13)));
