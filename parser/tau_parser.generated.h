...
inline std::vector<std::string> symbol_names{
	...
	"run_cmd", "__E_cli_command_106", "run_sym", "__E___E_cli_command_106_107", "__E___E_cli_command_106_108", "normalize_cmd", "__E_cli_command_109", "normalize_sym", "__E___E_cli_command_109_110", "subst_cmd", 
	"__E_cli_command_111", "subst_sym", "__E___E_cli_command_111_112", "nf_cmd_arg", "inst_cmd", "__E_cli_command_113", "inst_sym", "__E___E_cli_command_113_114", "inst_args", "dnf_cmd", 
	"__E_cli_command_115", "dnf_sym", "cnf_cmd", "__E_cli_command_116", "cnf_sym", "anf_cmd", "__E_cli_command_117", "anf_sym", "nnf_cmd", "__E_cli_command_118", 
	"nnf_sym", "pnf_cmd", "__E_cli_command_119", "pnf_sym", "mnf_cmd", "__E_cli_command_120", "mnf_sym", "snf_cmd", "__E_cli_command_121", "snf_sym", 
	"onf_cmd", "__E_cli_command_122", "onf_sym", "onf_cmd_arg", "def_list_cmd", "__E_cli_command_123", "def_sym", "__E___E_cli_command_123_124", "def_print_cmd", "__E_cli_command_125", 
	"number", "def_rr_cmd", "qelim_cmd", "__E_cli_command_126", "qelim_sym", "wff_cmd_arg", "get_cmd", "__E_cli_command_127", "get_sym", "__E___E_cli_command_127_128", 
	"option", "set_cmd", "__E_cli_command_129", "set_sym", "__E___E_cli_command_129_130", "option_value", "toggle_cmd", "__E_cli_command_131", "toggle_sym", "bool_option", 
	"def_input_cmd", "__E_cli_command_132", "input_stream", "def_output_cmd", "__E_cli_command_133", "output_stream", "history_list_cmd", "__E_cli_command_134", "history_sym", "__E___E_cli_command_134_135", 
	"history_print_cmd", "__E_cli_command_136", "memory", "history_store_cmd", "__E_cli_command_137", "__E_input_stream_138", "q_file_name", "console_sym", "__E_output_stream_139", "file_name", 
	"__E_file_name_140", "bf_cmd_arg", "abs_memory_sym", "rel_memory_sym", "selection_sym", "execute_sym", "examples_sym", "__E_help_arg_141", "__E___E_help_arg_141_142", "rel_memory", 
	"__E_memory_143", "__E___E_memory_143_144", "memory_id", "abs_memory", "__E_memory_145", "enum_option", "severity_opt", "__E_option_146", "status_opt", "__E_bool_option_147", 
	"colors_opt", "__E_bool_option_148", "hilighting_opt", "__E_bool_option_149", "indenting_opt", "__E_bool_option_150", "debug_repl_opt", "__E_bool_option_151", "option_value_true", "option_value_false", 
	"severity", "error_sym", "__E_severity_152", "info_sym", "__E_severity_153", "debug_sym", "__E_severity_154", "trace_sym", "__E_severity_155", "named_binding", 
...
//G177: __N_1(381)           => 'T'.
	p(NT(381), (T(28)));
//G178: __E_charvar_52(137)  => ~( __N_0(380) ) & ~( __N_1(381) ) & alpha(5).	 # conjunctive
...
//G213: offset(147)          => shift(157).
	p(NT(147), (NT(157)));
//G214: __N_2(382)           => io_var(139).
	p(NT(382), (NT(139)));
//G215: __E_offset_65(158)   => variable(106) & ~( __N_2(382) ).	 # conjunctive
	p(NT(158), (NT(106)) & ~(NT(382)));
//G216: offset(147)          => __E_offset_65(158).
	p(NT(147), (NT(158)));
//G217: __E_shift_66(159)    => capture(20).
	p(NT(159), (NT(20)));
//G218: __N_3(383)           => io_var(139).
	p(NT(383), (NT(139)));
//G219: __E___E_shift_66_67(160) => variable(106) & ~( __N_3(383) ).	 # conjunctive
...
//G246: __N_5(385)           => '}'.
	p(NT(385), (T(37)));
//G247: src_c(173)           => ~( __N_4(384) ) & ~( __N_5(385) ) & punct(7).	 # conjunctive
...
//G358: run_sym(252)         => __E___E_cli_command_106_107(253).
	p(NT(252), (NT(253)));
//G359: __E___E_cli_command_106_108(254) => __(52) num(125).
	p(NT(254), (NT(52)+NT(125)));
//G360: __E___E_cli_command_106_108(254) => null.
	p(NT(254), (nul));
//G361: __E_cli_command_106(251) => run_sym(252) __(52) wff(14) __E___E_cli_command_106_108(254).
	p(NT(251), (NT(252)+NT(52)+NT(14)+NT(254)));
//G362: run_cmd(250)         => __E_cli_command_106(251).
	p(NT(250), (NT(251)));
//G363: cli_command(213)     => run_cmd(250).
	p(NT(213), (NT(250)));
//G364: __E___E_cli_command_109_110(258) => 'n'.
	p(NT(258), (T(46)));
//G365: __E___E_cli_command_109_110(258) => 'n' 'o' 'r' 'm' 'a' 'l' 'i' 'z' 'e'.
	p(NT(258), (T(46)+T(8)+T(50)+T(9)+T(15)+T(16)+T(12)+T(52)+T(10)));
//G366: normalize_sym(257)   => __E___E_cli_command_109_110(258).
	p(NT(257), (NT(258)));
//G367: __E_cli_command_109(256) => normalize_sym(257) __(52) normalize_cmd_arg(241).
	p(NT(256), (NT(257)+NT(52)+NT(241)));
//G368: normalize_cmd(255)   => __E_cli_command_109(256).
	p(NT(255), (NT(256)));
//G369: cli_command(213)     => normalize_cmd(255).
	p(NT(213), (NT(255)));
//G370: __E___E_cli_command_111_112(262) => 's'.
	p(NT(262), (T(7)));
//G371: __E___E_cli_command_111_112(262) => 's' 'u' 'b' 's' 't'.
	p(NT(262), (T(7)+T(48)+T(49)+T(7)+T(11)));
//G372: __E___E_cli_command_111_112(262) => 's' 'u' 'b' 's' 't' 'i' 't' 'u' 't' 'e'.
	p(NT(262), (T(7)+T(48)+T(49)+T(7)+T(11)+T(12)+T(11)+T(48)+T(11)+T(10)));
//G373: subst_sym(261)       => __E___E_cli_command_111_112(262).
	p(NT(261), (NT(262)));
//G374: __E_cli_command_111(260) => subst_sym(261) __(52) nf_cmd_arg(263) _(11) '[' _(11) nf_cmd_arg(263) _(11) '/' _(11) nf_cmd_arg(263) _(11) ']'.
	p(NT(260), (NT(261)+NT(52)+NT(263)+NT(11)+T(19)+NT(11)+NT(263)+NT(11)+T(56)+NT(11)+NT(263)+NT(11)+T(20)));
//G375: subst_cmd(259)       => __E_cli_command_111(260).
	p(NT(259), (NT(260)));
//G376: cli_command(213)     => subst_cmd(259).
	p(NT(213), (NT(259)));
//G377: __E___E_cli_command_113_114(267) => 'i'.
	p(NT(267), (T(12)));
//G378: __E___E_cli_command_113_114(267) => 'i' 'n' 's' 't'.
	p(NT(267), (T(12)+T(46)+T(7)+T(11)));
//G379: __E___E_cli_command_113_114(267) => 'i' 'n' 's' 't' 'a' 'n' 't' 'i' 'a' 't' 'e'.
	p(NT(267), (T(12)+T(46)+T(7)+T(11)+T(15)+T(46)+T(11)+T(12)+T(15)+T(11)+T(10)));
//G380: inst_sym(266)        => __E___E_cli_command_113_114(267).
	p(NT(266), (NT(267)));
//G381: __E_cli_command_113(265) => inst_sym(266) __(52) inst_args(268).
	p(NT(265), (NT(266)+NT(52)+NT(268)));
//G382: inst_cmd(264)        => __E_cli_command_113(265).
	p(NT(264), (NT(265)));
//G383: cli_command(213)     => inst_cmd(264).
	p(NT(213), (NT(264)));
//G384: dnf_sym(271)         => 'd' 'n' 'f'.
	p(NT(271), (T(55)+T(46)+T(42)));
//G385: __E_cli_command_115(270) => dnf_sym(271) __(52) nf_cmd_arg(263).
	p(NT(270), (NT(271)+NT(52)+NT(263)));
//G386: dnf_cmd(269)         => __E_cli_command_115(270).
	p(NT(269), (NT(270)));
//G387: cli_command(213)     => dnf_cmd(269).
	p(NT(213), (NT(269)));
//G388: cnf_sym(274)         => 'c' 'n' 'f'.
	p(NT(274), (T(45)+T(46)+T(42)));
//G389: __E_cli_command_116(273) => cnf_sym(274) __(52) nf_cmd_arg(263).
	p(NT(273), (NT(274)+NT(52)+NT(263)));
//G390: cnf_cmd(272)         => __E_cli_command_116(273).
	p(NT(272), (NT(273)));
//G391: cli_command(213)     => cnf_cmd(272).
	p(NT(213), (NT(272)));
//G392: anf_sym(277)         => 'a' 'n' 'f'.
	p(NT(277), (T(15)+T(46)+T(42)));
//G393: __E_cli_command_117(276) => anf_sym(277) __(52) nf_cmd_arg(263).
	p(NT(276), (NT(277)+NT(52)+NT(263)));
//G394: anf_cmd(275)         => __E_cli_command_117(276).
	p(NT(275), (NT(276)));
//G395: cli_command(213)     => anf_cmd(275).
	p(NT(213), (NT(275)));
//G396: nnf_sym(280)         => 'n' 'n' 'f'.
	p(NT(280), (T(46)+T(46)+T(42)));
//G397: __E_cli_command_118(279) => nnf_sym(280) __(52) nf_cmd_arg(263).
	p(NT(279), (NT(280)+NT(52)+NT(263)));
//G398: nnf_cmd(278)         => __E_cli_command_118(279).
	p(NT(278), (NT(279)));
//G399: cli_command(213)     => nnf_cmd(278).
	p(NT(213), (NT(278)));
//G400: pnf_sym(283)         => 'p' 'n' 'f'.
	p(NT(283), (T(54)+T(46)+T(42)));
//G401: __E_cli_command_119(282) => pnf_sym(283) __(52) nf_cmd_arg(263).
	p(NT(282), (NT(283)+NT(52)+NT(263)));
//G402: pnf_cmd(281)         => __E_cli_command_119(282).
	p(NT(281), (NT(282)));
//G403: cli_command(213)     => pnf_cmd(281).
	p(NT(213), (NT(281)));
//G404: mnf_sym(286)         => 'm' 'n' 'f'.
	p(NT(286), (T(9)+T(46)+T(42)));
//G405: __E_cli_command_120(285) => mnf_sym(286) __(52) nf_cmd_arg(263).
	p(NT(285), (NT(286)+NT(52)+NT(263)));
//G406: mnf_cmd(284)         => __E_cli_command_120(285).
	p(NT(284), (NT(285)));
//G407: cli_command(213)     => mnf_cmd(284).
	p(NT(213), (NT(284)));
//G408: snf_sym(289)         => 's' 'n' 'f'.
	p(NT(289), (T(7)+T(46)+T(42)));
//G409: __E_cli_command_121(288) => snf_sym(289) __(52) nf_cmd_arg(263).
	p(NT(288), (NT(289)+NT(52)+NT(263)));
//G410: snf_cmd(287)         => __E_cli_command_121(288).
	p(NT(287), (NT(288)));
//G411: cli_command(213)     => snf_cmd(287).
	p(NT(213), (NT(287)));
//G412: onf_sym(292)         => 'o' 'n' 'f'.
	p(NT(292), (T(8)+T(46)+T(42)));
//G413: __E_cli_command_122(291) => onf_sym(292) __(52) variable(106) __(52) onf_cmd_arg(293).
	p(NT(291), (NT(292)+NT(52)+NT(106)+NT(52)+NT(293)));
//G414: onf_cmd(290)         => __E_cli_command_122(291).
	p(NT(290), (NT(291)));
//G415: cli_command(213)     => onf_cmd(290).
	p(NT(213), (NT(290)));
//G416: __E___E_cli_command_123_124(297) => 'd' 'e' 'f' 's'.
	p(NT(297), (T(55)+T(10)+T(42)+T(7)));
//G417: __E___E_cli_command_123_124(297) => 'd' 'e' 'f' 'i' 'n' 'i' 't' 'i' 'o' 'n' 's'.
	p(NT(297), (T(55)+T(10)+T(42)+T(12)+T(46)+T(12)+T(11)+T(12)+T(8)+T(46)+T(7)));
//G418: def_sym(296)         => __E___E_cli_command_123_124(297).
	p(NT(296), (NT(297)));
//G419: __E_cli_command_123(295) => def_sym(296).
	p(NT(295), (NT(296)));
//G420: def_list_cmd(294)    => __E_cli_command_123(295).
	p(NT(294), (NT(295)));
//G421: cli_command(213)     => def_list_cmd(294).
	p(NT(213), (NT(294)));
//G422: __E_cli_command_125(299) => def_sym(296) __(52) number(300).
	p(NT(299), (NT(296)+NT(52)+NT(300)));
//G423: def_print_cmd(298)   => __E_cli_command_125(299).
	p(NT(298), (NT(299)));
//G424: cli_command(213)     => def_print_cmd(298).
	p(NT(213), (NT(298)));
//G425: def_rr_cmd(301)      => rec_relation(16).
	p(NT(301), (NT(16)));
//G426: cli_command(213)     => def_rr_cmd(301).
	p(NT(213), (NT(301)));
//G427: qelim_sym(304)       => 'q' 'e' 'l' 'i' 'm'.
	p(NT(304), (T(53)+T(10)+T(16)+T(12)+T(9)));
//G428: __E_cli_command_126(303) => qelim_sym(304) __(52) wff_cmd_arg(305).
	p(NT(303), (NT(304)+NT(52)+NT(305)));
//G429: qelim_cmd(302)       => __E_cli_command_126(303).
	p(NT(302), (NT(303)));
//G430: cli_command(213)     => qelim_cmd(302).
	p(NT(213), (NT(302)));
//G431: get_sym(308)         => 'g' 'e' 't'.
	p(NT(308), (T(47)+T(10)+T(11)));
//G432: __E___E_cli_command_127_128(309) => __(52) option(310).
	p(NT(309), (NT(52)+NT(310)));
//G433: __E___E_cli_command_127_128(309) => null.
	p(NT(309), (nul));
//G434: __E_cli_command_127(307) => get_sym(308) __E___E_cli_command_127_128(309).
	p(NT(307), (NT(308)+NT(309)));
//G435: get_cmd(306)         => __E_cli_command_127(307).
	p(NT(306), (NT(307)));
//G436: cli_command(213)     => get_cmd(306).
	p(NT(213), (NT(306)));
//G437: set_sym(313)         => 's' 'e' 't'.
	p(NT(313), (T(7)+T(10)+T(11)));
//G438: __E___E_cli_command_129_130(314) => __(52).
	p(NT(314), (NT(52)));
//G439: __E___E_cli_command_129_130(314) => _(11) '=' _(11).
	p(NT(314), (NT(11)+T(3)+NT(11)));
//G440: __E_cli_command_129(312) => set_sym(313) __(52) option(310) __E___E_cli_command_129_130(314) option_value(315).
	p(NT(312), (NT(313)+NT(52)+NT(310)+NT(314)+NT(315)));
//G441: set_cmd(311)         => __E_cli_command_129(312).
	p(NT(311), (NT(312)));
//G442: cli_command(213)     => set_cmd(311).
	p(NT(213), (NT(311)));
//G443: toggle_sym(318)      => 't' 'o' 'g' 'g' 'l' 'e'.
	p(NT(318), (T(11)+T(8)+T(47)+T(47)+T(16)+T(10)));
//G444: __E_cli_command_131(317) => toggle_sym(318) __(52) bool_option(319).
	p(NT(317), (NT(318)+NT(52)+NT(319)));
//G445: toggle_cmd(316)      => __E_cli_command_131(317).
	p(NT(316), (NT(317)));
//G446: cli_command(213)     => toggle_cmd(316).
	p(NT(213), (NT(316)));
//G447: __E_cli_command_132(321) => type(170) __(52) in_var_name(143) _(11) '=' _(11) input_stream(322).
	p(NT(321), (NT(170)+NT(52)+NT(143)+NT(11)+T(3)+NT(11)+NT(322)));
//G448: def_input_cmd(320)   => __E_cli_command_132(321).
	p(NT(320), (NT(321)));
//G449: cli_command(213)     => def_input_cmd(320).
	p(NT(213), (NT(320)));
//G450: __E_cli_command_133(324) => type(170) __(52) out_var_name(148) _(11) '=' _(11) output_stream(325).
	p(NT(324), (NT(170)+NT(52)+NT(148)+NT(11)+T(3)+NT(11)+NT(325)));
//G451: def_output_cmd(323)  => __E_cli_command_133(324).
	p(NT(323), (NT(324)));
//G452: cli_command(213)     => def_output_cmd(323).
	p(NT(213), (NT(323)));
//G453: __E___E_cli_command_134_135(329) => 'h' 'i' 's' 't'.
	p(NT(329), (T(44)+T(12)+T(7)+T(11)));
//G454: __E___E_cli_command_134_135(329) => 'h' 'i' 's' 't' 'o' 'r' 'y'.
	p(NT(329), (T(44)+T(12)+T(7)+T(11)+T(8)+T(50)+T(18)));
//G455: history_sym(328)     => __E___E_cli_command_134_135(329).
	p(NT(328), (NT(329)));
//G456: __E_cli_command_134(327) => history_sym(328).
	p(NT(327), (NT(328)));
//G457: history_list_cmd(326) => __E_cli_command_134(327).
	p(NT(326), (NT(327)));
//G458: cli_command(213)     => history_list_cmd(326).
	p(NT(213), (NT(326)));
//G459: __E_cli_command_136(331) => history_sym(328) __(52) memory(332).
	p(NT(331), (NT(328)+NT(52)+NT(332)));
//G460: history_print_cmd(330) => __E_cli_command_136(331).
	p(NT(330), (NT(331)));
//G461: cli_command(213)     => history_print_cmd(330).
	p(NT(213), (NT(330)));
//G462: __E_cli_command_137(334) => wff(14).
	p(NT(334), (NT(14)));
//G463: __E_cli_command_137(334) => bf(21).
	p(NT(334), (NT(21)));
//G464: history_store_cmd(333) => __E_cli_command_137(334).
	p(NT(333), (NT(334)));
//G465: cli_command(213)     => history_store_cmd(333).
	p(NT(213), (NT(333)));
//G466: __E_input_stream_138(335) => 'i' 'f' 'i' 'l' 'e' _(11) '(' _(11) q_file_name(336) _(11) ')'.
	p(NT(335), (T(12)+T(42)+T(12)+T(16)+T(10)+NT(11)+T(5)+NT(11)+NT(336)+NT(11)+T(6)));
//G467: input_stream(322)    => __E_input_stream_138(335).
	p(NT(322), (NT(335)));
//G468: console_sym(337)     => 'c' 'o' 'n' 's' 'o' 'l' 'e'.
	p(NT(337), (T(45)+T(8)+T(46)+T(7)+T(8)+T(16)+T(10)));
//G469: input_stream(322)    => console_sym(337).
	p(NT(322), (NT(337)));
//G470: __E_output_stream_139(338) => 'o' 'f' 'i' 'l' 'e' _(11) '(' _(11) q_file_name(336) _(11) ')'.
	p(NT(338), (T(8)+T(42)+T(12)+T(16)+T(10)+NT(11)+T(5)+NT(11)+NT(336)+NT(11)+T(6)));
//G471: output_stream(325)   => __E_output_stream_139(338).
	p(NT(325), (NT(338)));
//G472: output_stream(325)   => console_sym(337).
	p(NT(325), (NT(337)));
//G473: q_file_name(336)     => '"' file_name(339) '"'.
	p(NT(336), (T(57)+NT(339)+T(57)));
//G474: __E_file_name_140(340) => printable(8).
	p(NT(340), (NT(8)));
//G475: __E_file_name_140(340) => printable(8) __E_file_name_140(340).
	p(NT(340), (NT(8)+NT(340)));
//G476: file_name(339)       => __E_file_name_140(340).
	p(NT(339), (NT(340)));
//G477: number(300)          => digits(161).
	p(NT(300), (NT(161)));
//G478: bf_cmd_arg(341)      => memory(332).
	p(NT(341), (NT(332)));
//G479: bf_cmd_arg(341)      => bf(21).
	p(NT(341), (NT(21)));
//G480: wff_cmd_arg(305)     => memory(332).
	p(NT(305), (NT(332)));
//G481: wff_cmd_arg(305)     => wff(14).
	p(NT(305), (NT(14)));
//G482: solve_cmd_arg(249)   => memory(332).
	p(NT(249), (NT(332)));
//G483: solve_cmd_arg(249)   => wff(14).
	p(NT(249), (NT(14)));
//G484: nf_cmd_arg(263)      => memory(332).
	p(NT(263), (NT(332)));
//G485: nf_cmd_arg(263)      => wff(14).
	p(NT(263), (NT(14)));
//G486: nf_cmd_arg(263)      => bf(21).
	p(NT(263), (NT(21)));
//G487: onf_cmd_arg(293)     => memory(332).
	p(NT(293), (NT(332)));
//G488: onf_cmd_arg(293)     => wff(14).
	p(NT(293), (NT(14)));
//G489: normalize_cmd_arg(241) => memory(332).
	p(NT(241), (NT(332)));
//G490: normalize_cmd_arg(241) => rr(10).
	p(NT(241), (NT(10)));
//G491: normalize_cmd_arg(241) => ref(18).
	p(NT(241), (NT(18)));
//G492: normalize_cmd_arg(241) => wff(14).
	p(NT(241), (NT(14)));
//G493: normalize_cmd_arg(241) => bf(21).
	p(NT(241), (NT(21)));
//G494: inst_args(268)       => wff_cmd_arg(305) _(11) '[' _(11) variable(106) _(11) '/' _(11) bf_cmd_arg(341) _(11) ']'.
	p(NT(268), (NT(305)+NT(11)+T(19)+NT(11)+NT(106)+NT(11)+T(56)+NT(11)+NT(341)+NT(11)+T(20)));
//G495: inst_args(268)       => bf_cmd_arg(341) _(11) '[' _(11) variable(106) _(11) '/' _(11) bf_cmd_arg(341) _(11) ']'.
	p(NT(268), (NT(341)+NT(11)+T(19)+NT(11)+NT(106)+NT(11)+T(56)+NT(11)+NT(341)+NT(11)+T(20)));
//G496: help_arg(230)        => help_sym(227).
	p(NT(230), (NT(227)));
//G497: help_arg(230)        => version_sym(220).
	p(NT(230), (NT(220)));
//G498: help_arg(230)        => quit_sym(217).
	p(NT(230), (NT(217)));
//G499: help_arg(230)        => clear_sym(223).
	p(NT(230), (NT(223)));
//G500: help_arg(230)        => get_sym(308).
	p(NT(230), (NT(308)));
//G501: help_arg(230)        => set_sym(313).
	p(NT(230), (NT(313)));
//G502: help_arg(230)        => toggle_sym(318).
	p(NT(230), (NT(318)));
//G503: help_arg(230)        => file_sym(233).
	p(NT(230), (NT(233)));
//G504: help_arg(230)        => history_sym(328).
	p(NT(230), (NT(328)));
//G505: help_arg(230)        => abs_memory_sym(342).
	p(NT(230), (NT(342)));
//G506: help_arg(230)        => rel_memory_sym(343).
	p(NT(230), (NT(343)));
//G507: help_arg(230)        => selection_sym(344).
	p(NT(230), (NT(344)));
//G508: help_arg(230)        => def_sym(296).
	p(NT(230), (NT(296)));
//G509: help_arg(230)        => inst_sym(266).
	p(NT(230), (NT(266)));
//G510: help_arg(230)        => subst_sym(261).
	p(NT(230), (NT(261)));
//G511: help_arg(230)        => normalize_sym(257).
	p(NT(230), (NT(257)));
//G512: help_arg(230)        => execute_sym(345).
	p(NT(230), (NT(345)));
//G513: help_arg(230)        => solve_sym(247).
	p(NT(230), (NT(247)));
//G514: help_arg(230)        => valid_sym(237).
	p(NT(230), (NT(237)));
//G515: help_arg(230)        => sat_sym(240).
	p(NT(230), (NT(240)));
//G516: help_arg(230)        => unsat_sym(244).
	p(NT(230), (NT(244)));
//G517: help_arg(230)        => dnf_sym(271).
	p(NT(230), (NT(271)));
//G518: help_arg(230)        => cnf_sym(274).
	p(NT(230), (NT(274)));
//G519: help_arg(230)        => anf_sym(277).
	p(NT(230), (NT(277)));
//G520: help_arg(230)        => snf_sym(289).
	p(NT(230), (NT(289)));
//G521: help_arg(230)        => nnf_sym(280).
	p(NT(230), (NT(280)));
//G522: help_arg(230)        => pnf_sym(283).
	p(NT(230), (NT(283)));
//G523: help_arg(230)        => mnf_sym(286).
	p(NT(230), (NT(286)));
//G524: help_arg(230)        => onf_sym(292).
	p(NT(230), (NT(292)));
//G525: help_arg(230)        => qelim_sym(304).
	p(NT(230), (NT(304)));
//G526: __E___E_help_arg_141_142(348) => 's'.
	p(NT(348), (T(7)));
//G527: __E___E_help_arg_141_142(348) => null.
	p(NT(348), (nul));
//G528: __E_help_arg_141(347) => 'e' 'x' 'a' 'm' 'p' 'l' 'e' __E___E_help_arg_141_142(348).
	p(NT(347), (T(10)+T(22)+T(15)+T(9)+T(54)+T(16)+T(10)+NT(348)));
//G529: examples_sym(346)    => __E_help_arg_141(347).
	p(NT(346), (NT(347)));
//G530: help_arg(230)        => examples_sym(346).
	p(NT(230), (NT(346)));
//G531: __E_memory_143(350)  => '%'.
	p(NT(350), (T(58)));
//G532: rel_memory_sym(343)  => '%' '-'.
	p(NT(343), (T(58)+T(23)));
//G533: memory_id(352)       => digits(161).
	p(NT(352), (NT(161)));
//G534: __E___E_memory_143_144(351) => memory_id(352).
	p(NT(351), (NT(352)));
//G535: __E___E_memory_143_144(351) => null.
	p(NT(351), (nul));
//G536: __E_memory_143(350)  => rel_memory_sym(343) __E___E_memory_143_144(351).
	p(NT(350), (NT(343)+NT(351)));
//G537: rel_memory(349)      => __E_memory_143(350).
	p(NT(349), (NT(350)));
//G538: memory(332)          => rel_memory(349).
	p(NT(332), (NT(349)));
//G539: abs_memory_sym(342)  => '%'.
	p(NT(342), (T(58)));
//G540: __E_memory_145(354)  => abs_memory_sym(342) memory_id(352).
	p(NT(354), (NT(342)+NT(352)));
//G541: abs_memory(353)      => __E_memory_145(354).
	p(NT(353), (NT(354)));
//G542: memory(332)          => abs_memory(353).
	p(NT(332), (NT(353)));
//G543: option(310)          => bool_option(319).
	p(NT(310), (NT(319)));
//G544: __E_option_146(357)  => 's' 'e' 'v'.
	p(NT(357), (T(7)+T(10)+T(51)));
//G545: __E_option_146(357)  => 's' 'e' 'v' 'e' 'r' 'i' 't' 'y'.
	p(NT(357), (T(7)+T(10)+T(51)+T(10)+T(50)+T(12)+T(11)+T(18)));
//G546: severity_opt(356)    => __E_option_146(357).
	p(NT(356), (NT(357)));
//G547: enum_option(355)     => severity_opt(356).
	p(NT(355), (NT(356)));
//G548: option(310)          => enum_option(355).
	p(NT(310), (NT(355)));
//G549: __E_bool_option_147(359) => 's'.
	p(NT(359), (T(7)));
//G550: __E_bool_option_147(359) => 's' 't' 'a' 't' 'u' 's'.
	p(NT(359), (T(7)+T(11)+T(15)+T(11)+T(48)+T(7)));
//G551: status_opt(358)      => __E_bool_option_147(359).
	p(NT(358), (NT(359)));
//G552: bool_option(319)     => status_opt(358).
	p(NT(319), (NT(358)));
//G553: __E_bool_option_148(361) => 'c'.
	p(NT(361), (T(45)));
//G554: __E_bool_option_148(361) => 'c' 'o' 'l' 'o' 'r'.
	p(NT(361), (T(45)+T(8)+T(16)+T(8)+T(50)));
//G555: __E_bool_option_148(361) => 'c' 'o' 'l' 'o' 'r' 's'.
	p(NT(361), (T(45)+T(8)+T(16)+T(8)+T(50)+T(7)));
//G556: colors_opt(360)      => __E_bool_option_148(361).
	p(NT(360), (NT(361)));
//G557: bool_option(319)     => colors_opt(360).
	p(NT(319), (NT(360)));
//G558: __E_bool_option_149(363) => 'h'.
	p(NT(363), (T(44)));
//G559: __E_bool_option_149(363) => 'h' 'i' 'l' 'i' 'g' 'h' 't'.
	p(NT(363), (T(44)+T(12)+T(16)+T(12)+T(47)+T(44)+T(11)));
//G560: __E_bool_option_149(363) => 'h' 'i' 'l' 'i' 'g' 'h' 't' 'i' 'n' 'g'.
	p(NT(363), (T(44)+T(12)+T(16)+T(12)+T(47)+T(44)+T(11)+T(12)+T(46)+T(47)));
//G561: hilighting_opt(362)  => __E_bool_option_149(363).
	p(NT(362), (NT(363)));
//G562: bool_option(319)     => hilighting_opt(362).
	p(NT(319), (NT(362)));
//G563: __E_bool_option_150(365) => 'i'.
	p(NT(365), (T(12)));
//G564: __E_bool_option_150(365) => 'i' 'n' 'd' 'e' 'n' 't'.
	p(NT(365), (T(12)+T(46)+T(55)+T(10)+T(46)+T(11)));
//G565: __E_bool_option_150(365) => 'i' 'n' 'd' 'e' 'n' 't' 'i' 'n' 'g'.
	p(NT(365), (T(12)+T(46)+T(55)+T(10)+T(46)+T(11)+T(12)+T(46)+T(47)));
//G566: indenting_opt(364)   => __E_bool_option_150(365).
	p(NT(364), (NT(365)));
//G567: bool_option(319)     => indenting_opt(364).
	p(NT(319), (NT(364)));
//G568: __E_bool_option_151(367) => 'd'.
	p(NT(367), (T(55)));
//G569: __E_bool_option_151(367) => 'd' 'b' 'g'.
	p(NT(367), (T(55)+T(49)+T(47)));
//G570: __E_bool_option_151(367) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(367), (T(55)+T(10)+T(49)+T(48)+T(47)));
//G571: debug_repl_opt(366)  => __E_bool_option_151(367).
	p(NT(366), (NT(367)));
//G572: bool_option(319)     => debug_repl_opt(366).
	p(NT(319), (NT(366)));
//G573: option_value(315)    => option_value_true(368).
	p(NT(315), (NT(368)));
//G574: option_value(315)    => option_value_false(369).
	p(NT(315), (NT(369)));
//G575: option_value(315)    => severity(370).
	p(NT(315), (NT(370)));
//G576: option_value_true(368) => 't'.
	p(NT(368), (T(11)));
//G577: option_value_true(368) => 't' 'r' 'u' 'e'.
	p(NT(368), (T(11)+T(50)+T(48)+T(10)));
//G578: option_value_true(368) => 'o' 'n'.
	p(NT(368), (T(8)+T(46)));
//G579: option_value_true(368) => '1'.
	p(NT(368), (T(33)));
//G580: option_value_true(368) => 'y'.
	p(NT(368), (T(18)));
//G581: option_value_true(368) => 'y' 'e' 's'.
	p(NT(368), (T(18)+T(10)+T(7)));
//G582: option_value_false(369) => 'f'.
	p(NT(369), (T(42)));
//G583: option_value_false(369) => 'f' 'a' 'l' 's' 'e'.
	p(NT(369), (T(42)+T(15)+T(16)+T(7)+T(10)));
//G584: option_value_false(369) => 'o' 'f' 'f'.
	p(NT(369), (T(8)+T(42)+T(42)));
//G585: option_value_false(369) => '0'.
	p(NT(369), (T(34)));
//G586: option_value_false(369) => 'n'.
	p(NT(369), (T(46)));
//G587: option_value_false(369) => 'n' 'o'.
	p(NT(369), (T(46)+T(8)));
//G588: __E_severity_152(372) => 'e'.
	p(NT(372), (T(10)));
//G589: __E_severity_152(372) => 'e' 'r' 'r' 'o' 'r'.
	p(NT(372), (T(10)+T(50)+T(50)+T(8)+T(50)));
//G590: error_sym(371)       => __E_severity_152(372).
	p(NT(371), (NT(372)));
//G591: severity(370)        => error_sym(371).
	p(NT(370), (NT(371)));
//G592: __E_severity_153(374) => 'i'.
	p(NT(374), (T(12)));
//G593: __E_severity_153(374) => 'i' 'n' 'f' 'o'.
	p(NT(374), (T(12)+T(46)+T(42)+T(8)));
//G594: info_sym(373)        => __E_severity_153(374).
	p(NT(373), (NT(374)));
//G595: severity(370)        => info_sym(373).
	p(NT(370), (NT(373)));
//G596: __E_severity_154(376) => 'd'.
	p(NT(376), (T(55)));
//G597: __E_severity_154(376) => 'd' 'e' 'b' 'u' 'g'.
	p(NT(376), (T(55)+T(10)+T(49)+T(48)+T(47)));
//G598: debug_sym(375)       => __E_severity_154(376).
	p(NT(375), (NT(376)));
//G599: severity(370)        => debug_sym(375).
	p(NT(370), (NT(375)));
//G600: __E_severity_155(378) => 't'.
	p(NT(378), (T(11)));
//G601: __E_severity_155(378) => 't' 'r' 'a' 'c' 'e'.
	p(NT(378), (T(11)+T(50)+T(15)+T(45)+T(10)));
//G602: trace_sym(377)       => __E_severity_155(378).
	p(NT(377), (NT(378)));
//G603: severity(370)        => trace_sym(377).
	p(NT(370), (NT(377)));
	#undef T
	#undef NT
