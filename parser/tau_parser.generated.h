...
struct tau_parser {
	...
	tau_parser() :
		...
		g(nts, load_prods(), nt(238), cc), p(g, load_opts()) {}
	...
	enum nonterminal {
		...
		bf_neg_cb, bf_ref, bf_constant, bf_and, bf_neg, bf_xor, bf_or, bf_all, bf_ex, bf_t, 
		bf_f, bf_splitter, bf_rec_relation, _Rbf_rec_relation_25, bf_ref_args, _Rbf_ref_args_26, _Rbf_ref_args_27, _Rbf_ref_args_28, bf_and_sym, bf_or_sym, 
		bf_xor_sym, bf_neg_sym, bf_all_sym, _Rbf_all_29, bf_ex_sym, _Rbf_ex_30, bf_splitter_sym, constant, binding, source_binding, 
		...
		wff_remove_buniversal_cb_sym, wff_has_clashing_subformulas_cb_sym, bf_has_subformula_cb_sym, wff_has_subformula_cb_sym, tau_collapse_positives_cb_sym, tau_cb_arg, _Rtau_collapse_positives_cb_33, _Rtau_collapse_positives_cb_34, tau_positives_upwards_cb_sym, inputs, 
		input, _Rinputs_35, _Rinputs_36, builder, builder_head, builder_body, _Rbuilder_head_37, _Rbuilder_head_38, bf_builder_body, wff_builder_body, 
		tau_builder_body, library, rules, rule, _Rrules_39, _Rrules_40, nso_rr, nso_rec_relations, nso_main, nso_rec_relation, 
		_Rnso_rec_relations_41, _Rnso_rec_relations_42, gssotc_rr, gssotc_rec_relations, gssotc_main, gssotc_rec_relation, _Rgssotc_rec_relations_43, _Rgssotc_rec_relations_44, start, _Rstart_45, 
		cli, cli_command, _Rcli_46, _Rcli_47, _Rcli_48, normalize, onf, dnf, cnf, anf, 
		nnf, pnf, minterm, bf_substitute, wff_substitute, bf_instantiate, wff_instantiate, rr_nso, help, version, 
		quit, get, list_outputs, _Rcli_command_49, clear_outputs, print_output, file, toggle, set, normalize_sym, 
		form_arg, onf_sym, var_arg, dnf_sym, cnf_sym, anf_sym, nnf_sym, pnf_sym, minterm_sym, q_nso_rr, 
		q_wff, output, wff_selection, file_sym, file_path, instantiate_sym, q_var, bf_var_selection, _Rbf_instantiate_50, q_bf, 
		bf_selection, _Rbf_instantiate_51, _Rbf_instantiate_52, wff_var_selection, _Rwff_instantiate_53, _Rwff_instantiate_54, _Rwff_instantiate_55, substitute_sym, _Rbf_substitute_56, _Rbf_substitute_57, 
		_Rwff_substitute_58, _Rwff_substitute_59, help_sym, cli_cmd_sym, _Rhelp_60, version_sym, quit_sym, selection_sym, absolute_output, relative_output, 
		absolute_output_sym, output_sym, _Rabsolute_output_61, output_id, relative_output_sym, _Rclear_outputs_62, clear_sym, get_sym, set_sym, toggle_sym, 
		option, _Rget_63, _Rset_64, option_value, bool_option, severity_opt, status_opt, colors_opt, option_value_true, option_value_false, 
		...
		__neg_45, __neg_46, __neg_47, __neg_48, __neg_49, 
	};
...
private:
	...
	idni::prods<char_type, terminal_type> load_prods() {
		...
		q(nt(72), ~(nt(339)) & (nt(64)) & ~(nt(340)) & ~(nt(341)) & ~(nt(342)) & ~(nt(343)));
		...
		q(nt(111), ~(nt(344)) & ~(nt(345)) & ~(nt(346)) & ~(nt(347)) & (nt(81)) & ~(nt(348)) & ~(nt(349)) & ~(nt(350)) & ~(nt(351)) & ~(nt(352)) & ~(nt(353)) & ~(nt(354)) & ~(nt(355)) & ~(nt(356)) & ~(nt(357)) & ~(nt(358)) & ~(nt(359)) & ~(nt(360)) & ~(nt(361)) & ~(nt(362)) & ~(nt(363)) & ~(nt(364)) & ~(nt(365)));
		...
		q(nt(163), ~(nt(366)) & ~(nt(367)) & ~(nt(368)) & ~(nt(369)) & (nt(132)) & ~(nt(370)) & ~(nt(371)) & ~(nt(372)) & ~(nt(373)) & ~(nt(374)) & ~(nt(375)) & ~(nt(376)) & ~(nt(377)) & ~(nt(378)) & ~(nt(379)));
		// bf_rec_relation => _Rbf_rec_relation_25 _ bf_def _ bf _ dot.
		q(nt(162), (nt(163)+nt(15)+nt(17)+nt(15)+nt(132)+nt(15)+nt(20)));
		// bf_ref => sym offsets bf_ref_args.
		q(nt(151), (nt(39)+nt(40)+nt(164)));
		...
		q(nt(164), (nt(21)+nt(15)+nt(167)+nt(15)+nt(22)));
		// bf_and => open_parenthesis _ bf _ bf_and_sym _ bf _ close_parenthesis.
		q(nt(153), (nt(21)+nt(15)+nt(132)+nt(15)+nt(168)+nt(15)+nt(132)+nt(15)+nt(22)));
		// bf_or => open_parenthesis _ bf _ bf_or_sym _ bf _ close_parenthesis.
		q(nt(156), (nt(21)+nt(15)+nt(132)+nt(15)+nt(169)+nt(15)+nt(132)+nt(15)+nt(22)));
		// bf_xor => open_parenthesis _ bf _ bf_xor_sym _ bf _ close_parenthesis.
		q(nt(155), (nt(21)+nt(15)+nt(132)+nt(15)+nt(170)+nt(15)+nt(132)+nt(15)+nt(22)));
		// bf_neg => bf _ bf_neg_sym.
		q(nt(154), (nt(132)+nt(15)+nt(171)));
		// _Rbf_all_29 => capture.
		q(nt(173), (nt(45)));
		// _Rbf_all_29 => variable.
		q(nt(173), (nt(47)));
		// bf_all => bf_all_sym __ _Rbf_all_29 __ bf.
		q(nt(157), (nt(172)+nt(13)+nt(173)+nt(13)+nt(132)));
		// _Rbf_ex_30 => capture.
		q(nt(175), (nt(45)));
		// _Rbf_ex_30 => variable.
		q(nt(175), (nt(47)));
		// bf_ex => bf_ex_sym __ _Rbf_ex_30 __ bf.
		q(nt(158), (nt(174)+nt(13)+nt(175)+nt(13)+nt(132)));
		// bf_splitter => bf_splitter_sym _ open_parenthesis _ bf _ close_parenthesis.
		q(nt(161), (nt(176)+nt(15)+nt(21)+nt(15)+nt(132)+nt(15)+nt(22)));
		// bf_and_sym => '&'.
		q(nt(168), (t(24)));
		// bf_or_sym => '|'.
		q(nt(169), (t(25)));
		...
		q(nt(138), (t(29)));
		// bf_all_sym => 'f' 'a' 'l' 'l'.
		q(nt(172), (t(38)+t(30)+t(31)+t(31)));
		// bf_ex_sym => 'f' 'e' 'x'.
		q(nt(174), (t(38)+t(32)+t(33)));
		// bf_splitter_sym => 'S'.
		q(nt(176), (t(39)));
		// bf_t => '1'.
		q(nt(159), (t(40)));
		...
		q(nt(152), (nt(25)+nt(15)+nt(177)+nt(15)+nt(26)));
		// constant => capture.
		q(nt(177), (nt(45)));
		// constant => binding.
		q(nt(177), (nt(178)));
		...
		q(nt(179), (nt(181)+nt(15)+nt(28)+nt(15)+nt(182)));
		// type => null.
		q(nt(181), (nul));
		// type => chars.
		q(nt(181), (nt(34)));
		...
		q(nt(147), (nt(186)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_or_cb => bf_or_cb_sym __ bf_cb_arg __ bf_cb_arg.
		q(nt(148), (nt(188)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_xor_cb => bf_xor_cb_sym __ bf_cb_arg __ bf_cb_arg.
		q(nt(149), (nt(189)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_neg_cb => bf_neg_cb_sym __ bf_cb_arg.
		q(nt(150), (nt(190)+nt(13)+nt(187)));
		// bf_eq_cb => bf_eq_cb_sym __ bf_cb_arg __ wff_cb_arg __ wff_cb_arg.
		q(nt(85), (nt(191)+nt(13)+nt(187)+nt(13)+nt(192)+nt(13)+nt(192)));
		// bf_neq_cb => bf_neq_cb_sym __ bf_cb_arg __ wff_cb_arg __ wff_cb_arg.
		q(nt(86), (nt(193)+nt(13)+nt(187)+nt(13)+nt(192)+nt(13)+nt(192)));
		// bf_is_zero_cb => bf_is_zero_cb_sym __ bf_cb_arg __ bf_cb_arg.
		q(nt(142), (nt(194)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_is_one_cb => bf_is_one_cb_sym __ bf_cb_arg __ bf_cb_arg.
		q(nt(143), (nt(195)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_remove_funiversal_cb => bf_remove_funiversal_cb_sym __ bf_cb_arg __ bf_cb_arg __ bf_cb_arg __ bf_cb_arg.
		q(nt(145), (nt(196)+nt(13)+nt(187)+nt(13)+nt(187)+nt(13)+nt(187)+nt(13)+nt(187)));
		// bf_remove_fexistential_cb => bf_remove_fexistential_cb_sym __ bf_cb_arg __ bf_cb_arg __ bf_cb_arg __ bf_cb_arg.
		q(nt(146), (nt(197)+nt(13)+nt(187)+nt(13)+nt(187)+nt(13)+nt(187)+nt(13)+nt(187)));
		// wff_remove_existential_cb => wff_remove_existential_cb_sym __ wff_cb_arg __ wff_cb_arg.
		q(nt(89), (nt(198)+nt(13)+nt(192)+nt(13)+nt(192)));
		// wff_remove_bexistential_cb => wff_remove_bexistential_cb_sym __ wff_cb_arg __ wff_cb_arg __ wff_cb_arg __ wff_cb_arg.
		q(nt(90), (nt(199)+nt(13)+nt(192)+nt(13)+nt(192)+nt(13)+nt(192)+nt(13)+nt(192)));
		// wff_remove_buniversal_cb => wff_remove_buniversal_cb_sym __ wff_cb_arg __ wff_cb_arg __ wff_cb_arg __ wff_cb_arg.
		q(nt(91), (nt(200)+nt(13)+nt(192)+nt(13)+nt(192)+nt(13)+nt(192)+nt(13)+nt(192)));
		// wff_has_clashing_subformulas_cb => wff_has_clashing_subformulas_cb_sym __ wff_cb_arg __ wff_cb_arg.
		q(nt(87), (nt(201)+nt(13)+nt(192)+nt(13)+nt(192)));
		// bf_has_subformula_cb => bf_has_subformula_cb_sym __ bf_cb_arg __ bf_cb_arg __ bf_cb_arg.
		q(nt(144), (nt(202)+nt(13)+nt(187)+nt(13)+nt(187)+nt(13)+nt(187)));
		// wff_has_subformula_cb => wff_has_subformula_cb_sym __ wff_cb_arg __ wff_cb_arg __ wff_cb_arg.
		q(nt(88), (nt(203)+nt(13)+nt(192)+nt(13)+nt(192)+nt(13)+nt(192)));
		// bf_has_subformula_cb_sym => 'b' 'f' '_' 'h' 'a' 's' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' '_' 'c' 'b'.
		q(nt(202), (t(34)+t(38)+t(22)+t(42)+t(30)+t(43)+t(22)+t(43)+t(44)+t(34)+t(38)+t(23)+t(45)+t(46)+t(44)+t(31)+t(30)+t(22)+t(47)+t(34)));
		// wff_has_clashing_subformulas_cb_sym => 'w' 'f' 'f' '_' 'h' 'a' 's' '_' 'c' 'l' 'a' 's' 'h' 'i' 'n' 'g' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' 's' '_' 'c' 'b'.
		q(nt(201), (t(48)+t(38)+t(38)+t(22)+t(42)+t(30)+t(43)+t(22)+t(47)+t(31)+t(30)+t(43)+t(42)+t(21)+t(49)+t(50)+t(22)+t(43)+t(44)+t(34)+t(38)+t(23)+t(45)+t(46)+t(44)+t(31)+t(30)+t(43)+t(22)+t(47)+t(34)));
		// wff_has_subformula_cb_sym => 'w' 'f' 'f' '_' 'h' 'a' 's' '_' 's' 'u' 'b' 'f' 'o' 'r' 'm' 'u' 'l' 'a' '_' 'c' 'b'.
		q(nt(203), (t(48)+t(38)+t(38)+t(22)+t(42)+t(30)+t(43)+t(22)+t(43)+t(44)+t(34)+t(38)+t(23)+t(45)+t(46)+t(44)+t(31)+t(30)+t(22)+t(47)+t(34)));
		// wff_remove_existential_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(198), (t(48)+t(38)+t(38)+t(22)+t(45)+t(32)+t(46)+t(23)+t(51)+t(32)+t(22)+t(32)+t(33)+t(21)+t(43)+t(52)+t(32)+t(49)+t(52)+t(21)+t(30)+t(31)+t(22)+t(47)+t(34)));
		// wff_remove_bexistential_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'b' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(199), (t(48)+t(38)+t(38)+t(22)+t(45)+t(32)+t(46)+t(23)+t(51)+t(32)+t(22)+t(34)+t(32)+t(33)+t(21)+t(43)+t(52)+t(32)+t(49)+t(52)+t(21)+t(30)+t(31)+t(22)+t(47)+t(34)));
		// wff_remove_buniversal_cb_sym => 'w' 'f' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'b' 'u' 'n' 'i' 'v' 'e' 'r' 's' 'a' 'l' '_' 'c' 'b'.
		q(nt(200), (t(48)+t(38)+t(38)+t(22)+t(45)+t(32)+t(46)+t(23)+t(51)+t(32)+t(22)+t(34)+t(44)+t(49)+t(21)+t(51)+t(32)+t(45)+t(43)+t(30)+t(31)+t(22)+t(47)+t(34)));
		// bf_remove_fexistential_cb_sym => 'b' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'f' 'e' 'x' 'i' 's' 't' 'e' 'n' 't' 'i' 'a' 'l' '_' 'c' 'b'.
		q(nt(197), (t(34)+t(38)+t(22)+t(45)+t(32)+t(46)+t(23)+t(51)+t(32)+t(22)+t(38)+t(32)+t(33)+t(21)+t(43)+t(52)+t(32)+t(49)+t(52)+t(21)+t(30)+t(31)+t(22)+t(47)+t(34)));
		// bf_remove_funiversal_cb_sym => 'b' 'f' '_' 'r' 'e' 'm' 'o' 'v' 'e' '_' 'f' 'u' 'n' 'i' 'v' 'e' 'r' 's' 'a' 'l' '_' 'c' 'b'.
		q(nt(196), (t(34)+t(38)+t(22)+t(45)+t(32)+t(46)+t(23)+t(51)+t(32)+t(22)+t(38)+t(44)+t(49)+t(21)+t(51)+t(32)+t(45)+t(43)+t(30)+t(31)+t(22)+t(47)+t(34)));
		// bf_cb_arg => bf.
		q(nt(187), (nt(132)));
		// wff_cb_arg => wff.
		q(nt(192), (nt(81)));
		// bf_and_cb_sym => 'b' 'f' '_' 'a' 'n' 'd' '_' 'c' 'b'.
		q(nt(186), (t(34)+t(38)+t(22)+t(30)+t(49)+t(53)+t(22)+t(47)+t(34)));
		// bf_or_cb_sym => 'b' 'f' '_' 'o' 'r' '_' 'c' 'b'.
		q(nt(188), (t(34)+t(38)+t(22)+t(23)+t(45)+t(22)+t(47)+t(34)));
		// bf_xor_cb_sym => 'b' 'f' '_' 'x' 'o' 'r' '_' 'c' 'b'.
		q(nt(189), (t(34)+t(38)+t(22)+t(33)+t(23)+t(45)+t(22)+t(47)+t(34)));
		// bf_neg_cb_sym => 'b' 'f' '_' 'n' 'e' 'g' '_' 'c' 'b'.
		q(nt(190), (t(34)+t(38)+t(22)+t(49)+t(32)+t(50)+t(22)+t(47)+t(34)));
		// bf_eq_cb_sym => 'b' 'f' '_' 'e' 'q' '_' 'c' 'b'.
		q(nt(191), (t(34)+t(38)+t(22)+t(32)+t(54)+t(22)+t(47)+t(34)));
		// bf_neq_cb_sym => 'b' 'f' '_' 'n' 'e' 'q' '_' 'c' 'b'.
		q(nt(193), (t(34)+t(38)+t(22)+t(49)+t(32)+t(54)+t(22)+t(47)+t(34)));
		// bf_is_zero_cb_sym => 'b' 'f' '_' 'i' 's' '_' 'z' 'e' 'r' 'o' '_' 'c' 'b'.
		q(nt(194), (t(34)+t(38)+t(22)+t(21)+t(43)+t(22)+t(55)+t(32)+t(45)+t(23)+t(22)+t(47)+t(34)));
		// bf_is_one_cb_sym => 'b' 'f' '_' 'i' 's' '_' 'o' 'n' 'e' '_' 'c' 'b'.
		q(nt(195), (t(34)+t(38)+t(22)+t(21)+t(43)+t(22)+t(23)+t(49)+t(32)+t(22)+t(47)+t(34)));
		...
		q(nt(66), (nt(208)+nt(13)+nt(205)+nt(13)+nt(205)));
		// tau_cb_arg => capture.
		q(nt(205), (nt(45)));
		// tau_cb_arg => tau.
		q(nt(205), (nt(64)));
		// tau_collapse_positives_cb_sym => 't' 'a' 'u' '_' 'c' 'o' 'l' 'l' 'a' 'p' 's' 'e' '_' 'p' 'o' 's' 'i' 't' 'i' 'v' 'e' 's' '_' 'c' 'b'.
		q(nt(204), (t(52)+t(30)+t(44)+t(22)+t(47)+t(23)+t(31)+t(31)+t(30)+t(56)+t(43)+t(32)+t(22)+t(56)+t(23)+t(43)+t(21)+t(52)+t(21)+t(51)+t(32)+t(43)+t(22)+t(47)+t(34)));
		// tau_positives_upwards_cb_sym => 't' 'a' 'u' '_' 'p' 'o' 's' 'i' 't' 'i' 'v' 'e' 's' '_' 'u' 'p' 'w' 'a' 'r' 'd' 's' '_' 'c' 'b'.
		q(nt(208), (t(52)+t(30)+t(44)+t(22)+t(56)+t(23)+t(43)+t(21)+t(52)+t(21)+t(51)+t(32)+t(43)+t(22)+t(44)+t(56)+t(48)+t(30)+t(45)+t(53)+t(43)+t(22)+t(47)+t(34)));
		// _Rinputs_35 => _ input.
		q(nt(211), (nt(15)+nt(210)));
		// _Rinputs_36 => null.
		q(nt(212), (nul));
		// _Rinputs_36 => _Rinputs_35 _Rinputs_36.
		q(nt(212), (nt(211)+nt(212)));
		// inputs => _ less _ input _Rinputs_36 _ dot.
		q(nt(209), (nt(15)+nt(30)+nt(15)+nt(210)+nt(212)+nt(15)+nt(20)));
		// input => in _ colon _ open_brace _ source_binding _ close_brace.
		q(nt(210), (nt(53)+nt(15)+nt(28)+nt(15)+nt(25)+nt(15)+nt(179)+nt(15)+nt(26)));
		// builder => _ builder_head _ builder_body _ dot.
		q(nt(213), (nt(15)+nt(214)+nt(15)+nt(215)+nt(15)+nt(20)));
		// _Rbuilder_head_37 => __ capture.
		q(nt(216), (nt(13)+nt(45)));
		...
		q(nt(214), (nt(21)+nt(15)+nt(45)+nt(217)+nt(15)+nt(22)));
		...
		q(nt(218), (nt(17)+nt(15)+nt(132)));
		// wff_builder_body => wff_def _ wff.
		q(nt(219), (nt(18)+nt(15)+nt(81)));
		// tau_builder_body => tau_def _ tau.
		q(nt(220), (nt(19)+nt(15)+nt(64)));
		// library => rules.
		q(nt(221), (nt(222)));
		// _Rrules_39 => _ rule.
		q(nt(224), (nt(15)+nt(223)));
		// _Rrules_40 => null.
		q(nt(225), (nul));
		...
		q(nt(226), (nt(227)+nt(228)));
		// _Rnso_rec_relations_41 => _ nso_rec_relation.
		q(nt(230), (nt(15)+nt(229)));
		...
		q(nt(234), (nt(15)+nt(64)+nt(15)+nt(29)));
		// _Rstart_45 => inputs.
		q(nt(239), (nt(209)));
		// _Rstart_45 => builder.
		q(nt(239), (nt(213)));
		...
		q(nt(239), (nt(232)));
		// start => _Rstart_45 _.
		q(nt(238), (nt(239)+nt(15)));
		// _Rcli_46 => _ dot _ cli_command.
		q(nt(242), (nt(15)+nt(20)+nt(15)+nt(241)));
		// _Rcli_47 => null.
		q(nt(243), (nul));
		...
		q(nt(244), (nul));
		// _Rcli_48 => _ dot.
		q(nt(244), (nt(15)+nt(20)));
		// cli => _ cli_command _Rcli_47 _Rcli_48 _.
		q(nt(240), (nt(15)+nt(241)+nt(243)+nt(244)+nt(15)));
		// __neg_45 => help.
		q(nt(380), (nt(258)));
		// __neg_46 => version.
		q(nt(381), (nt(259)));
		...
		q(nt(263), (nt(132)) & ~(nt(380)) & ~(nt(381)) & ~(nt(382)) & ~(nt(383)) & ~(nt(384)));
		// cli_command => wff.
		q(nt(241), (nt(81)));
		...
		q(nt(245), (nt(269)+nt(13)+nt(270)));
		// onf => onf_sym __ var_arg form_arg.
		q(nt(246), (nt(271)+nt(13)+nt(272)+nt(270)));
		// dnf => dnf_sym __ form_arg.
		q(nt(247), (nt(273)+nt(13)+nt(270)));
		// cnf => cnf_sym __ form_arg.
		q(nt(248), (nt(274)+nt(13)+nt(270)));
		// anf => anf_sym __ form_arg.
		q(nt(249), (nt(275)+nt(13)+nt(270)));
		// nnf => nnf_sym __ form_arg.
		q(nt(250), (nt(276)+nt(13)+nt(270)));
		// pnf => pnf_sym __ form_arg.
		q(nt(251), (nt(277)+nt(13)+nt(270)));
		// minterm => minterm_sym __ form_arg.
		q(nt(252), (nt(278)+nt(13)+nt(270)));
		// var_arg => null.
		q(nt(272), (nul));
		// var_arg => chars.
		q(nt(272), (nt(34)));
		...
		q(nt(266), (nt(283)+nt(33)+nt(284)+nt(33)));
		...
		q(nt(255), (nt(285)+nt(13)+nt(288)+nt(13)+nt(291)+nt(13)+nt(292)));
		...
		q(nt(256), (nt(285)+nt(13)+nt(294)+nt(13)+nt(295)+nt(13)+nt(296)));
		...
		q(nt(253), (nt(297)+nt(13)+nt(298)+nt(13)+nt(299)));
		...
		q(nt(254), (nt(297)+nt(13)+nt(300)+nt(13)+nt(301)));
		// _Rhelp_60 => null.
		q(nt(304), (nul));
		// _Rhelp_60 => __ cli_cmd_sym.
		q(nt(304), (nt(13)+nt(303)));
		// help => help_sym _Rhelp_60.
		q(nt(258), (nt(302)+nt(304)));
		// version => version_sym.
		q(nt(259), (nt(305)));
		// quit => quit_sym.
		q(nt(260), (nt(306)));
		// wff_selection => selection_sym __ digits.
		q(nt(282), (nt(307)+nt(13)+nt(37)));
		// bf_selection => selection_sym __ digits.
		q(nt(290), (nt(307)+nt(13)+nt(37)));
		// bf_var_selection => selection_sym __ digits.
		q(nt(287), (nt(307)+nt(13)+nt(37)));
		// wff_var_selection => selection_sym __ digits.
		q(nt(293), (nt(307)+nt(13)+nt(37)));
		// q_nso_rr => apostrophe _ nso_rr _ apostrophe.
		q(nt(279), (nt(32)+nt(15)+nt(226)+nt(15)+nt(32)));
		// q_wff => apostrophe _ wff _ apostrophe.
		q(nt(280), (nt(32)+nt(15)+nt(81)+nt(15)+nt(32)));
		// q_bf => apostrophe _ bf _ apostrophe.
		q(nt(289), (nt(32)+nt(15)+nt(132)+nt(15)+nt(32)));
		// q_var => apostrophe _ var _ apostrophe.
		q(nt(286), (nt(32)+nt(15)+nt(52)+nt(15)+nt(32)));
		// file_path => chars.
		q(nt(284), (nt(34)));
		...
		q(nt(302), (t(42)));
		// help_sym => 'h' 'e' 'l' 'p'.
		q(nt(302), (t(42)+t(32)+t(31)+t(56)));
		// version_sym => 'v'.
		q(nt(305), (t(51)));
		// version_sym => 'v' 'e' 'r' 's' 'i' 'o' 'n'.
		q(nt(305), (t(51)+t(32)+t(45)+t(43)+t(21)+t(23)+t(49)));
		// quit_sym => 'e'.
		q(nt(306), (t(32)));
		// quit_sym => 'e' 'x' 'i' 't'.
		q(nt(306), (t(32)+t(33)+t(21)+t(52)));
		// quit_sym => 'q'.
		q(nt(306), (t(54)));
		// quit_sym => 'q' 'u' 'i' 't'.
		q(nt(306), (t(54)+t(44)+t(21)+t(52)));
		// output_sym => 'o'.
		q(nt(311), (t(23)));
		// output_sym => 'o' 'u' 't' 'p' 'u' 't'.
		q(nt(311), (t(23)+t(44)+t(52)+t(56)+t(44)+t(52)));
		// selection_sym => 's'.
		q(nt(307), (t(43)));
		// selection_sym => 's' 'e' 'l' 'e' 'c' 't' 'i' 'o' 'n'.
		q(nt(307), (t(43)+t(32)+t(31)+t(32)+t(47)+t(52)+t(21)+t(23)+t(49)));
		// instantiate_sym => 'i'.
		q(nt(285), (t(21)));
		// instantiate_sym => 'i' 'n' 's' 't' 'a' 'n' 't' 'i' 'a' 't' 'e'.
		q(nt(285), (t(21)+t(49)+t(43)+t(52)+t(30)+t(49)+t(52)+t(21)+t(30)+t(52)+t(32)));
		// substitute_sym => 's'.
		q(nt(297), (t(43)));
		// substitute_sym => 's' 'u' 'b' 's' 't' 'i' 't' 'u' 't' 'e'.
		q(nt(297), (t(43)+t(44)+t(34)+t(43)+t(52)+t(21)+t(52)+t(44)+t(52)+t(32)));
		// normalize_sym => 'n'.
		q(nt(269), (t(49)));
		// normalize_sym => 'n' 'o' 'r' 'm' 'a' 'l' 'i' 'z' 'e'.
		q(nt(269), (t(49)+t(23)+t(45)+t(46)+t(30)+t(31)+t(21)+t(55)+t(32)));
		// file_sym => 'r'.
		q(nt(283), (t(45)));
		// file_sym => 'r' 'e' 'a' 'd'.
		q(nt(283), (t(45)+t(32)+t(30)+t(53)));
		// clear_sym => 'c'.
		q(nt(316), (t(47)));
		// clear_sym => 'c' 'l' 'e' 'a' 'r'.
		q(nt(316), (t(47)+t(31)+t(32)+t(30)+t(45)));
		// onf_sym => 'o' 'n' 'f'.
		q(nt(271), (t(23)+t(49)+t(38)));
		// dnf_sym => 'd' 'n' 'f'.
		q(nt(273), (t(53)+t(49)+t(38)));
		// cnf_sym => 'c' 'n' 'f'.
		q(nt(274), (t(47)+t(49)+t(38)));
		// anf_sym => 'a' 'n' 'f'.
		q(nt(275), (t(30)+t(49)+t(38)));
		// nnf_sym => 'n' 'n' 'f'.
		q(nt(276), (t(49)+t(49)+t(38)));
		// pnf_sym => 'p' 'n' 'f'.
		q(nt(277), (t(56)+t(49)+t(38)));
		// minterm_sym => 'm' 'i' 'n' 't' 'e' 'r' 'm'.
		q(nt(278), (t(46)+t(21)+t(49)+t(52)+t(32)+t(45)+t(46)));
		// absolute_output_sym => '&'.
		q(nt(310), (t(24)));
		// relative_output_sym => '%'.
		q(nt(314), (t(57)));
		...
		q(nt(321), (nul));
		// _Rget_63 => __ option.
		q(nt(321), (nt(13)+nt(320)));
		// get => get_sym _Rget_63.
		q(nt(261), (nt(317)+nt(321)));
		// _Rset_64 => __.
		q(nt(322), (nt(13)));
		// _Rset_64 => _ '=' _.
		q(nt(322), (nt(15)+t(6)+nt(15)));
		// set => set_sym __ option _Rset_64 option_value.
		q(nt(268), (nt(318)+nt(13)+nt(320)+nt(322)+nt(323)));
		// toggle => toggle_sym __ bool_option.
		q(nt(267), (nt(319)+nt(13)+nt(324)));
		// get_sym => 'g' 'e' 't'.
		q(nt(317), (t(50)+t(32)+t(52)));
		// set_sym => 's' 'e' 't'.
		q(nt(318), (t(43)+t(32)+t(52)));
		// toggle_sym => 't' 'o' 'g' 'g' 'l' 'e'.
		q(nt(319), (t(52)+t(23)+t(50)+t(50)+t(31)+t(32)));
		// option => bool_option.
		q(nt(320), (nt(324)));
		// option => severity_opt.
		q(nt(320), (nt(325)));
		...
		q(nt(326), (t(43)+t(52)+t(30)+t(52)+t(44)+t(43)));
		// colors_opt => 'c'.
		q(nt(327), (t(47)));
		// colors_opt => 'c' 'o' 'l' 'o' 'r'.
		q(nt(327), (t(47)+t(23)+t(31)+t(23)+t(45)));
		// colors_opt => 'c' 'o' 'l' 'o' 'r' 's'.
		q(nt(327), (t(47)+t(23)+t(31)+t(23)+t(45)+t(43)));
		// severity_opt => 's' 'e' 'v'.
		q(nt(325), (t(43)+t(32)+t(51)));
		// severity_opt => 's' 'e' 'v' 'e' 'r' 'i' 't' 'y'.
		q(nt(325), (t(43)+t(32)+t(51)+t(32)+t(45)+t(21)+t(52)+t(58)));
		...
		q(nt(331), (t(32)));
		// error_sym => 'e' 'r' 'r' 'o' 'r'.
		q(nt(331), (t(32)+t(45)+t(45)+t(23)+t(45)));
		// info_sym => 'i'.
		q(nt(334), (t(21)));
		// info_sym => 'i' 'n' 'f' 'o'.
		q(nt(334), (t(21)+t(49)+t(38)+t(23)));
		// debug_sym => 'd'.
		q(nt(332), (t(53)));
		// debug_sym => 'd' 'e' 'b' 'u' 'g'.
		q(nt(332), (t(53)+t(32)+t(34)+t(44)+t(50)));
		// trace_sym => 't'.
		q(nt(333), (t(52)));
		// trace_sym => 't' 'r' 'a' 'c' 'e'.
		q(nt(333), (t(52)+t(45)+t(30)+t(47)+t(32)));
		return q;
	}
};
