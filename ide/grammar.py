...
def _extract_commands(info: GrammarInfo):
    ...
    command_patterns = [
        ...
        (["without"], "without_cmd", "Normal form without a conjunct: without <expr> <clause>"),
...
def _build_production_docs(info: GrammarInfo):
    ...
    for aliases, label, doc in [
        ...
        (["without"], "without_cmd", "Normal form of an always-conjunction without one conjunct: without <expr> <clause>"),
        (["qelim"], "qelim_cmd", "Quantifier elimination"),
